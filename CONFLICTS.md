...
## C-034 — no one constant converts EU into joules, because the EU figures are not ordered by Stage

**Rules:** `Fracture of Worlds — The Living System/VII. Aether Class, Essence Typology, Aether Flow (Parts Seventeen–Nineteen).md:83` vs `Volume I — Character Cards/Gimbzo.md:58`, `Volume I — Character Cards/Dougou Ozumu Zettari.md:62`, `Volume I — Character Cards/Yorime Seikai.md:59`, `Volume I — Character Cards/Kwon Mu-jin.md:73` and the other 31 attested reserves in `imports/essence-ledger/anchors.json`
**The clash:** Part Nineteen says the reserve scales with Temperance Stage. The attested reserves do not. Inside Stage XII alone they run from Yorime Seikai's 74,000 EU to Gimbzo's 4.8×10¹⁴ EU, 9.8 orders of magnitude apart at one Stage; and Dougou Ozumu Zettari at Stage XIII holds 92,000 EU, less than Yoko Mishiro's 185,000 at Stage V. Because the figures are not monotone in Stage, no single joules-per-EU constant can put them in the joule bands their Stages' Grades claim in Part Four. Tested at Isaac's 1 EU = 1 MJ, read through η, 28 of 165 figures land in band and the median sits 0.85 decades low; the best single constant, 6.2×10⁶ J/EU, reaches 68 of 165. Each figure's own required constant spans 20.6 decades, from 2.9×10³ J/EU to 1.2×10²⁴, and the residual is Stage-shaped rather than scattered: mean +0.98 decades at Stage III, −0.36 at Stage VII, −2.75 at Stage XII, −11.63 at Stage XIII and −13.69 at Stage XIV. Isaac's own sanity check shows the shape in one line — Iron Fist at 4,800 EU is 4.8 GJ, which is B-grade as he says, while the page that carries it puts Dougou at Stage XIII and "X-Grade at his apex", 11.9 decades above where the joules land.
**Quotes:** FoW VII:83: "**EU (Essence Units)** — the raw reserve. Total volume of usable Essence stored in the Crystal at any moment. Scales with Temperance Stage, governed primarily by **Tempering Yield**." Gimbzo:58: "| **Essence Capacity** | **4.8 × 10¹⁴ EU** — *vast, but the volume sits low. He does not burn essence, he stores it, like a cistern. Endurance fights favour him absolutely* |" Dougou:62: "**Essence Capacity** · 92,000 EU · **Flux Density** 18,400 EU/g · **Aura** SS-Tier Sovereign Tectonic Gravity" Yorime:59: "| **Essence Capacity** | **74,000 EU** — vast but carefully rationed. ***She does not spend freely because every Claim invites hunger***" Part Four's ladder, for scale, FoW II:28 and :40: "| Hollow | 1–10 | below 60 J | below 12.4 m/s |" … "| EX+ | 1,501+ | 6.906×10^37 J and above | FTL and above |"
**Consequence if unresolved:** the Essence Ledger cannot state a joule value for any EU figure, so no working can be priced in real energy, no reserve table can be built by Stage, Tier or Grade, and the tier ladders of WAR-8 have no spine to hang on.
**Recommendation:** none. Both readings are live: either the conversion is not one constant (a per-Stage or per-Grade constant would fit — the median constant each Stage would need is in `imports/essence-ledger/fit.json`, `by_stage`), or a constant holds and the card figures are wrong. Which of those is Isaac's call, and every card figure stays exactly as written until he makes it.
**Status:** open

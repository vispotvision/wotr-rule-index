# Brief — Chapter 2, "Twenty-Two Drops"

Book: night-watch-zombification · POV: Vesk · scene_type: working · Front (proposed): project-zombification · target 3,500 words (set-piece band).
...
{
 "number": 2,
 "title": "Twenty-Two Drops",
 "beat": "The ninth hind lies on the table by the second division and Vesk builds the contractile matrix into his third-dilution formulation, flask in both palms because his hands will not close. Nuvalik opens the shoulder and will not say what she found in the fourth hind; Malphas sits on the gauge bench in the four-degree cold with his fingers the colour of a living man's and asks Foss to get him the Arbitration Division's field manual. Vesk counts the drip, twenty-two a minute, and lets the question of what Stage the Lord is go by again. The work turns from proving rot to making it move.",
 "scene_type": "working",
 "pov": "Vesk",
 "cast": [
  "Vesk",
 ...
 "plants": [
  "H07-warm-hands",
  "H08-concealed-contraction",
  "H09-nuvaliks-three-names",
  "H10-vesks-grafts",
  "H11-the-sky-finishes",
  "H21-the-ninth-hind"
 ],
 "pays": [],
 "time_elapsed": "Day 1; the second division to the ninth",
 "target_words": 3500
}
```
...
- **H07-warm-hands** (planted ch2, due ch60, status planned): Malphas's hands keep a living man's colour in a four-degree coldhouse. Paid in the hearing gallery, at the verdict, as a detail Wystan notices and never explains; never recognition. Keywords: hands, warm, cold, gallery.
- **H08-concealed-contraction** (planted ch2, due ch6, status planned): Nuvalik got contraction out of the fourth hind's shoulder twice and did not report it; Malphas 'will discuss with her separately'. Paid when the discussion happens. Keywords: contraction, shoulder, separately, twice.
- **H09-nuvaliks-three-names** (planted ch2, due ch55, status planned): Nuvalik carries a name three people carried before her and thinks she has spent all three on this work. Paid when she sets down the name she wears in the cell and leaves; she does not inform. Keywords: name, three, set down, leaves.
- **H10-vesks-grafts** (planted ch2, due ch46, status planned): Vesk's grafted fingers, the ridged yellow nails that will not stop growing; the village that put stones on its graves. Paid when he dies of his own formulation and Nuvalik lays stones on his walking body. Keywords: grafts, nails, stones, grave.
- **H11-the-sky-finishes** (planted ch2, due ch38, status planned): 'Where I was raised, the sky finishes what the ground starts, and when the sky refuses, people walk out to see why.' Paid when the ravens will not come down to Tally and he walks. Keywords: sky, ground, ravens, walk out.
- **H21-the-ninth-hind** (planted ch2, due ch10, status planned): 'The ninth hind is the freshest and she is the one I want.' Paid when she stands up off the table and leans to the standpipe. Keywords: ninth hind, table, stood, standpipe.

### Hooks this chapter pays

None (the outline row `pays` is empty).
...
**This chapter's tick:** segment 1, "The dose walks", first of its three pushes (ch2, 6, 10; ch10 fills it when the ninth hind stands). The world change on the page: the contractile matrix goes into Vesk's third-dilution formulation and into the ninth hind by the second division, so the work turns from proving rot to making it move; the POV must see the consequence (the drip counted, the hind dosed and on the table). Segment 1 is not filled here. Mention is not advancement (bible). No Front exists in table/fronts.yaml for this thread; `front_id` stays null and nothing is written to the table.
...
- **No PC in this book.** The standing book rule from bible.md applies in its place: **neither Wystan nor Malphas ever learns of the other.** Malphas knows his hunter only as "the Night Register" (at most "a desk on Cutler Row with a brass token") and designs against the Division field manual as against an institution; he never hears or reads Wystan's name. Nothing noticed across that line is ever paid as recognition, and the narration never winks at the reader who knows both. Malphas is seen, never entered (Vesk's POV only); no Stage is named or implied for him alive, and none of his card's lich-form figures reach the page.
- **Length:** 3,500 words, set-piece band (Table Rule 2: set piece 2,500 minimum with full scene standards).
- **One deliberate lie by an NPC** (Table Rule 8) and **one misreading by the POV character** (R6-4, R5-C1), both declared verbatim in the notes.
- **Italic thought:** R39-7 binds (bible, POV and narration): only the POV (Vesk) thinks in italics; no named NPC gets a private italic thought, which overrides Table Rule 10's "one italic private thought per NPC per scene" for this book.
- **Numbers:** none invented; numbers reach the page only in a mouth, an instrument, a document or a private count (R14-4, R12-5). The crew's cards are stubs with no figures. "Twenty-two a minute" is Vesk's private count.
- **Mechanism:** the bible asks for a wotr-phenomenon pass before drafting ch2 (the contractile matrix leaning down a saturation gradient).

### Standing Inventory (from `session_start "Wystan Ashmore" working Accord`, # STANDING INVENTORY section only)
...
Nothing pending or proposed for these tags; no escalation.

## Scene brief

`scene_brief` with --thread "Wystan Ashmore" --type working --culture Accord --cast Vesk Malphas Nuvalik "Ilmar Foss" (the header reads "Wystan Ashmore" because that is the thread; the POV is Vesk). Loadout dropped (it is §3).
...
Note on the FOW lines: Malphas's figures are the lich form (Stage XIV); per bible.md none of them reaches the page and no Stage is named or implied for the living man.

## Previous chapter

Last 1613 words of ch01/final.md, cut at a paragraph boundary:

> *To Tally, N., North Ferriby walk, by the Timberline chapter.*
>
> *Your insert of the 14th has been read at the Night Register and is open here.*
>
> *I ask you to walk your line again as you walked it before the 11th, and to measure whatever you find on it, lying or standing, with the same rule and in the same way. Write each one down at the time, in a notebook you keep on your person, with the day and the division. I want a second dataset from the same observer. Do not change your method to please me. Where you find nothing, write that you found nothing, and where.*
>
> *Tell me who set the parish marker on the Ferriby line, and when, if anybody knows. Tell me what the animals on that line put their mouths to: water, licks, troughs, anything that is set out and filled.*

He reached the foot of the page and stopped with the pen off the paper.

The clerk at the bulletin office had told Tally the Night Register was a person. It had been true for four years, since the Division wanted a particular officer somewhere else and found him a scullery on Cutler Row with a main that went off at the eleventh division. A desk could be folded into another desk by one line in a Prime Warden's minute. A letter signed with a name would go on being about the name.

He signed it *Night Register, Cutler Row*, dropped a thumb of brass wax beside it, and set the brass in the wax. Then he folded it in three.

"Who carries it?" Yinzhi said.

"The Society's bag goes back with the morning bundle."

"I go past the bulletin office. I could..."

"You could go home."

She had finished her tea. She stood with the empty cup in both hands and did not put it down.

"What happens now," she said. "To the... With me. On the docket."

"Nothing, tonight. Nothing tomorrow, or the day after." He capped the ink. "If it comes to a hearing, and it will not come soon, somebody will stand up and say the assay was eight months capped and burned two coils and cannot say what she read. You will tell them what you read. That is the whole of what an assay of record does."

"I can tell them now."

"I know you can. Go home and sleep, and tell them in a year."

"The chapter will ask where the tin is."

"Tell them it is under my brass at Cutler Row and they may write."

"And you."

"The day desk, at the sixth."

She looked at the sill, at the tin and the fold of paper squared beside it, and back at him.

"You said forty-two," she said.

"Forty-two."

"Then you counted." She put her cup in the sink next to his and did not straighten it. "Eat something, Master Wystan. At the sixth. Something that is not tea."

He heard her go down the outer stair, both flights, and the street door, and then the rain had her.

He turned her cup in the sink so that it stood level with his.

The fifth division went while he was writing up the night, and he counted the bell off toward the river and got it right. He turned back through the day book to the page he had been reading when she knocked, where the margin said *edges* in his hand, and under it *ask Tally who set the marker*. The second half was done. He sat with the first half.

Eleven hinds and a stag inside a quarter mile. The last of them twenty-two paces short of the parish boundary marker. Clean ground on the far side, and Tally had walked it and turned and walked it again, because he was the sort of man who checks the far side twice. Four ravens in the birch that would not come down. And a residue the hind herself had signed, because her own Lattice had run the working to the end.

Somebody had put it into her. That was the part with a hand in it.

*A dose goes where it is put.*

He wrote it under *edges*, in smaller letters, and then he wrote out the rest of it underneath in the plain sentences a memorandum would need. Whatever the formulator had put into those animals had stopped where he stopped putting it, because a man who works at a distance from his own work has to choose the distance, and every site in the four counties would show the same hard margin once somebody walked it with a rule. The Swale walks would have an edge. The two chapters in the eastern timber would have edges. Whatever the Marches man had tried to draw would have one. A man who kept away from what he made would leave his edges behind him wherever he went, as reliably as a signature.

He read it over. It held.

At the back of the book, on the pages he kept for them, he entered the forty-second minute beneath the other forty-one. *Hind, North Ferriby cut. Not frightened. Did not suffer.* He left the line after it clear and ruled it off.

The main came back at the sixth division.

It started under the flags as a note too low to be a note and came up through the legs of the bench and into the window glass, which took it and held it. The kettle lid buzzed once on the kettle. Out in the front room the meter beside the door ticked, and he knew without looking that its needle had come off the pin under the Board's seal and the bill for Cutler Row was running again. His shoulders came down. He had not noticed they were up.

He wrote the time in the margin: *main on, 6th.*

Then he took the tin. He lifted it the way he lifted everything, two fingers and a thumb at the rim of the lid and the base, and he took the docket form in the other hand, and he went out through the front room and along the passage, where the hum ran under the boards the whole length of the house, and up the four steps to the front of the building where the Division kept its day desk.

The day desk was a long counter under the street windows with a brass rail across the front of it for the public to stand behind. The stove in the corner was cold. The chalk slate showed yesterday's filings, and the docket book stood on its lectern at the near end, shut, with the ribbon hanging out of it at the current page.

He set the tin on the counter and opened the book.

Ferriby was four pages back. A day clerk had entered it in the copying hand, the Bureau's return pinned to the leaf beside it, signed in its own ink: *Wellspring bleed, Verdantia, tertiary expression, no operator indicated. No further action. No file. E. Brack, Lattice Classification Bureau, northern office.* Two lines had been ruled under it in red. In the margin, in the day desk's hand, *closed.*

He did not disturb any of it. He dipped the day desk's pen and wrote beneath the red.

> *Memorandum of the Night Register. The filing above is opened this division as a Register file, Ferriby. Exhibit one is held at Cutler Row under the officer's brass. The assay of record is named at the head of the Register docket, laid in. Chapter wax is retained, four pieces, for custody. The measurement above is not disputed. W. Ashmore, Warden of Duty.*

In the margin, level with Brack's line, he wrote one word. *edges.*

He folded the docket form once, with her name inward, and laid it in the book at the page.

The street door let in rain and a day clerk. He was a man of fifty or so, bald across the crown with a short fringe of grey above the ears, clean-shaven, his face gone red from the walk. He was heavy through the belly under a brown day-coat buttoned one hole wrong, and he had black sateen oversleeves on to keep the ink off his cuffs, with a wen at the side of his nose that he touched when he was thinking. He shook his hat out on the mat.

"Still on the main, Master Ashmore?"

"Since the sixth."

"Good. Good. Our lane was off half the night, the whole of it. Wife sat up with the lamp." He came down the counter peeling his gloves. "What have you got there, then?"

"Ferriby."

The clerk leaned in over the book where Wystan's finger lay. His lips moved on the Bureau's line. "Bleed. No operator. That's Brack's, that is." He nodded at it, satisfied. "That's closed, that one. Came back the other day."

He shut the book over the memorandum, over the folded docket and the one word in the margin, took it off the lectern in both arms and slid it into its place on the shelf behind the counter, spine out. Then he went to the stove and got down on his knees in front of it with the spill-jar.

"You'll want this lit, Master," he said, to the grate. "You look perished."

Wystan picked up the tin by its rim, two fingers and a thumb, and carried it back down the passage over the hum to the sill, and set it beside the fold of chapter wax, and laid his brass on the lid.

## Cast

state.json has no facts about any cast member yet, so each gets the full card (capped at 6,000 characters). All four have cards.
...
Formulation and synthesis. Built the Verdantia formulation, third dilution, introduced live and carried on the animal's own circulation. Wellspring harmonisations pending Isaac.
...
Malphas, whom he calls Lord and a genius. Pending Isaac beyond that.
...
Two grafts on the hands. His fingers are long and were longer before the second graft; the nails on the two that took came in ridged and yellow and grow at a rate that embarrasses him. His hands no longer close properly, so he carries things out in front of him in both palms, the way a server carries wine. Remaining inventory pending Isaac.

###### XIV · Psychology

Loses most thoughts now, the way he loses most things, and keeps the pleasure. Delights in the dead getting up. Has watched eleven days for a sign of what Stage Malphas is and has not asked. Counts things he cannot stop hearing: the coldhouse drip, twenty-two a minute.

###### XV · Equipment

The flask. Pending Isaac beyond that.
...
Pending Isaac. The hand grafts may belong here or in Physical Description; pending Isaac.

---

*Source: The Night's Watch (scenes/the_nights_watch.md). Project Zombification.*
...
> **Second Catalyst · Stage XIV, Zenith. The Becoming.** Recognition, this time, from something that does not sit on a throne. What answered when he stopped working alone at Invocation had been waiting the entire span between for him to run out of body.
>
> He did not die in the conventional sense and did not seek out a lichdom in the conventional sense either. **The overload he'd been carrying since the day he named it a strength found somewhere permanent to go.** His Essence Core, already restructured and already anomalous, had a second home built for it long before he understood it needed one. Moving in was less a working than an admission.
>
> **Avatar of Death is not this entry.** That is further out, and further up, and this is the doorway he walked through to get within reach of it — not the destination.

---

##### I.V · The Becoming, in the Body

What's left of him reads as a hood and a robe before it reads as a person — black cloth gone to rag at every hem, moving on air that has better things to do than move. The skull inside the hood is bone the color of old parchment, jaw loose, a scatter of small gold crosses hung at throat height that nobody has asked him about twice. A crown of pale spurs rises off the skull in place of hair, uneven, the way something grows rather than the way something is worn. What he carries is long, dark-bladed, etched gold along the fuller — the same gold as the crosses, the same gold as the Remnant.
The Golden Remnant travels at his hip or a half-pace behind, small enough to be mistaken for a hunched attendant until the light catches it: a lesser skeleton worked entirely in bone-gold, spurred the same way he is, a second small skull chained at its collar and swinging faintly whether or not anything nearby is causing air to move. It does not walk like a construct walks. It walks like something that used to have somewhere to be and hasn't lost the habit.
Nothing about either body has weight in the way a living thing has weight. Both cast the wrong kind of shadow in bright light, thin and doubled, as though the sun hasn't fully decided how many of him there are to shade.
...
**Dissolution** · Limina. **Primary.** Solvation driven by the entropy of mixing — a solid dissolves not because the solvent attacks it but because the mixed state has higher entropy, and the process runs on its own once initiated. *Failure: entropy does not consult the practitioner about which structures were load-bearing.*
**Mortalis** · Vitalia. **Co-primary as of the Becoming.** Venous black-red, no longer the decay half of him but the whole of the ground he stands on. He does not channel Mortalis the way a living practitioner borrows a current he'll eventually step out of. He is standing in his own.
**Solfatara** · Caloria. Deep sulphurous red. The volcanic register, the fume, the miasma.
**Nihiloth** · Limina. Destructive interference — a Nihiloth Domain does not impose law, it cancels the law already present. And the cancellation is symmetric: everything he brings inside is subject to the same null, including the parts of himself he was relying on. **Post-Becoming, that symmetry costs him nothing new. There's nothing left in him a null can take that the split housing hasn't already priced in.**
...
Anatomy and the ferment. Works the carcasses and reads what the ferment did: the connective scaffold is eaten and the cells are left, so a hind stands structurally liquid and cellularly whole, held up only by the hide. Got contraction out of the fourth hind's shoulder twice and did not report it. Wellspring harmonisations pending Isaac.
...
The three dead whose name she carries; the kin-turns that follow from them are pending Isaac.
...
Works with her sleeves pushed past the elbow and an apron on. Doesn't ask for the lamp to be brought closer. Remaining inventory pending Isaac.

###### XIV · Psychology

Wipes the blade before she speaks, which is the one thing about her that frightens Vesk. Has objected twice that a carcass no bird will touch stays where it fell and gets counted. Her proverb: where she was raised, the sky finishes what the ground starts, and when the sky refuses, people walk out to see why. Her private thought on the page: she has spent all three names for this body on this work. Hesitates before fetching the hook for the ninth hind, then goes.

###### XV · Equipment

Butchering knife; the hook.
...
*Source: The Night's Watch (scenes/the_nights_watch.md). The sky proverb is a Far-Northern Standing Inventory candidate, pending Isaac.*
...
Coil and instrument work. Understands attribution practice from the inside. He is the one who states why the Ferriby residue reads clean: nothing in the cell ever couples, and the deer's own Lattice runs the working and signs it. Wellspring harmonisations pending Isaac.
...
The steadiest hands in the building. Works with a jeweller's glass screwed into his eye. Remaining inventory pending Isaac.

###### XIV · Psychology

Calls the synthesis filthy and says so. Vesk reads him as a man who still explains things as though he expects an appeal hearing. Presses Malphas on the walking dose: no Crystal, no self, no reason to do anything.

###### XV · Equipment

Jeweller's glass; coils in pieces on the bench.
...
Only Malphas appears in `voice_fingerprints` (Vesk, Nuvalik and Foss have fewer than eight attributed lines). Rule: if two characters' lines could be swapped and nobody noticed, the scene failed (R15-1-VOICE_DIFFERENTIATION).
...
### scene_recall "ninth hind contractile matrix formulation drip"

#### The Night's Watch  (the_nights_watch.md, score 95)
[WHAT DOES NOT SMELL DEAD] "The new matrix is contractile," Malphas said. "Nuvalik has already got contraction out of the fourth hind's shoulder twice and did not think it worth mentioning, which I will discuss with her separately. Contractile tissue in a saturation gradient does what every growing thing in the world does, which is lean. It does...
[WHAT DOES NOT SMELL DEAD] Vesk got in ahead of Foss this time, because the growth was his. "Verdantia formulation, third dilution, introduced live and carried on the animal's own circulation. The Green Pulse does not repair, it grows, and that is exactly why it is the correct Wellspring for this and why nobody has used it this way. Put growth i...
...
#### Commencement of The Curia. [ Kujo Arc ]  (commencement_of_the_curia_kujo_arc.md, score 92)
[Commencement of The Curia. [ Kujo Arc ]] He watched it happen on the back of his own left hand and had no framework for it whatsoever. The Lattice inside him was expressing outward through the flesh, and it was doing it as a tiling, plane-filling, a regular partition of the whole surface of him into cells that met edge to edge with no gap and no overlap anywh...
[Commencement of The Curia. [ Kujo Arc ]] A knee from the clinch is not a kick and has no arc and needs no distance. The hip travels perhaps eight inches and the whole mass of the trunk goes with it through a joint that is already the hardest thing in the lower body, and the reason it is the Thai national answer to everything is that it works at a range where ...
...
[The_Path_of_Sorrow] *Encounter density: one per kilometer in valleys. Three to four in gulches. D-tier territorial, aggro-locked. Emira cannot run. Yōko cannot fight. I am the only combat asset in a three-person party with an average threat level of F-minus and a total Essence pool that is 99.6% concentrated in one member. If I take a hit...
...
#### The Second Law, Held Open  (11_mujin_second_law_held_open.md, score 43)
[Added by the gap-fill pass (Pack Thirteen §5)] **Research consulted, per §7.** Verwey transition in magnetite (transition temperature, cubic to monoclinic, easy-axis rotation, two-order resistivity drop, ferroelastic twinning). Frostbite pathophysiology (extracellular then intracellular ice, osmotic dehydration, reperfusion injury at four to eight hours). *Fracture...
[Added by the gap-fill pass (Pack Thirteen §5)] **Injury by structure.** Frostbite in the correct order: extracellular ice first in the tissue spaces, osmotic withdrawal of water from the cells behind it, the cells shrinking and dying of thirst inside an ice field. Three fingers of the left hand are already past recovery. The pain arrives four to eight hours after w...
...our hundred paces of men dying with their workings half made, from whatever the old man did in the sky at the ninth hour, and now from me, and the density in this valley is a hundred times what the district main at Sum-gol ca...
...go their whole lives without it changing by a Grade, and whatever Kaalabad had carried onto this road at the ninth hour, he was not carrying it now.  *Depth. It is Depth and it is Flux behind it, and I have been reading the...

#### What the Plate Would Not Take  (what_the_plate_would_not_take.md, score 40)
[IV. WHAT IT COSTS] A compressed resonance field is silent in the Aether and reads like nothing. An open one floods the local volume with a known quantity, and every disturbance in that volume now stands against a reference he had made himself, which is the difference between listening in a dark room and listening in a dark room you have ...
[Author notes] Arc: The Elven Crisis. POV Ruvaen Aloreth. Vaelmarr drill ground, year eleven. Conversion log (Pack Sixteen), Isaac's rough to page: vibration/aberration to laminar flow and turbulent wake; "molecular particles smoothing out and becoming wild" to laminar going turbulent over a moving body; "aether shifted on the plane"...
...et cleanly on the second pass without opening.*  *He opened today on the fourth throw. Last winter it was the ninth.*  Lunn Aeveth, nineteen and four months on the wall, bent down and picked up one of the halves and turned it...
...ad turned on the same eight feet of it, and the paste had dried, and it took the weight with a chalky give. Behind him the sea gate winch was working. Two hundred and forty links of chain coming over an iron drum, and the dr...

#### Bulwark  (02_wren_bulwark.md, score 39)
[Notes (author-facing, not canon)] **One fix.** Your paste has the space closing around *Bram*. Bram is at the southern reach with three hundred men. I read it as Wren and wrote Wren. **Register split, per Pack Twelve.** The aurora is Mystic: the sky does a thing, nobody explains it, no causal account anywhere. The duel is Technical: exhaustive, tactica...
[Notes (author-facing, not canon)] *Bulwark.* **Effect** — the shield's whole face takes an identical share of an impact instead of the boss taking it. Blue at the boss, spreading to the rim, leaving grey behind. **Cost** — the grey is spent capacity and does not come back inside a fight. Three deliveries is the historical number and this one took a thi...
...wark  *The Ashgate road, within sight of the Kharven gates.*  ---  The sky over the north went to work at the ninth hour and did not consult anybody.  It began as a thickening. The cloud base did not move and did not break, a...
...need to come out any other way, because the whole of it had been designed to happen in a place with a gate behind it and no room to reform.  Wren had walked the ground in the summer under a false name with a hired cart and...

#### Punta  (22_darius_punta.md, score 38)
...
[Dead Preparation, and the two-part answer] **First half, from the ash.** *A man who is ready for everything is throwing nothing.* That is **co-contraction** and it is real biomechanics: agonist braced against antagonist stiffens a joint, and a stiff joint accelerates slowly and delivers less. It is the first thing anybody learns about power generation and it is...

#### Five Numbers  (19_aurelian_five_numbers.md, score 36)
[Three things the sheet gave me that I could not have invented] **Paru 63's Cost/Backlash: *current inverts if Boundary glyph is absent; caster pulled too.*** Your sequence puts 75 immediately after 63, and the Codex says 63 *requires* it. Formed Boundary is not an addition to the combination; it is the failure-mode fix, and it is written in the entry. Darius says "Boundary" out lo...
[Five Numbers] A Formed Boundary anchors against domain bleed. Ensoulment is a domain operation. Mending Aether across a break is a domain operation. Formulating Essence into a new expression is a domain operation, and every one of them requires bleed across a border that had just been declared closed by a working whose entire Family...

### scene_recall "Vesk Malphas Nuvalik Foss Greyshaft Nine coldhouse"
...
...Nine hinds hung on the rail. They had been on the rail eleven days.  There was no smell.  That was the part Vesk still went and stood in front of, on the nights when the work was slow. A coldhouse with nine carcasses in it...

#### Nine Hours of Daylight  (nine_hours_of_daylight.md, score 44)
...
[Author notes] Arc: The Elven Crisis, under the Ilthára Korvaeth / The New World thread. POV Ruvaen Aloreth. Coldwater common, continuing; ends with him starting up the quarry stair. RP post; Dova'Kan, Gorgi and Xmere not written. The dragon lying down is the ignorance quota. A mass that size entering a volume should displace what is...
...# Nine Hours of Daylight  *Coldwater common, continued.* *POV: Ruvaen Aloreth. RP reply. Dova'Kan, Gorgi and Xmere a...
...ll that makes a man who has never been in a war understand what he has walked into, and there is one of those nine miles north of here with four hundred animals in it and it has been open since the Thin Weeks because we have...

#### The War in the North I — The Kharven-Seat  (the_war_in_the_north_i_the_kharven_seat.md, score 41)
[Author notes] Flags for Isaac, none resolved. 1. Büri / Moto. The text reads "Muken Büri's north wall survey". The Ledger and the State of Play carry him as Muken Moto, and "Temür" is a Mongolian-register name in a room that otherwise runs Stark and Ice. The Büri / Moto definitive ruling is still open on the Docket, so both stand un...
...
...agrees with you." Lambert raised his voice half a register without changing anything else about it. "Mistress Foss. Leave the stack. It will be eleven short whether or not you count it a third time."  The door came open on a...
...eat out of the room at knee height, and the woman who came through it filled the frame side to side.  Rannvei Foss stood a hand shorter than Lorn and carried twice his weight through the shoulders and the back, the kind of b...

#### In Form  (in_form.md, score 40)
[In Form] *Coldwater common, continued.* *POV: Ruvaen Aloreth. RP reply. Dova'Kan, Gorgi, Xmere and Avo'Kan are not written; their beats stay open.* ---
[Author notes] Arc: The Elven Crisis, under the Ilthára Korvaeth / The New World thread. POV Ruvaen Aloreth. Coldwater common, continuing. RP post; Dova'Kan, Gorgi and Xmere not written. He takes the High Vaeloris correction and does not defend the Archive. For an Eressean the shame is not ignorance but having called a thing by a nam...

#### A Silence in the Chord  (00_SUPERSEDED_wrong_names.md, score 40)
[Onawa, and why the beheading works] Her card is Level 300, Stage X, Grade A across every Primary Stat, a Realm-tier Domain that holds lesser Domains, a mile-and-a-half pressure field with the mask down. She cannot be killed in a fight. Her listed vulnerabilities are **consecrated and warded ground, direct harm to the raven, and prolonged separation from ...
[The fracture, each branch answering in its own grammar] **Velthaeir** enters a finding in the sealed register and publishes nothing. **The Eladrin** send no letter and answer with a count, and a silence held past nine has moved out of language into judgement, and every Concord observer transcribes the exchange as having had nothing said in it. **The Echo Elves** split clean...
...ears the Old Faces, came to Greysalt under parley on the ninth day of the withheld season with a household of nine and a raven on her shoulder and the First Ash Mask worn crownwise, as she had worn it since her mother's fune...
...en is in a position to tell them.  The Reach listens. Something in the tree line always notices first. Within nine days every Tsohanto barrow-ground in the New World had gone to the specific stillness of a place already grie...

#### The Hatch  (the_hatch.md, score 40)
[The Hatch] *Coldwater common. Late morning, the second day.* *POV: Ruvaen Aloreth. RP reply. Dova'Kan, Gorgi and Xmere are not written; their beats stay open.* ---
[Author notes] Arc: The Elven Crisis, under the Ilthára Korvaeth / The New World thread. POV Ruvaen Aloreth. Coldwater common, late morning of the second day. RP post; Dova'Kan, Gorgi and Xmere not written. Flagged unrepaired: R39-7, this post predates the compliance pass and the POV lock is clean here but the scene sits in a run whe...

#### The Vacancy  (01_the_vacancy_korvaeth_arc.md, score 39)
[IV. ELEVEN ASKED] **House Vhelor** came for money. **House Aarenn** came because Vhelor came. **House Serath-Lo** came because their charter runs through Korvaeth's own vault and they had no other option, and their delegate said so out loud, in form, which everybody in the room respected and nobody forgot. **House Mirroven** came last a...
[The branches, each in its own grammar] **The Sylvaaren** refuse to be asked, and Aardhae's reply is the useful one: *elarieur* is valid self-witness, which means **Ilthára has a name after all if she wants it**. She refuses in eleven words now carved above the eastern door: *"I will not hold my name from a forest I have never stood in."*
...measures.  Maren Vaeleth had opinions.  She kept them where she kept the Vosk woman's granddaughter, who was nine, and who was standing in the fourth rank of the yard with her grandmother's hand shut around her wrist becaus...
...r up herself. Anyone who had ever seen a coronation would have known it, because the imperial coil is done in nine passes by two attendants and cannot be done in fewer, and what was on Onawa's head that morning was four pass...

#### No Entry For That  (no_entry_for_that.md, score 39)
[No Entry For That] *Part One: the quarry stair above Coldwater, first light.* *Part Two: the Korvaeth camp above Harrowbeck, the same morning.* *POV: Ruvaen Aloreth, then Aeldros Korvaeth. RP reply. Dova'Kan, Gorgi and Xmere are not written; their beats stay open.* ---
[Author notes] Arc: The Elven Crisis, under the Ilthára Korvaeth / The New World thread. Two movements. Part One POV Ruvaen Aloreth on the quarry stair; Part Two POV Aeldros Korvaeth at the Korvaeth camp above Harrowbeck, the same morning. RP post; Dova'Kan, Gorgi and Xmere not written. R39-7 compliant in both movements. Only the POV...

### wiki "Arbitration Division" (hit list and snippets only; full pages trimmed)

#### Value, Coin and Trade  (Geography & the Four Quarters/Value, Coin and Trade.md, score 87)
[The Art of Trade, Through the Ages] The second-order effect is the one the Arbitration Division watches. A market in claims on a falling quantity **rewards whoever is willing to promise delivery he cannot make**, because the penalty falls due later and the premium is paid now. Four houses have failed on delivery in the last decade. *Each failure was desc...
[What Is Actually Valuable] Stated highest first, **in the sequence the Arbitration Division pays creditors when a bankrupt estate is divided.** This ordering is not sentiment. It is the most honest statement of value the Accord has ever produced. | Rank | Asset | |---|---| | **First** | **Contracted Essence supply.** A secured right to delivery ...
...yone, and enforced by nobody.  ---  ## What Is Actually Valuable  Stated highest first, **in the sequence the Arbitration Division pays creditors when a bankrupt estate is divided.** This ordering is not sentiment. It is the most h...
...ate sitting on a strong steady source will outprice a river valley of the finest wheat ground by a factor the Arbitration Division has stopped finding remarkable, because the wheat ground can be bought and **the source cannot be mo...

#### Haelvorn · Housecat  (Summoned and Bound/Haelvorn · Housecat.md, score 86)
[XII · Attested Encounters] Norbu Waymark, senior guide of the waystation, is recorded as having certified the Guild's version of the account, and nothing further about his role is entered here because nothing further is established. **The Kegshard Relief**, Accord Archive, Arbitration Division report, dated. The refusal to close on a column thre...
[XI · Counterplay] The Arbitration Division's field guidance recommends this. It is worth writing down plainly that the Accord's standard answer to its own registered asset is to make its summoner die of the working, and that the guidance has been distributed to units who have never been told what it does. **Radiant current** is nearly u...
...*Accord Classification** | Registered, Division of Concordia, then reclassified without her consent under the Arbitration Division's ordnance schedule following the Thinbreath filings. Rimsang's written objection is attached to the...
...scharge routes the entire return into Rimsang, which ends the engagement in under a minute by ending her. The Arbitration Division's field guidance recommends this. It is worth writing down plainly that the Accord's standard answer...

#### The Rites  (The War Cycle/The Rites.md, score 80)
[The Consent Apparatus] > *Reproduced in full at the direction of the Arbitration Division and over the objection of the Bench of Attribution, whose stated ground was that publication serves no purpose. The Division's reply was that this was correct and that it would be published anyway.*
[The Rites] *Burial, Exclusion, and the Consent of the Dead* > Compiled by the Research and Archives Division from parish rolls, hold-records, and the returns of the Bench of Attribution. **The consent schedules are reproduced in full at the direction of the Arbitration Division and over the objection of the Bench.** >  > *Eighth ...
...sistent with local tradition.**  ---  ## The Consent Apparatus  > *Reproduced in full at the direction of the Arbitration Division and over the objection of the Bench of Attribution, whose stated ground was that publication serves...

#### Seren Valenne · The Grey Adjudicator  (Volume I — Character Cards/Seren Valenne · The Grey Adjudicator.md, score 77)
[Affiliation] **Guild Accord · Arbitration Division · Arbitration Adjudicator, Senior.** Assigned to the **Neutral Chambers** of the Inner World. Jurisdiction: disputes of Concord Law, Divine Sanction, and Temperance violations. *In current canon the Division's brief is diplomacy, treaty enforcement, mediation between nations and ad...
[IX · Relationships] **The Arbitration Division** · Peers call them the Grey Adjudicator. **Famed for never raising their voice nor drawing a weapon, and for quelling conflicts that once became interrealm wars.** **Kaelrith Dorne, the Iron Wound** · *Taken from his card rather than theirs.* **Unofficial reports say Seren invoked his aid du...
...**Name** · Seren Valenne. **Called** · The Grey Adjudicator. **Role** · **Adjudicator of the Guild Accord's Arbitration Division. Mediator of divine, political and Wellspring-related disputes. A living instrument of Concord Law.*...
...the name of a working reaches the page in a reading, never in narration.*  #### Affiliation  **Guild Accord · Arbitration Division · Arbitration Adjudicator, Senior.** Assigned to the **Neutral Chambers** of the Inner World. Jurisd...

#### Tsukihana Reimei · Moon-Bloom at Dawn  (Volume I — Character Cards/Tsukihana Reimei · Moon-Bloom at Dawn.md, score 75)
[IX · Relationships] **High Arbiter Saen** · Mentor, in the Arbitration Division *(unattested)*. **The Arbitration Division** · Noticed her gift and trained it. **The Enforcement Division** · Took her after the Oath. **The fae** · **Call her Hana-no-Kagami**, said to appear wherever dreams must be judged for truth. **The Well-born entity**...
[Affiliation] **Guild Accord, Enforcement Division.** *Her fae lineage nearly branded her heretic under Concord law; her gift for reflection rites drew notice from the Arbitration Division instead.* **Trained under High Arbiter Saen** *(unattested)*, then transferred to Enforcement after mastering the *Mirror Garden Oath* *(unattest...
...hether the Mirror Garden is hers or its.  ---  ### IX · Relationships  **High Arbiter Saen** · Mentor, in the Arbitration Division *(unattested)*. **The Arbitration Division** · Noticed her gift and trained it. **The Enforcement Di...

#### Argen Vael'thar · The White Arbiter  (Volume I — Character Cards/Argen Vael'thar · The White Arbiter.md, score 73)
[Affiliation] **Guild Accord, Arbitration Division**, at its head. **Reports only to the High Concordant.** *The longest-serving Prime Arbiter in recorded Accord history, credited with rewriting nearly a quarter of the Codex of Absolute Magical Law after the Crevice Wars (unattested).* **Fewer than five Total Severances sanctioned i...
[IX · Relationships] **The High Concordant** · **The only office he reports to.** **The Concord Council** · He sits on it as Prime Arbiter, beside the High Warden and the High Marshal. **Saphri** · Companion, aide, anchor. *The one bond the sheet is built on.* **Young Sealwrights** · His students, in Eresse. *"Every law begins as a confess...
...Called** · The White Arbiter. *Merciful Iron.* **Role** · **Prime Arbiter of the Concord Council. Head of the Arbitration Division. Overseer of every Concord Trial and Severance.** **Lineage** · Human, born in Eresse, New World. *H...
...sation as if they were scripture. The diagnostic mouth is his profession.*  #### Affiliation  **Guild Accord, Arbitration Division**, at its head. **Reports only to the High Concordant.** *The longest-serving Prime Arbiter in recor...

### wiki "Stage" (hit list and snippets only; full pages trimmed)

#### The Sixteen Stages  (The Magic System/The Sixteen Stages.md, score 99)
[VII — Refraction] ---
[The Ladder at a Glance] ---
...# The Sixteen Stages  *What Temperance Does to a Soul, Stage by Stage, Told Plainly* > Compiled for the Prime Instructors of the...
...# The Sixteen Stages  *What Temperance Does to a Soul, Stage by Stage, Told Plainly* > Compiled for the Prime Instructors of the Guild Accord at the direction of the Rese...

#### VI. The Sixteen Temperance Stages (Part Sixteen)  (Fracture of Worlds — The Living System/VI. The Sixteen Temperance Stages (Part Sixteen).md, score 95)
[Stage I — Murmuring (Tier 1 · Initiate)] The Crystal has opened. Essence stirs but cannot be directed. The practitioner feels power as noise, a hum beneath the skin that responds to emotion but not to intent. All Sub-Stats present but volatile. Output unreliable and heavily mood-dependent. **Max Grade E. Ceiling 50.** The world has noticed you. You have not y...
[Stage VI — Glory (Tier 5 · Expert)] Peak of the inner phase. The self burns bright and is noticed. The Aura begins generating genuine environmental effects. Techniques carry the weight of identity rather than improvisation. The Crystal has processed Splintering's fractures into features. **Aether Class emerges and the Echo field forms.** **Max Grade A. C...
...# VI. The Sixteen Temperance Stages (Part Sixteen)  *"Temperance is not a buff. It is a confession of how much you've survived."* Each Stage is...
...nce Stages (Part Sixteen)  *"Temperance is not a buff. It is a confession of how much you've survived."* Each Stage is a qualitative transformation in the Crystal's architecture. The Stages are not sequential achievements to...

#### A Reader's Codex  (Reference Table/A Reader's Codex.md, score 80)
[The Ladder] Glory is the first Stage whose Catalyst is a decision rather than an accident, a choice to accept real cost for something the practitioner values more than their own structural integrity. Refraction is the Stage at which the Crystal becomes an object a person can look at, which means the fracture record Splintering wro...
[A Short Glossary of Forty Terms] Subtraction and reorganization, not accumulation. **Stage**: one of the sixteen structural reorganizations a Crystal undergoes under pressure. **Level and Band**: Level counts how far a Crystal has densified, from 1 to a ceiling of 500 that only Revelation and Apex pass, uncounted; the five Bands are its hundreds: Mort...
...mperance, and Temperance is subtraction, not accumulation. A practitioner does not train their way up sixteen Stages. They survive something that structurally reorganizes the Crystal, and the Stage that results is built out o...
...train their way up sixteen Stages. They survive something that structurally reorganizes the Crystal, and the Stage that results is built out of whatever was actually in the Crystal at the moment it broke and reformed. Nine s...

#### Speculum Harmoniae  (Techniques/Speculum Harmoniae.md, score 79)
[Design Chain] ---
[Design Chain] ---
...the live line back to her. **Craft** · Spellcraft, gestured (a circle traced in the air around the target). **Stage floor** · Stage V, Splintering. **Grade required** · B-Grade (Splintering's ceiling; instability risk above 3...
...ck to her. **Craft** · Spellcraft, gestured (a circle traced in the air around the target). **Stage floor** · Stage V, Splintering. **Grade required** · B-Grade (Splintering's ceiling; instability risk above 320). **Path gate...

#### I. Levels, Experience and Stat Points (Parts One–Three)  (Fracture of Worlds — The Living System/I. Levels, Experience and Stat Points (Parts One–Three).md, score 42)
...evel Structure  #### The Hard Cap  The system operates on a maximum of Level 500 for every practitioner below Stage XV. This number is not arbitrary. It represents the structural limit of what a mortal Soul Crystal can contai...
...al can contain before the distinction between practitioner and Principle collapses entirely. Characters below Stage XV who reach Level 500 and continue to accumulate sufficient Soul Crystal pressure do not advance in level. T...

#### II. Grades, Gates and Thresholds (Parts Four–Ten)  (Fracture of Worlds — The Living System/II. Grades, Gates and Thresholds (Parts Four–Ten).md, score 42)
...ly engage, resist, or overcome. It is derived from a Sub-Stat's raw numeric value and confirmed by Temperance Stage. A stat cannot hold its Tier Grade if the Soul Crystal has not undergone the Threshold required to sustain th...
...or fail to survive. Brown Dwarf level and beyond, scaling toward stellar and solar-system scale. At **Zenith, Stage XIV**, speed and attack output are no longer assessed by conventional metrics. The character exists in a stat...

## Continuity

### Facts (cast or place)

state.json `facts` is empty: no facts recorded yet about Vesk, Malphas, Nuvalik, Ilmar Foss or Greyshaft Nine (and none of kind "lie").

### Summaries of prior chapters

state.json `summaries` is empty: ch01 was drafted and gated PASS (ch01/GATE.md) but its summary has not been carried into state.json. For reference only, ch01/final_notes.md "Summary for continuity" (not yet in the book's memory):

The same night, from the fourth division to the sixth. Wystan checks and blots Yinzhi's full name at the docket head (the name is not rendered) and enters her as assay of record. Gloved, he moves the Ferriby wedge with forceps into a fresh Division Fixatio tin, seals it with brass wax and strikes his brass into the seal. He logs it in the day book as Register file Ferriby, exhibit one, "crown +¼ in sealed." He collects the four pieces of chapter wax: two were on the front-room blotter and two under the desk. The pieces fit the join. He folds them in a druggist's paper, dates it on the outside and keeps it for custody. Over grounding tea he asks whether the bracelet is still pulling, and Yinzhi says no. He drafts a nine-word wire, rejects it and writes a letter to Tally instead: walk the line and measure into a notebook, a second dataset from the same observer, who set the marker, and what the animals put their mouths to. He signs it "Night Register, Cutler Row." He sends Yinzhi home. He enters the Register's position, "A dose goes where it is put," and records the forty-second minute. The main returns at the sixth division. At the day desk he writes his memorandum under Brack's closed classification, with *edges* in the margin. A day clerk reads only the classification and shelves the book.

### Hook agenda

Planted or advanced hooks due by ch05: none.

OVERDUE (due before ch02, unpaid): none.

Note: every hook in state.json is still status "planned", including the eight ch01 planted (H01–H06, H23, H24 per ch01/GATE.md). Nearest dues on the book's calendar: H08-concealed-contraction (planted here, due ch06), H01-far-side-of-the-marker (due ch07), H21-the-ninth-hind (planted here, due ch10).

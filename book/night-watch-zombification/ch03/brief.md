# Brief — Chapter 3, "The Morning Check"
...
```json
{
 ...
 "beat": "Wystan wakes at noon with his hands shaking, reads Keld's minute against the written record as he does every morning, and walks to the medical house where Keld sits at a window still waiting for a relief that came too late. At the day desk Prime Warden Elspeth Lyle reads the edges memorandum and tells him the Register may keep a curiosity open until the quarterly inspection of the gauge-housing and not a day longer. Brack stops him in the corridor, stands by his classification, and hands over the Bureau's raw readings unasked; in Lyle's closed room Wystan feels the day's residue settle on his skin as it always does and does not remark it. He knows he will get a hand and not a purse, and says so to Brack in those words.",
 "scene_type": "quiet",
 "pov": "Wystan Ashmore",
 "cast": [
  "Wystan Ashmore",
 ...
 "place": "the Division's medical house and the Arbitration Division's northern office, the day desk",
 "front_id": null,
 ...
 "plants": [
  ...
  "H14-brass-token",
  "H15-six-who-know",
  "H32-hand-never-purse"
 ],
 "pays": [],
 "time_elapsed": "Day 1; noon to the ninth division",
 "target_words": 3500
}
```
...
- **H12-kelds-minute** (planted ch3, due ch72, status planned). Keld's minute, taken off a door handle, lucid, waiting for relief; checked every morning against a written record. It slips by a word after Cutler Row; paid when it is set right at Keld's bedside. Keywords: Keld, minute, written record, relief.
- **H13-low-ground-sink** (planted ch3, due ch44, status planned). Wystan's Shell rests near zero saturation; free residue in a closed volume runs toward him. The dead lean to the quiet. He believes they are being sent to him; paid when he learns he is the sink and nobody sent them. Keywords: sink, lowest, lean, nobody sent.
- **H14-brass-token** (planted ch3, due ch72, status planned). The Register token is brass, not silver, because the Night Register is not a full desk, and he has never asked to have it changed. Paid when he hands it in. Keywords: brass, token, silver, handed.
- **H15-six-who-know** (planted ch3, due ch64, status planned). Suppression held waking and sleeping; six people alive know what Stage he is. Paid when he drops it in the death-house and the whole cordon knows. Keywords: Stage, six, cordon, knew.
- **H32-hand-never-purse** (planted ch3, due ch76, status planned). His technique gets the hand, never the purse; Article XV prosecutes only the purse. This case inverts it. Paid when he teaches it: the hand or the purse, never both. Keywords: hand, purse, never, both.
...
**This chapter's tick:** segment 1, "Exhibit one", second of its five pushes (ch1, 3, 5, 7, 12; ch12 fills it). Mention is not advancement (bible): the world changes here when the Prime Warden reads the edges memorandum and sets a term on the file — the Register may keep "a curiosity" open until the quarterly inspection of the gauge-housing and not a day longer — and when Brack hands over the Bureau's raw readings unasked, so the file now holds a second institution's measurements. The POV sees the consequence: a deadline on the file, and data he did not have. The segment is not filled. `front_id` stays null; nothing is written to `table/fronts.yaml` (needs `add_front` on Isaac's word).
...
- **No PC in this book.** The standing book rule from bible.md applies in its place: **neither Wystan nor Malphas ever learns of the other.** Wystan knows his quarry only as "the formulator," "the man who never goes near them" (never "the Lord", which he has never heard); no file he can read names the hand. Nothing noticed across that line is ever paid as recognition, and the narration never winks at the reader who knows both. The anti-exemplar in the outline's voice note ("Somewhere out there a man with warm hands was watching…") is exactly what is forbidden.
- **Length:** 3,500 words, set-piece band (Table Rule 2: set piece 2,500 minimum with full scene standards), although the scene type is quiet.
- **One deliberate lie by an NPC** (Table Rule 8) and **one misreading by the POV character** (R6-4, R5-C1), both declared verbatim in the notes. The bible's standing misreadings are available ("a dose goes where it is put" / the edges, entered ch1; the formulator "never goes near them"); H13 wants the residue settling on his skin in Lyle's room felt and *not remarked* — he must not read it correctly.
- **Italic thought:** R39-7 binds (bible, POV and narration): only the POV (Wystan) thinks in italics; no named NPC gets a private italic thought, overriding Table Rule 10's one-per-NPC allowance for this book.
- **Numbers:** none invented; numbers reach the page only in a mouth, an instrument, a document or a private count (R14-4, R12-5). Wystan's card figures (Stage X, Suppression, Level) never go into bare narration; H15 ("six people alive know what Stage he is") is a private count, not a stat line. Brack's raw readings are an instrument/document: the figures on them are the Bureau's, and none are on any card — keep them unquoted or in a mouth, and invent no value.
- **Register:** Wystan-side idiom (voice note): numbers not adjectives, the division of the hour, the day book's margin, one object handled per chapter (for ch3, the brass token is the obvious one: H14). The dead are reported flat. Time in divisions ("noon to the ninth division").
- **Names:** Elspeth Lyle and Osgood Keld have no card; Lyle is originated in the plan (Prime Warden, Arbitration Division's northern office). Keld is not House Keld of the Polar Reach (bible Flags: no link asserted).


### Standing Inventory (from `session_start "Wystan Ashmore" quiet Accord`, # STANDING INVENTORY section only)
...
Book's recurrence set (bible.md): the hum and the moment it stops; the meter, its seal and the bill; the small hammer and the dull note of a cased weight; the nine-word wire; the roll and the entry in ink. The gauge-housing and its quarterly inspection is in the beat itself.

## Rule loadout

`book_tools.py loadout quiet` → prose-law pov scene-structure standing-inventory register. `load_rules prose-law pov scene-structure standing-inventory register --brief`, whole output:

-- 244 rules for tags ['pov', 'prose-law', 'register', 'scene-structure', 'standing-inventory']
...
R23-8-KHARVEN_INVENTORY_DECOUPLED  [Inner World Naming Amendment VIII]  live
...
R22-7-KHARVEN_INVENTORY_KEPT  [Moto Reversion Ledger VII]  live
...
R20C-47-CRAFTS_OWE_THE_INVENTORY  [Pack Twenty R20C-47]  live
...
R20C-48-ZETTARI_THIN_GROUND  [Pack Twenty R20C-48]  live
...
R20C-57-INVENTORY_PAGES_BUILD_ORDER  [Pack Twenty R20C-57]  live
...
R15-1-STANDING_INVENTORY_SURVIVES  [Pack Fifteen §1]  live
...
R11-2-SILHOUETTE  [Pack Eleven §2]  live
...
R11-3-PROOF_MARKS_CANON  [Pack Eleven §3]  live
...
R11-5-STANDING_INVENTORY_PERIPHERY  [Pack Eleven §5]  live
...
R6-8-STANDING_INVENTORY_CATEGORIES  [Pack Six PART II.8]  live
...
`check_docket prose-law pov scene-structure standing-inventory register`:

```
-- 0 pending/proposed for ['pov', 'prose-law', 'register', 'scene-structure', 'standing-inventory']
```
...
`scene_brief "<beat>" --thread "Wystan Ashmore" --type quiet --culture Accord --cast "Wystan Ashmore" "Osgood Keld" "Elspeth Lyle" "Edwyn Brack"` (loadout dropped; it is §3):
...
no card for 'Osgood Keld' in the wiki mirror; check Notion before writing anything numeric about them

no card for 'Elspeth Lyle' in the wiki mirror; check Notion before writing anything numeric about them
...
Last 1426 words of `ch02/final.md` ("Twenty-Two Drops", Vesk POV), raw, cut at a paragraph boundary. Note: ch02's gate is undecided with verdict *revise*; this is the r0 text, which still carries the one-word FAIL ("twelve days" → "eleven").

Vesk did not need a pump. He needed a gradient, and a thing that grows makes its own.

"At the flank," he said. "Not the wound. The wound gives it a cavity and a cavity is a puddle. I want it in the new tissue where the channel is finest, because the finest channel is where growth is still going on, and growth pulls."

"Growth pulls," Foss said.

"It pulls the way every green thing in a dry pot pulls. The dry side of the pot is where the root goes. That is all this is. It goes toward what it can still use and it keeps going until there is nothing left to use." He had his hands out in front of him. "Hold the hide, please. Both thumbs. There."

The pour took a long time and he was the only one in the room who enjoyed it.

He worked it in at four places along the near flank, a little at each, and between each he stopped and gave it the count of forty and watched the colour go out of the surface as the channels took it away inland. That was the thing. That was the whole thing. On the first night, with the third dilution and no matrix, the colour had sat where he put it for a quarter of an hour like paint on a wall. Tonight it went. Not fast. But it went, and it went on going after he took his hands off it. The new scaffold was carrying. It had been carrying since before tonight and nobody had asked it to.

"Say what you see," he said.

"I see it clearing." Foss had the glass down at the hide. "Uneven. It is going faster at the two forward pours than the two back."

"Say why."

"I will not guess."

"Guess wrong, then, and I will correct you, and you will remember the correction longer than the fact."

"It is going faster forward because the animal died forward." Foss straightened up. "The trunk quit last. The forward tissue is where the old road was best kept and the growth had the best material to build on, so the channel is finest and most numerous at the shoulder and the girth, and the finest channel is the strongest pull. Which is your sentence, not mine, and I dislike it, and it is correct."

"It is correct."

"It is filthy, and it is correct, and those are two separate findings and I want both in the book."

Malphas stood up off the gauge bench.

He was not a large man. He filled nothing when he arrived and nothing when he moved, and in twelve days Vesk had watched for the thing that men like him were supposed to have and had not seen it once. No pressure in the room. No note under the floor. Nothing in the slate, nothing in the brass, nothing in the cold. What there was instead was the one thing Vesk could not get past: the Lord had been sitting on an iron bench in a room the housing gauge had at four degrees since the first division, with no gloves on and his coat folded beside him and not under him, and his fingers were the colour of a living man's fingers.

Eleven days he had watched for it. The twelfth had started at the second division and he had never asked.

The press threw its warm air along the east wall and the gauge bench stood in the middle of it, and that was the whole of why the Lord's hands never took the cold. He had worked it out on the fourth night. He had been pleased with it and had not said so, because a man does not tell his Lord where he sits.

"Nuvalik," Malphas said. "The ninth hind is the freshest and she is the one I want. Say what she is now that she is on the table."

"She is meat with a new net in it and the net can shorten." Nuvalik had her knife in her hand and did not look at the carcass. "That is what you have bought. No Crystal. No self. Nothing in her that wants anything, and instead of it a tissue that shortens when one end of her is emptier than the other. Put the empty end somewhere and she goes there. Not because she chooses it. Because that is what shortening does."

"And the speed."

"The speed is whatever the tissue allows and I will not have a number for it until she is on the floor."

"Days," Foss said. "Four to six. You said four to six."

"Four to six without an anchor, and there is no anchor in her, and there will not be one." Malphas walked up to the table. "An anchor is a binding. A binding takes a name. A name is the only thing in this world the Accord can prosecute, and I have not put one in her, and this is the first night where that decision costs us something, because a thing with no name in it cannot be told where to go. It can only be given somewhere emptier than where it is."

"The main," Vesk said. He heard it come out of him too loud again. "The capped mains. Lord, the whole row here is capped, the housings are dead the length of that wall, this building is the emptiest place in four streets and she is lying in the middle of it."

"Yes."

"Then she will not need four days. Eleven feet is all she needs."

"She will need to get up," Malphas said, "which she has not done."

That went into Vesk like cold water. He was grateful for it, and he had not known he wanted correcting until it arrived. He put both palms on the table edge and looked down at the hind.

Proving rot was finished. Eleven days on the rail and no smell and nine carcasses signed by nobody, and it had been beautiful work and it had been an argument about what a thing is. This was not that. From the second division tonight the work was an argument about what a thing does, and everything that had been elegant about it was now only the ground it stood on.

"Write the night up," Malphas said. "Vesk's pour, the four places and the order of them, Foss's clearing at the shoulder, Nuvalik's shortening in her own words. Not a summary. The words."

"In the book," Nuvalik said.

"In the book, and in ink, and with the division. I want the whole of this project written down under the name I gave it, by four hands, in one book, because the file somebody builds out of us will be built off what is written and I would rather it be built off this than off a clerk's recollection of it."

He put two fingers against the ninth hind's flank, above the pour, and pressed. The hide moved under the pressure like the skin on cooling milk. Then he took his hand back and looked at the fingers, the way a man checks whether a thing has come off on him.

"The ninth," he said.

Foss went back to the coil and the broken gauge-housing. Nuvalik wiped the blade and set it down and went to the shelf over the press for the book, and the press turned over, and outside the dog did not bark.

Vesk stayed at the table with the empty flask standing between his palms.

The hide at the shoulder drew up.

It was small. A hand's breadth of it, no more, a slow tightening that came up and held for the length of a breath and let go, and nothing at all was touching her. He stood with the flask between his hands and waited for it to come again and it did not come again. He did not know whether that had been the matrix, or the slate under her taking her weight over as the meat found its level, or his own eyes at the end of the fourth day without sleep. He had nothing to put against it either way.

He did not call Foss back to put the glass on it.

The drip went on in the corner and he found he was counting it again. He let himself get to twenty-two. Then he went to the shelf for the book and wrote the division in the margin.

## Cast

state.json has no facts yet, so every carded cast member gets the full card (capped at 6,000 characters).
...
*[card capped at 6,000 characters; full card 14,265 characters. Lines past the cap that this beat turns on, verbatim:]*

#### XI. Spirit Axes
One, dormant and degraded, to **Osgood Keld**, the officer who trained him. Keld is not dead. Keld is in a room in the Division's medical house with an identity that was overwritten while he stood inside a working for six hours waiting for relief. Wystan was the second man through that door. Axis 100 is what a bond to a man no longer at the other end of it reads as.

#### XIII. Physical Description
Tall, narrow, built like someone who has not eaten a proper meal in daylight for a decade. Hair the colour of wet mahogany with red in it where the lamp catches, parted off-centre and worn to the waist, kept clean because a filing officer who looks unkempt gets his findings questioned. A long face, high flat cheekbones, a mouth that rests closed and thin. Eyes dark and set deep enough to sit in shadow at any hour. Skin has the bloodless quality of a man who works nights and sleeps through the light, with a brown discolouration across the backs of both hands that the medical house calls residue staining and he calls nothing at all. Shoulders narrow, no chest to speak of, forearms corded from carrying a case satchel and nothing else. Thirty-eight, and reads as either twenty-five or fifty depending on the lamp.
Black oiled wool, a full cloak with a standing collar, over a coat closed to the throat. The silver-grey embroidery at the shoulder is the Arbitration Division's and is worn nearly smooth. Everything he owns is black because residue shows on black and he wants to see it.
**Distinguishing.** The stain on his hands. A white line through the left eyebrow. A habit of holding objects by the very edge, two-fingered, even a cup.

#### XIV. Psychology
**What he refuses.** To sign an attribution he cannot derive. He has held cases open for four and six years while families waited, and he does not apologise for it.
**What he believes that costs him.** That naming who did a thing is the only justice available when the thing cannot be undone. He chased a purse belonging to a chartered house two years ago, filed it accurately, and was moved to nights the following month.
**Voice.** Flat, unhurried, exact. He answers the question asked and not the one intended. He will correct your terminology in the middle of your grief and does not notice he has done it.
**Humour.** Institutional, dry, delivered with no signal that it has occurred.

#### XVII. Fracture Log
Consolidated: three, all Band II, all ordinary.
**Unconsolidated: one.** The six hours. He carries forty-one minutes of other people and one of them is Keld's, taken off a door handle, and in Keld's minute Keld is still lucid and still waiting for relief to arrive. Anchoring 420 is the only reason that minute is filed under Keld's name and not his own. He checks it every morning against a written record. It has not moved yet.
...
No card (`character "Osgood Keld"`: no card in the wiki mirror). bible.md: "**Osgood Keld.** On Wystan's card only (Spirit Axis): the officer who trained him, overwritten, in a room in the medical house, alive. Wystan's morning check." bible.md Flags: "**House Keld.** Haren Keld, the Keld lord of the Polar Reach … Osgood Keld is on Wystan's card only. No link asserted." state.json facts: none. See Wystan's card §XI and §XVII above for Keld's minute.

### Elspeth Lyle

No card (`character "Elspeth Lyle"`: no card in the wiki mirror). bible.md (Originated in this plan): "**Elspeth Lyle**, Prime Warden of the Arbitration Division's northern office." Her place: "the Arbitration Division's northern office (the day desk, the Prime Warden's room, the archive)". First appearance; no physical inventory, voice or want exists anywhere — the writer builds her on the page (wotr-npc discipline: a want, a refusal line, a voice) and declares it in the notes as originated. state.json facts: none.
...
bible.md: "**Edwyn Brack.** Card stub. Lattice Classification Bureau, northern office; never wrong in a way that mattered; his classifications are correct off true measurements every time, including the last (ch67)." First physical appearance (card §XIII: "Full inventory pending his first appearance"). H24 (Brack signs bleed) is live behind him.

### Voice fingerprints

`voice_fingerprints`: none of this cast (Wystan Ashmore, Osgood Keld, Elspeth Lyle, Edwyn Brack) appears; the table covers 30 characters with eight or more attributed archive lines, and these have fewer. Differentiate by the card and the source scene, not by the numbers (R15-1).

## Recall

### scene_recall "Keld minute written record medical house edges memorandum quarterly inspection gauge-housing raw readings"

##### Commencement of The Curia. [ Kujo Arc ]  (commencement_of_the_curia_kujo_arc.md, score 94)
[Commencement of The Curia. [ Kujo Arc ]] He had known that before he arrived, because measure is the first item on any technical floor and he has been reading measure since he was fifteen. Inside eleven feet there is no arc. A hammer needs a radius and a radius needs a room, and the correct answer to being inside somebody's measure holding a hammer is to stop...
[Commencement of The Curia. [ Kujo Arc ]] The Imperceptible District. That was the Bench's term for it and Charles had filed correspondence about it for nineteen years without ever once understanding that it was a place. Everything the register cannot weigh, because nothing witnessed it, because it left no mark, because it did not come out. The road not taken ...
...and gave nothing back, and the blood that had come out around them on the first day had run red for perhaps a minute and had then gone black, and the black had kept coming, and it came still, and it fell from his fingers onto...
...ything on the stack and calling the stack devotion, and the Curia wrote it down as devotion, and I signed the minute." His voice did not rise. Nothing in the room rose. "I have watched three men do it before you and they are a...

##### The House of Abscene ( Kujo Arc )  (the_house_of_abscene_kujo_arc.md, score 81)
[The House of Abscene ( Kujo Arc )] *Twenty-two years and I have never proposed a thing I did not want to be given. That is what this place does. You come down here to make a report and you go back up having volunteered.* "That is the whole of it, my lord," said Corwin Sesk. "I have nothing further and I would ask leave to withdraw and take an instructio...
[The House of Abscene ( Kujo Arc )] A tunnel-master forgot whether he had completed an inspection and performed it twice. An assay clerk became absolutely certain she had entered a figure that remained absent from the record. A Forge Guard sergeant passed one of his soldiers in a corridor, greeted him, walked six paces, and suddenly could not remember wh...
...markers moved across kingdoms, mountain ranges, buried ruins, and the scattered remains of Aelor. For several minutes Kujo said nothing. Then his attention passed over one of the symbols representing the search routes dedicate...
...sure.  He would give them familiarity.  At the first checkpoint he argued over an inspection stamp for twelve minutes because an innocent Dawi returning home after years abroad would never accept an incorrectly applied customs...
...
[The Witness Schedule] *They have been practising jurisprudence with their hands for six hundred years,* he thought, *and calling it an art, and my Curia has been practising it with paper and calling it a faith, and Kujo has been filing false entries against the Continuum while both of us congratulated ourselves on our separate vocabularies....
...to each turn, and the hemp squeaked against itself in a small regular rhythm that had been going on for forty minutes. Rain moved across the high windows in long unhurried passes. Down in the yard somebody was caulking a hull...
...Nothing had rotted.  That was the first thing, and Verinus had been standing at the boundary stone for eleven minutes working out why it bothered him more than any of the rest of it. Three weeks since Vaeloris had stopped bein...

##### The_Path_of_Sorrow  (The_Path_of_Sorrow.md, score 73)
...
...decisions required ranking, and ranking required the system that had been sitting idle in the rain for forty minutes while its operator stared at his own hands.  He sheathed Kurosetsu. The guard settled into the scabbard mout...
...chedule based on the boot-tracks in the mud outside the pens, which indicated a two-guard rotation on a forty-minute cycle with the last pass occurring approximately twelve minutes ago. It read the distance from the pen to the...

##### The Night's Watch  (the_nights_watch.md, score 63)
...
[FORTY-TWO] "Coil calibrated at the chapter bench on the tenth, against the standard, at the eighth hour." She set her hands flat on the bench either side of the tin, and they were steady, which he noted. "Ambient taken before and after. Sample loaded dry, no wash, because I did not want to lose anything soluble. Four passes. Sign...
...f the ceiling in the far corner at a rate Vesk had counted once and never stopped hearing. Twenty-two drops a minute. The ice press turned over in the next room with the long dragging complaint of a machine built for a purpose...
...gate open and I need you to sweep below the floor, down to the bottom of the range. You will read noise for a minute and a half and I want you to keep going through the noise."  "That burns coils."  "Yes."  She took the spare...

##### THE KINGDOM OF KHARVEN  (THE_KINGDOM_OF_KHARVEN_corrected.md, score 63)
...
[**VI. THE BANNER HOUSES**] When the kingdom fell, the Keld withdrew to the tundra without ceremony or explanation. They did not participate in the factional fighting. They did not negotiate with any claimant. They returned to the life they had lived before Muken arrived, because the tundra does not care about politics and the Keld do not care ab...
...a problem that was already solved. He offered them the same terms. They accepted for the same reasons.  House Keld did not learn the lesson. The Keld did not need to. Muken rode to the Polar Reach, looked at the tundra, look...
...He offered them the same terms. They accepted for the same reasons.  House Keld did not learn the lesson. The Keld did not need to. Muken rode to the Polar Reach, looked at the tundra, looked at the people who lived on the t...

##### THE KINGDOM OF KHARVEN  (THE_KINGDOM_OF_KHARVEN_buri.md, score 63)
[**VI. THE BANNER HOUSES**] When Stannvaard cuts grain supply but keeps sending inscription substrate, the Thornwalls are the first to notice the pattern, because the Thornwalls have been tracking Stannvaard's trade behavior for generations and they know the difference between a shortage and a message. Their current analysis of the Ore Council's ...
[**VI. THE BANNER HOUSES**] When the kingdom fell, the Keld withdrew to the tundra without ceremony or explanation. They did not participate in the factional fighting. They did not negotiate with any claimant. They returned to the life they had lived before Muken arrived, because the tundra does not care about politics and the Keld do not care ab...
...a problem that was already solved. He offered them the same terms. They accepted for the same reasons.  House Keld did not learn the lesson. The Keld did not need to. Muken rode to the Polar Reach, looked at the tundra, look...
...He offered them the same terms. They accepted for the same reasons.  House Keld did not learn the lesson. The Keld did not need to. Muken rode to the Polar Reach, looked at the tundra, looked at the people who lived on the t...

##### What the Ground Was Owed  (10_wotr_what_the_ground_was_owed.md, score 63)
[Notes (author-facing, not canon)] **6,950 words, one continuous piece, no spacers.** Every line of your dialogue is verbatim. Verified clean.
[Rulings] ---
...he would get on with it.  Sodoku Moto got down off the Droval.  He killed all eleven and it took him under a minute and he did it with Kurosetsu and he did not use the cold, and Yoko, who was there, entered afterward in her o...
...essels. Every blood vessel in Seiji Tenrai's body came apart, from the capillary beds outward, over fifty-one minutes, and the man was conscious for forty-eight of them because the brain is well supplied and goes last.  He sto...

### scene_recall "Wystan Ashmore Osgood Keld Elspeth Lyle Edwyn Brack medical house Arbitration Division northern office day desk"

##### The Night's Watch  (the_nights_watch.md, score 91)
...
##### THE KINGDOM OF KHARVEN  (THE_KINGDOM_OF_KHARVEN_buri.md, score 75)
[**VI. THE BANNER HOUSES**] The Ashmores are the least martial house in a martial kingdom and the most quietly dangerous. Their power is grain. Their leverage is the specific kind of leverage that comes from controlling what everyone else needs to survive the winter, and the Ashmores have never lost a negotiation with anyone who was hungry, which...
...
##### THE KINGDOM OF KHARVEN  (THE_KINGDOM_OF_KHARVEN_corrected.md, score 75)
[**VI. THE BANNER HOUSES**] The Ashmores are the least martial house in a martial kingdom and the most quietly dangerous. Their power is grain. Their leverage is the specific kind of leverage that comes from controlling what everyone else needs to survive the winter, and the Ashmores have never lost a negotiation with anyone who was hungry, which...
[**VI. THE BANNER HOUSES**] When the kingdom fell, the Ashmores survived because food is the one currency that never loses its value. They traded grain for protection, protection for political access, political access for favorable positioning in whatever power structure emerged from the collapse, and the positioning ensured that whoever eventual...
...the condition was honest, and Muken valued honest conditions above comfortable ones.  House Thornwall, House Ashmore, and House Hallenfeld were conquered in the traditional sense, their lords brought to submission through mili...
...t affect their function, because their function is the wall and the wall does not have opinions.  ***3. House Ashmore***  **Seat: **Ashbury, southern lowlands.  **Territory: **The Greenhollow.  **Identity: **The breadbasket. Ho...

##### The True King of the North, Part 5  (the_true_king_of_the_north_part_5.md, score 70)
...
##### The True King of the North, Part 11  (the_true_king_of_the_north_part_11.md, score 69)
[The True King of the North, Part 11] "You are going to live," Lilia said. The sentence was not reassurance. The sentence was a medical assessment delivered in the tone of a woman who had delivered the assessment's opposite enough times to understand the difference between the two deliveries and who understood that the difference was the thing the patient ...
[The True King of the North, Part 11] "Shallow," she said. The word was a report delivered to herself, the physician's habit of narrating the assessment aloud so that the assessment's conclusions were available to anyone within earshot who might need them, and the anyone was the field medic standing three paces behind and the stretcher-bearers who were dec...
...d shared, the tell that marked the family's architecture in the faces of every person who carried the blood. "Ashmore and Thornwall have chosen their side."  The sentence was short because the sentence needed to be short. Ashmo...
...hmore and Thornwall have chosen their side."  The sentence was short because the sentence needed to be short. Ashmore controlled the grain. Thornwall controlled the timber and the Stannvaard trade relationship. The two houses t...

##### The True King of the North, Part 4  (the_true_king_of_the_north_part_4.md, score 65)
...
[The True King of the North, Part 4] Muken clasped Godfrey's forearm. The clasp was the northern greeting, hand to forearm, and the greeting was older than the Moto's arrival and older than the Banner Houses and older than the kingdom itself, reaching back to the time when two men meeting in cold country needed to confirm that the other man's arm was warm...
...
[V. THE COURTS ANSWER] **Ovaeren, styled Regent-by-Assembly**, took the chair at Vaelmarr on the fortieth day with a validated name and no blood claim whatsoever, and the Court had chosen him precisely because he had no blood claim, since a regent with a claim is a usurper waiting for a bad winter. He was sixty-eight, careful, personally dec...
[Corrections applied] **The doctrinal split is verbatim your session's ruling.** Eresse: a name passes only before the full assembled witness, count called, every witness compensated, and an uncompensated witness has not witnessed. Varrisak: the holding validates when assembly is impossible, and Korvaeth has not held a full assembly in thir...
...stop for age.  ---  The Empress of Eresse came out of the eastern door at the sixth bell with two of her own household behind her and neither of them touching her.  Onawa had asked for that in writing, in full form, eleven d...
...Ureth register, in front of the count, and the moment it leaves Ilthára Korvaeth's mouth the record shows the house of Korvaeth performing Eressean procedure.*  *And if Eressean procedure governs at Korvaeth then it governs e...

##### The True King of the North, Part 16  (the_true_king_of_the_north_part_16.md, score 62)
[The True King of the North, Part 16] The vial was Valdís's work. Valdís Ashmore. The name was a northern name worn over a function that was not northern. Valdís had arrived in Kharven-Seat three years before Hild, had established herself as an alchemist of unusual competence, had offered her services to whoever occupied the capital, and had been accepted ...
[The True King of the North, Part 16] The vial was Valdís's work. Valdís Ashmore. The name was a northern name worn over a function that was not northern. Valdís had arrived in Kharven-Seat three years before Hild, had established herself as an alchemist of unusual competence, had offered her services to whoever occupied the capital, and had been accepted ...
...
### wiki "Prime Warden" (hit list and snippets only; full pages trimmed)

##### Oneiron Parasite · Nightmare Warden  (Techniques/Oneiron Parasite · Nightmare Warden.md, score 90)
[Summary card] **Effect** · A fragment of him takes root behind a target's ribs, watches what they feel, and can be made to unmake their composure from inside. **Cost** · If it is destroyed, the pain returns to him. If he lets it sit too long, it starts reporting his host's own fears back to him as if they were his. **Limit** · Needs...
[FOW line] **Governing Primary** · Gnosis, Dominion **Sub-Stats** · Gnosis Cognition, Gnosis Retention, Dominion Sovereignty, Ardency Density **Stage floor** · Stage VII, Refraction (Band II, Awakened) **Grade required** · A-Grade **Path gate** · Spirit Path **Resonant Pair** · None documented in the source.
...# Oneiron Parasite · Nightmare Warden  ## Oneiron Parasite · Nightmare Warden  ### Summary card  **Effect** · A fragment of him takes root behind a...
...# Oneiron Parasite · Nightmare Warden  ## Oneiron Parasite · Nightmare Warden  ### Summary card  **Effect** · A fragment of him takes root behind a target's ribs, watches what they feel,...

##### Garron Vuldane · Warden of Thaumar  (Volume I — Character Cards/Garron Vuldane · Warden of Thaumar.md, score 90)
[IV · Primary Stats] **Path** · Body dominant, Attraction secondary. > **Vitality 610 carried alongside a Dominion of only 300.** He commands wardens beneath him, but the number that actually defines him is the one measuring what his own body can absorb before Iron Bloom starts. ---
[I · Identity] **Name** · Garron Vuldane. **Called** · The Iron Warden, Warden of Thaumar. **Role** · **Master Alchemist. Siegewright. Thaumaturgic Warden of the Grand Forges.** A broad, mountain-born figure in layered scaleplate, his iron-gray mane blending into a metallic fur of living Aethersteel that answers his pulse. His transm...
...# Garron Vuldane · Warden of Thaumar  ## Garron Vuldane · Warden of Thaumar  > *"The forge never stops burning. Only the weak forget th...
...# Garron Vuldane · Warden of Thaumar  ## Garron Vuldane · Warden of Thaumar  > *"The forge never stops burning. Only the weak forget that every spark is a choice."*  ---  ###...

##### Cyrus Vellhar · The Azure Warden  (Volume I — Character Cards/Cyrus Vellhar · The Azure Warden.md, score 77)
[V · Sub-Stat Peaks] **Harmonics Empathy 275** *(at ceiling)* · Gnosis Memory-Sense 260 · Harmonics Resonance 255 · Gnosis Perception 230 · Tempering Flow-Control 210 · Dexterity Feint 200 · Evasion 180 · Resilience Dispersion 175 · Vitality Tolerance 150 · Ardency Undertow 120. ---
[IV · Primary Stats] **Stage IV · Flourishing** · **Level 95** · Level Band I · Coherence Band F · Grade B · Ceiling 275. > **Pool 3,500**: 1,900 from Band I, 1,600 from Thresholds I–IV. **Allocated 3,435.** | Stat | Value | Grade | Reading | |---|---|---|---| | **Harmonics** | **270** | B | Near ceiling. Tide-Sense reads a room before he ...
...# Cyrus Vellhar · The Azure Warden  ## Cyrus Vellhar · The Azure Warden  > *"Calm waters lie. Waves tell the truth."*  ---  ### I · Identity  **...
...# Cyrus Vellhar · The Azure Warden  ## Cyrus Vellhar · The Azure Warden  > *"Calm waters lie. Waves tell the truth."*  ---  ### I · Identity  **Name** · Cyrus Vellhar. **Called** ·...

##### The Concord Military  (The Guild Accord/The Concord Military.md, score 71)
[The Enforcement Division] Each division answers to a **High Warden**, who serves as both judge and general. *Their presence in a realm is considered a state of martial law.* ---
[The Enforcement Division] *The Concord's iron soul. It enacts the Codex's will through direct action — arrest, containment, suppression, and when necessary, erasure.* | Order | Function | |---|---| | **The Vanguard Orders** | Elite strike teams responding to Wellspring breaches, Domain violations, and rogue Ascendant entities. Each member bears...
...|  At the apex stands the **High Marshal of the Accord**, who sits on the Council beside the High Warden and Prime Arbiter, forming the **Triumvirate of Balance.**  ---  ## The Codex Protocols  *Universal combat laws enforce...
...nsional anchors. **They can immobilize gods or stitch open rifts shut with Essence chainwork** | | **The Null Wardens** | Silent enforcers assigned to track and capture Codex violators. **They speak no word, their throats seal...

##### The Guild Accord in the Modern Era — Divisions, Companies, Academies and Offices  (The Guild Accord/The Guild Accord in the Modern Era — Divisions, Companies, Academies and Offices.md, score 59)
...s runs the same skeleton, whatever it calls the parts. **Governance.** A **Master**, elected annually, styled Prime Warden or Upper Bailiff in some companies and addressed by that title without exception at any formal occasio...
...tered realms | Logistics, over who controls Gate priority | | **Enforcement** | The Sealwrights, and the High Warden's presence, which is martial law wherever it stands | Forfeitures and amercements, which is a scandal nobody...

##### The Guild Seat of Stannvaard — The Metal-Wardens of the Ring  (The Inner World — The Northern Shield/The Guild Seat of Stannvaard — The Metal-Wardens of the Ring.md, score 47)
...# The Guild Seat of Stannvaard — The Metal-Wardens of the Ring  *The Metal-Wardens of the Ring · The Ore Council · The Seat of the Scale · Central Shield* > ⚠️...
...# The Guild Seat of Stannvaard — The Metal-Wardens of the Ring  *The Metal-Wardens of the Ring · The Ore Council · The Seat of the Scale · Central Shield* > ⚠️ **Amendment applied.** The sour...


---- full text of Oneiron Parasite · Nightmare Warden ----

### wiki "Lattice Classification Bureau" (the beat's "Bureau"; hit list and snippets only; full pages trimmed)

##### The Derivation of Practice — Thaumaturgic and Theurgic  (The Magic System/The Derivation of Practice — Thaumaturgic and Theurgic.md, score 98)
[The Derivation of Practice — Thaumaturgic and Theurgic] *A Classification of Practitioner Types by Relationship to the System* *Guild of Measurewrights, under the Hexagonal Oath, in concurrence with the Research & Archives Division and the Lattice Classification Bureau* > **The fire was always in her. The understanding of fire was always in him. Both produce fire. The insti...
[The Derivation Index] **DI = (Cross-Axis Mean Performance) / (Single-Axis Peak Performance)** Measured across a standardised battery spanning **all three encounter axes — Wild, Spirit, Medium —** across at least three Families, scoring consistency, peak deviation, adaptation time and technique legibility. > **DI approaching 1.0** — theurgic...
...itution that cannot tell the difference will be burned by both.** > — *Attributed to the third Provost of the Lattice Classification Bureau, upon her resignation*  ---  ## Why a Second Axis  The existing apparatus measures **wh...

##### Edwyn Brack  (Volume I — Character Cards/Edwyn Brack.md, score 84)
[Edwyn Brack] *Lattice Classification Bureau, northern office. Classifier. Scene-derived stub from The Night's Watch; everything not stated in that scene is pending Isaac.*
[I · Identity] **Name.** Edwyn Brack. Northern stratum. **Affiliation.** Lattice Classification Bureau, northern office. His signature is on half the classifications that come out of it. **Level / Stage / Band.** Pending Isaac. **Catalyst Event.** Pending Isaac.
...# Edwyn Brack  ## Edwyn Brack  *Lattice Classification Bureau, northern office. Classifier. Scene-derived stub from The Night's Watch; everything not...
...in that scene is pending Isaac.*  ### I · Identity  **Name.** Edwyn Brack. Northern stratum. **Affiliation.** Lattice Classification Bureau, northern office. His signature is on half the classifications that come out of it. **L...

##### The Guild Accord  (Factions, Bloodlines & Institutions/The Guild Accord.md, score 56)
[How a Commission moves] **Submission** · Civilians, scholars, or officials file at the nearest Guild Hall. **Validation** · Arbitration examines the request for legality, Essence risk, and moral justification. **Classification** · Threat Tier and Class assigned, then etched into the Lattice as a glyphic record. **Acceptance** · A party signs ...
[The Commission Framework] > *"Duty is the crucible. The soul is the metal. The Lattice remembers what emerges."* Every sanctioned mission is classified by two axes: its **Threat Tier** (T1–T9), corresponding to the practitioner rank required, and its **Commission Class**, defining the operation's purpose. A Tier represents existential danger an...
...ioner to law. Each oath sworn, each commission fulfilled, each judgment rendered echoes through the **Concord Lattice**: a living web of Essence signatures that records every deed, every betrayal, every act of mercy in harmonic...
...merely political. **It is spiritual.** To join the Accord is to offer a fragment of one's Soul Crystal to the Lattice, forever binding one's Essence to the Codex's truth. > > **The Crystal remembers what the mind forgets. The L...

##### Kwon Mu-jin  (Volume I — Character Cards/Kwon Mu-jin.md, score 41)
[VIII–IX · Traits and Domain] ---
[X · Techniques] ---

##### Onawa Ashkewe  (Volume I — Character Cards/Onawa Ashkewe.md, score 40)
[VIII–IX · Traits and Domain] ---
[IV–V · Stats] | Stat | Value | Grade | Peaks | |---|---|---|---| | **Gnosis** | **395** | A — *near the ceiling* | Fluency 385 · Sapience 378 · Analysis 355 · Perception 348 · Retention 330 · Acuity 315 · Warding 300 | | **Harmonics** | 380 | A | Attunement 365 · Stability 340 · Chord 320 · Confluence 305 | | **Tempering** | 365 | A...

##### Cozbi Mahuo  (Volume I — Character Cards/Cozbi Mahuo.md, score 40)
[VIII–IX · Traits and Domain] ---
[VI–VII · Force and Flow] **Strike Force** · EX-Grade through Pneumosphera or conscripted constructs. **Personal unarmed output closer to X-Grade.** **Durability** · X-Grade — solid, **and documented to fail against a targeted seal (Dhaerin) and a direct physical contest (Dova).** *Not unkillable. Just arranged never to need a fair fight.* **Do...


---- full text of The Derivation of Practice — Thaumaturgic and Theurgic ----

#### The Derivation of Practice — Thaumaturgic and Theurgic

*A Classification of Practitioner Types by Relationship to the System*
*Guild of Measurewrights, under the Hexagonal Oath, in concurrence with the Research & Archives Division and the Lattice Classification Bureau*
> **The fire was always in her. The understanding of fire was always in him. Both produce fire. The institution that cannot tell the difference will be burned by both.**
> — *Attributed to the third Provost of the Lattice Classification Bureau, upon her resignation*
...
state.json `facts` is empty: nothing from ch1 or ch2 has been carried into the book's memory yet (both chapters are drafted; ch1 gate PASS, ch2 gate undecided, verdict revise). No facts, no lies on record.

### Summaries of prior chapters

state.json `summaries` is empty. As a stopgap, the "Summary for continuity" from each chapter's `final_notes.md` (the writer's own, not yet approved into memory):
...
Hooks planted or advanced and due within 3 chapters (due ch3–ch6), and any overdue:
...
Note: every hook in state.json still reads status "planned", including the fourteen ch1/ch2 plants (H01–H11, H21, H23, H24); the memory pass that marks them planted has not run. Live Wystan-side threads this chapter can touch without paying: H23 edges in the margin (due ch16; Lyle reads that memorandum), H24 Brack signs bleed (due ch67; Brack stands by it here), H01 who set the marker and H04 Tally's second dataset (the ch1 letter is out).

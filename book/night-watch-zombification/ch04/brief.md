...
{
 "number": 4,
 "title": "A Number in the Room",
 "beat": "In the Xu counting house by the river Deming draws the second tranche of Verdantia off the Swale supply contract as wastage and writes the covering letter as ordered, naming Project Zombification in the second line. He counts the days Malphas has given him and the weeks the Logistics return will take, and argues with a Logistics factor over a column he intends to lie in. He tells the factor the Hollow Shaft story as a joke about careless men; it is the thing he is most afraid of. The purse now has paper on it, in his hand, carrying the chosen word.",
 "scene_type": "talky",
 "pov": "Xu Deming",
 "cast": [
  "Xu Deming",
 ...
 "place": "the Xu counting house by the river",
 "front_id": null,
 "proposed_front": "the-swale-wastage",
 "plants": [
  "H16-thirty-one-days",
  "H17-eleven-weeks",
  "H18-the-project-name-is-the-file",
  "H19-the-hollow-shaft-people"
 ],
 "pays": [],
 "time_elapsed": "Day 2",
 "target_words": 3500

# Brief — Chapter 5, "Who Set the Marker"
...
{
 "number": 5,
 "title": "Who Set the Marker",
 "beat": "Tally's answer comes up with the bulletin bundle: the marker is the Ferriby estate's old survey stone. Wystan and Yinzhi ride to the cut, where Tally (first seen, first inventoried) walks them the line, and Wystan stands eight hours on the carcass ground without food to run Called Late on a scene weeks cold. He states a sequence: somebody came up from the south along the estate's round, stopped short of the stone, and went back the way he came, on foot, at a walking pace, more than once. The inquiry moves off the cut and onto the round.",
 "scene_type": "working",
 "pov": "Wystan Ashmore",
 "cast": [
  "Wystan Ashmore",
 ...
 "place": "the North Ferriby cut and the parish marker",
 "front_id": null,
 "proposed_front": "the-night-register-file",
 "plants": [],
 "pays": [],
 "time_elapsed": "Days 4 to 5",
 "target_words": 3500
}
```
...
None (the outline row's `plants` is empty).

### Hooks this chapter pays

None (the outline row's `pays` is empty).

### Hooks the beat touches without paying

- **H01-far-side-of-the-marker** (planted ch1, due ch7, status planned). Tally found clean ground on the far side of the parish marker, twenty-two paces past the last carcass, and checked it twice; Wystan writes 'ask Tally who set the marker'. Paid when the lick-keeper's round is found to end at the marker: the carrier turned home there. Keywords: marker, far side, lick, turned. **This chapter advances it, does not pay it:** the beat answers "who set the marker" (the Ferriby estate's old survey stone) and moves the inquiry onto the estate round. The payment (the lick-keeper's round ends at the marker; the carrier turned home there) is ch7's. Wystan's Called Late sequence ("stopped short of the stone, and went back the way he came, on foot, at a walking pace, more than once") sets it up; do not name the licks, Josse, or the carrier here.
- **H04-tallys-second-dataset** (planted ch1, due ch41, status planned). Wystan asks Tally to keep walking and measuring: 'I want a second dataset from the same observer.' Paid when the notebook is taken from Tally's walking body, complete to the night he died. Keywords: second dataset, same observer, notebook, Tally. Tally has received the ch1 letter and is walking and measuring; his notebook can appear (he walks them the line). Not paid until ch41.
- **H23-edges-in-the-margin** (planted ch1, due ch16, status advanced). Wystan's margin note: edges. Paid when the walkers erase them and he strikes the word in public. Keywords: edges, margin, struck, bleed. Event ch3: Lyle reads 'edges' in the margin; the position goes into her minute. Quote: "She read *edges* and the plain sentences underneath it, and then *A dose goes where it is put*, and took up her pen, and copied the line into the minute in a small upright hand, and wrote the date and the division beside it." The edges position still stands on the file; the far side of the marker being clean reads to Wystan as an edge. Not struck until ch16.

### Front tick (proposed Front, from bible.md)

### the-night-register-file (Wystan's case) — 6 segments
...
**This chapter's tick:** segment 1, "Exhibit one", third of its five pushes (ch1, 3, 5, 7, 12; ch12 fills it). The segment names "the round and its intermediary"; this chapter finds the round and ch7 finds the intermediary. Mention is not advancement (bible): the world changes here when the marker is identified as the Ferriby estate's old survey stone and Wystan, after eight hours of Called Late on the carcass ground, states a sequence (somebody came up from the south along the estate's round, stopped short of the stone, went back the way he came, on foot, walking pace, more than once). The POV sees the consequence: the inquiry moves off the cut and onto the round. The segment is not filled. `front_id` stays null; nothing is written to `table/fronts.yaml` (needs `add_front` on Isaac's word).
...
- **No PC in this book.** The standing book rule from bible.md applies in its place: **neither Wystan nor Malphas ever learns of the other.** Wystan knows his quarry only as "the formulator," "the man who never goes near them" (never "the Lord", which he has never heard); no file he can read names the hand. Nothing noticed across that line is ever paid as recognition, and the narration never winks at the reader who knows both. The sequence Wystan states off Called Late is a walker with no face and no name ("somebody"); it must not resolve toward anyone the reader knows, and the narration must not hint that the round leads to a man with warm hands. The voice note's anti-exemplar is exactly what is forbidden.
- **Length:** 3,500 words, set-piece band (Table Rule 2: set piece 2,500 minimum with full scene standards). Scene type is working: the working on the page is Called Late (card: trigger "a scene more than six hours cold"; function "reconstruction from a degraded field"). Run wotr-phenomenon's logic from the card only; invent no figure. The eight hours without food is a cost the body pays on the page (Table Rule 5).
- **One deliberate lie by an NPC** (Table Rule 8; the NPC is Tally or Yinzhi, the only NPCs present) and **one misreading by the POV character** (R6-4, R5-C1), both declared verbatim in the notes. Available standing misreadings (bible, "What Wystan believes that is wrong"): the edges (a dose has edges; the clean far side of the marker is read as one), and the formulator "never goes near them" (the walker on the round is read as a man who sends things, not one who touches). Do not pre-empt ch7: Wystan must not conclude the walker is a lick-keeper or an intermediary.
- **Italic thought:** R39-7 binds (bible, POV and narration): only the POV (Wystan) thinks in italics; no named NPC gets a private italic thought.
- **Numbers:** none invented; numbers reach the page only in a mouth, an instrument, a document or a private count (R14-4, R12-5). Tally's measurements are an instrument/document (his rule, his notebook): the attested ones are eleven hinds and a stag, grey-green mass to nine inches at the tallest, twenty-two paces from the last carcass to the clean ground past the marker. Yinzhi's card and Tally's card carry no figures; give them none.
- **Register:** Wystan-side idiom (voice note): numbers not adjectives, the division of the hour, the day book's margin, one object handled per chapter (for ch5, the survey stone or Tally's notebook/rule; Wystan handles by the edge, H06). The dead are reported flat. Time in divisions; the chapter runs Days 4 to 5.
- **First inventory of Tally:** the beat says "first seen, first inventoried". His card has no physical description beyond the source (a knife and a rule; forty miles of timber a week; "the sort of man who measures"). Anything added is the writer's origination and must be declared in the notes.
- **Yinzhi** carries the regulation bracelet (it pulls toward a suppressed practitioner; she lied in ch1 that it went quiet) and the coils; she is the assay of record. Her full name is never rendered.
...
Book's recurrence set (bible.md): the hum and the moment it stops; the meter, its seal and the bill; the small hammer and the dull note of a cased weight; the nine-word wire; the roll and the entry in ink. Out on the cut there is no main: the absence of the hum is available as the clock (a rural parish off the main), and the bulletin bundle / nine-word wire opens the beat.
...
`scene_brief "<beat>" --thread "Wystan Ashmore" --type working --culture Accord --cast "Wystan Ashmore" "Qiu Yinzhi" "Nol Tally"` (loadout dropped; it is §3):
...
**`ch04/final.md` does not exist.** Chapter 4 ("A Number in the Room", Xu Deming POV) escalated at its gate with no draft in any round (ch04/GATE.md: "The drafting step wrote no files in any round"); none of its hooks (H16–H19) is planted and the-swale-wastage was not ticked. The last drafted chapter on this side is ch3, so what follows is the last 1489 words of `ch03/final.md` ("The Morning Check", Wystan POV), raw, cut at a paragraph boundary. Ch5 follows ch3 on Wystan's side (Day 1 → Days 4 to 5); ch4 is a separate Deming thread on Day 2 and ch5 depends on nothing in it.

He picked it up first.

The Register's token was brass because the Night Register was not a full desk. Every officer of a full desk carried silver, and the porters at the Division's doors knew the difference at a glance and were a shade slower for brass. He had carried it four years and had never asked to have it changed. He put it in his waistcoat.

Then he turned the tin a quarter turn under the window and let the light rake the seal. The device stood in the wax sharp to its edges. He took the day book under his arm and went up.

The upper passage was narrow and ill-lit, with the Prime Warden's door at the end of it shut and a bench against the wall outside. A man was sitting on the bench with a Bureau folder on his knees. He stood up when he saw who it was.

"Ashmore."

Edwyn Brack was a broad man of about fifty with a short neck and a clean-shaven red face that looked scrubbed. His grey hair was cut close all over. A pair of gold-wire spectacles was pushed up onto his forehead and forgotten there. He wore the Bureau's grey worsted, good cloth, and on the pad of his right thumb a shiny white scar the size of a thumbnail, the old burn a man gets once from holding a coil wrong and never again. He held the folder against his chest in both hands. Its tape was the Bureau's green.

"Master Brack."

"I have seen your memorandum."

Wystan waited.

"I'll not pretend I liked the margin." Brack's voice was big and unhurried, and it filled the passage without his raising it. "You wrote your word next to my name. Edges. All right. I've no quarrel with a word. But I'll tell you straight, since I'm stood here. It's bleed. My man took it off a calibrated coil against the standard and it's bleed, Verdantia, tertiary, and there's no operator in it. I'd sign it again this afternoon. I'd sign it in front of you, Ashmore, and your Prime Warden."

"I have not said you were wrong."

"You've said it's a dose."

"I have said the measurement is not disputed."

"Aye, you've said that." Brack shifted the folder. "And then you've written 'edges' next to it, which is a man saying he doesn't dispute the weight and then going round the back of the scale with his little hammer." He did not seem angry. He seemed to be setting it out so that it was on the table. "Strike it, Ashmore. Go on. A solid weight rings. Mine'll ring."

"I expect it will."

"Well, then." Brack held out the folder.

Wystan did not take it at once.

"The passes," Brack said. "The field sheets off the Ferriby cut, with the coil calibration pinned to the front. Raw, as my surveyor wrote them, in his own hand, before anybody at my desk touched them. The Bureau doesn't send them out with a return. Nobody ever asks for them."

"I did not ask for them."

"No. You'd not have." He was still holding it out. "If I'm wrong, it's in there. It'll not be in there. But you'll have it, and then you'll know, and then we can..." He stopped, and started again. "I'd sooner you had the sheets than the word."

Wystan took it by the edge, two fingers and a thumb, and felt the weight of it come into his hand. It was heavier than it looked. There were a good many sheets.

"Thank you, Master Brack."

"Don't thank me. Read it." Brack sat down again on the bench and put his hands on his knees. "I'm waiting on the Prime Warden."

The door at the end of the passage said, "Warden of Duty."

The Prime Warden's room was small and very warm, with a stove in the corner and the window shut and the shutter half across it. A long table did for a desk. The minute book lay open on it beside a stick of the office's red wax, and her silver token lay on the blotter where she had unhooked it from the chain.

On the wall beside the door was the gauge-housing, brass and slate-backed, locked under the Board's seal across the hasp, and the last inspector's card tucked into the frame. He did not need to read the card. He knew the date on it.

"Shut the door."

He shut it.

She held out her hand for the day book without getting up, and he opened it at the page and laid it in front of her, turned so that she could read it, and stood back. She read *edges* and the plain sentences underneath it, and then *A dose goes where it is put*, and took up her pen, and copied the line into the minute in a small upright hand, and wrote the date and the division beside it.

He stood with Brack's folder held against his coat.

It began on the backs of his hands first, as it always did, where the stain was. A fine dry settling, with nothing there to see, as if the air in the room had given up something it had been holding since the morning and let it down on him. Then the face, over the cheekbones and along the lids, and the throat above the collar. He kept still and let it come.

It was what any shut room did by this hour, with the main running under it and people at work in it all day, and it came down on everybody in the room alike; Lyle had simply never sat a night on the Register, and had nothing on her hands to feel it with.

He did not remark it. He never did.

She was one of the six. She had had it off his file the week he was put on nights, and she had read it, and had said nothing then, and had said nothing since. He watched her write.

"The term," she said, and wrote it. He read it upside down as it came. *The Register may keep this curiosity open until the quarterly inspection of the gauge-housing, and not a day longer. E. Lyle, Prime Warden.* She turned the minute round to him and held out the pen.

He initialled the position, and then the term. His hand shook on the second initial and he did not stop to steady it. It came out legible.

She turned the book back, softened the red wax at the stove's door and dropped a thumb of it beside her name, and pressed her silver into it. She held it for a slow count of five without any help at all.

"What is that under your arm?"

"The Bureau's raw readings for Ferriby. The field sheets."

Her eyes went to the green tape and stayed there a moment. "You asked the Bureau for its raw readings."

"No. Master Brack gave them to me in the passage."

"Unasked."

"Unasked."

"Then enter them as received unasked, today, with the division, before you read a line of them." She wiped the pen. "And they go on the return with the rest of it if it comes to that."

"Did you send for him?"

"I did not send for Master Brack." She was writing again, and the pen did not stop. "He is here on the Bureau's own business."

Wystan waited, and she wrote.

"Your three lamps are on my bill, Warden," she said, without looking up. "Go and read your sheets."

Brack was on the bench with his hands on his knees and his spectacles still on his forehead. He looked up.

"Well?"

"The quarter."

Brack let out a breath through his nose. "She's generous. I'd have given you a turn." He looked at the folder under Wystan's arm, and at the day book. "And say you're right. Say your edges hold, and there's a man, and you walk him down. What do you get for it?"

Below them, toward the river, a bell began on the ninth division. Wystan counted it off and got it right.

"I will get a hand and not a purse."

Brack looked at him.

"There's not a Warden in this building would thank you for a hand," he said. "Fifteen wants the purse. It's framed over half the desks downstairs."

"I know where it is framed."

"Then what's it for?"

Wystan did not answer that. He took the brass out of his waistcoat, turned it once between two fingers so that the worn device caught the lamp at the end of the passage, and put it back.

"Master Brack," the door said.

Brack got up off the bench, and settled his coat, and pulled the spectacles down off his forehead onto his nose.

"Then I hope it's bleed," he said, "for your sake," and went in.

## Cast

### Wystan Ashmore (POV)

state.json holds facts about him, so the FOW line (`fow_line "Wystan Ashmore"`):
...
No facts in state.json yet; full card (`character "Qiu Yinzhi"`, capped at 6,000 characters):
...
No facts in state.json yet; full card (`character "Nol Tally"`, capped at 6,000 characters):
...
`voice_fingerprints`: none of the cast (Wystan Ashmore, Qiu Yinzhi, Nol Tally) appears in the table (it lists 30 characters with eight or more attributed lines). Voice from the cards and the bible: Yinzhi precise, an artificer's apprentice; Tally a man who measures.

## Recall

### scene_recall "marker survey stone Called Late carcass ground round south Ferriby estate"

#### The_Path_of_Sorrow  (The_Path_of_Sorrow.md, score 94)
[The_Path_of_Sorrow] The last signs of town life fell away behind them. Wagon ruts. Trampled grass. Chimney smoke. The dull comfort of fences and fields and the human habit of pretending that order was the natural state of things. Ahead: harsher country. Dry earth split by roots. Iron-colored stone jutting through the soil at angles that s...
[The_Path_of_Sorrow] He had been raised in different severity. Kharven's surrounding territory was desert forest — harsh heat, long-reaching sightlines broken by ancient stone and thornwood. Predator country, yes, but honest predator country. You could see where death might come from if you had the training for it. You could learn the angl...
...ridgelines between the tendons rather than the smooth contours of adequate nutrition.  She was demihuman. The markers were visible even in the pen's low light: ears that tapered to soft points above the temporal ridge, rising...
...on of deciding for the benefit of the person who is about to hear it.  "Y'know the territory past the eastern marker is monster country, yeah? The Verath Expanse. Not the kind where you run into a dire wolf and scare it off wi...

#### The Revolution Of The Inner World  (the_revolution_of_the_inner_world.md, score 86)
[The Revolution Of The Inner World] Bram Greymane stopped the line at the Ashenmoor in the fourth year and did it in a way nobody could appeal. The survey wanted to run the southern spur across eleven miles of flat empty country between the wall and the moor, and the eleven miles were flat and empty because an orc host of eleven thousand had starved to d...
[The Revolution Of The Inner World] In the first year Whitemere surveyed a rail line from the Ring to the coast. It did not follow the valleys. That is the thing that every account of the Inner World's first line notices and that the Old World engineers who came north to laugh at it could not get past. A road follows the flattest ground. The line followe...
...uries, and the premium was invisible because there was nothing to compare it to.  In the first year Whitemere surveyed a rail line from the Ring to the coast.  It did not follow the valleys. That is the thing that every accoun...
...the flattest ground. The line followed the shallowest current, which put it over two ridges that a competent surveyor would have gone around and through four villages that had no reason to exist and past three cities that did...

#### The Night's Watch  (the_nights_watch.md, score 85)
[WHAT DOES NOT SMELL DEAD] "North Ferriby walk, Timberline chapter of the Night Watch Society. Forty miles of timber a week and he counts deer, and on the ninth he found eleven hinds and a stag inside a quarter mile and measured the mass with a rule, and on the tenth he walked north to the stones and walked the far side of the marker twice to be...
[WHAT DOES NOT SMELL DEAD] "You want them to get up." "I want them to leave." Malphas took his fingers off the hind. "A carcass that stays in a field is a fact with a location and a date and a boundary marker twenty-two paces to the north. A carcass that walks eleven miles and lies down somewhere else is a bleed, because a bleed has no edge, and...
...asses, no mass, nothing sick. Went back and found the last one. Twenty-two paces short of the parish boundary marker. Clean ground on the far side of it. I checked the far side twice.*  That was the thing. That was the whole t...
...e margins until nobody can say where it stopped. It does not stop twenty-two paces short of a parish boundary marker. It does not check the far side.  A boundary means somebody chose one, and a choice means a hand, and a hand...

#### Commencement of The Curia. [ Kujo Arc ]  (commencement_of_the_curia_kujo_arc.md, score 85)
[Commencement of The Curia. [ Kujo Arc ]] Bone ash is calcium phosphate, and calcium phosphate is chosen for a cupel because it is chemically inert to what it absorbs and porous enough to take it, and a man's skeleton is the same material in a different arrangement. The Lattice through it makes it the most absorbent structure in a body and always has, which is...
[Commencement of The Curia. [ Kujo Arc ]] Ash in his mouth. The cold of the ice-field on the ruined side of his face where the eyebrow had opened again, and under both of those the flat animal smell of a road that had two thousand men on it and had been at this since the ninth hour. His ribs on the left side had been broken for four hours and had settled into ...
...themselves at it. That was the thing the Seat's own officers would not believe when it was reported. They had surveyed it, and they had gone at the mortar course two feet above the footing where the frost had already been work...
...had then gone black, and the black had kept coming, and it came still, and it fell from his fingers onto the stone in a rhythm he had stopped counting on the fourth day.  The first nail had been the loudest thing that ever h...

#### WAR OF THE REALMS  (WOTR_Vaeloris_Sequence.md, score 83)
[Three Poppy Heads] Kesh took it. The wax was white and plain and the impression in it was a rough uncut stone, which was not what she had expected and was, she found, the first thing about the Holy Sea of Alabaster that had told her anything. She turned it over once and went to find her Sovereign. The royal garden of the Alabaster Court ...
[The Witness Schedule] The wall was old and low and had lime-washed stone under his forearms that came off on the wool. Below him the boom lay across the water in its long dark line and the Zettari hulls sat inside it with morning smoke going up off two of them and a tender working across from the third. Gulls on the mastheads. Fewer than ye...
...in nineteen years, and now it was the loudest thing in the capital.  Far out, past the light, past the shoal markers, past the point where the channel opened into deep water, the horizon carried a wound.  It had no colour tha...
...unt of an incursion was one reading and one reading was not a finding, and he had scheduled the corroborating survey for the second week of the following month.  Six hundred and six.  One hundred and thirty-five short.  And th...

#### What the Ground Was Owed  (10_wotr_what_the_ground_was_owed.md, score 79)
[What the Ground Was Owed] Edward Lambert did not answer immediately. Then he looked down at the fourth stone, which was set apart from the other three by the width of a path, and which was smaller, and which had less on it, because there had been less to put on it: a name, and an office, and no dates, because the parish book at Vaeloris that he...
[What the Ground Was Owed] *The revocation was performed in form. Full register, correct contours, before a witness. It is valid. The name Moto has been taken off him and cannot be given back by anybody, and he died without one, and I have entered him as elar-ama, contingent, held by nobody, and there is no other form available to me.* *I have b...
...nt to the graves on the morning of the first frost with his hands behind his back and stood in front of three stones in the upper burying ground at Kharven-Seat and did not kneel and did not remove anything.  Hild Ice. Twelve...
...e depth of the lettering across all three at Lambert's own instruction, because a difference in depth between stones cut in one week says something about relative importance and Edward Lambert had spent fifty-three years refu...

#### The House of Abscene ( Kujo Arc )  (the_house_of_abscene_kujo_arc.md, score 78)
...
[The House of Abscene ( Kujo Arc )] A week later he identified a flaw in a forge-array that would have cracked an entire heating channel by winter. After that he noticed that three assay irregularities from separate guild shipments shared the same mathematical error and proved the fault belonged to a measuring instrument rather than the ore. He asked for...
...es. The five Void Generals remained around him, their vague silhouettes shifting at the edge of definition as markers moved across kingdoms, mountain ranges, buried ruins, and the scattered remains of Aelor. For several minute...
...them does not belong.”  His hand closed slowly.  “Then it passes.”  The Void Generals watched the corruption markers disappear and return elsewhere.  “That is important,” Kujo continued. “Do not let it remain long enough to b...

#### The True King of the North, Part 2  (the_true_king_of_the_north_part_2.md, score 76)
[The True King of the North, Part 2] He had spent most of the day reaffirming the western boundary. Whenever they reached an old territorial marker, Zaehaerys dismounted and inspected it himself rather than leaving the work to attendants, scraping away accumulated ice before driving replacement stakes where weather or movement had disturbed the ancient li...
[The True King of the North, Part 2] The words landed without performance. Without the generosity-as-weapon that a lesser speaker would have used, the magnanimous I-forgive-you that was really a dagger wearing a silk glove. Fern meant it. She was not upset with Zaehaerys because being upset with Zaehaerys was being upset with the mountain for being the sh...
...ars.  He had spent most of the day reaffirming the western boundary. Whenever they reached an old territorial marker, Zaehaerys dismounted and inspected it himself rather than leaving the work to attendants, scraping away accu...

### scene_recall "Wystan Ashmore Qiu Yinzhi Nol Tally North Ferriby cut parish marker"

#### The Night's Watch  (the_nights_watch.md, score 94)
...
[THE THING WITH EDGES] *Filed 14th, Tally, N., Timberline chapter, North Ferriby walk.* The Night Watch Society printed its inserts on the cheapest rag it could buy and the ink bled into the fibre, so a man reading one at the third hour by a single lamp did it with his nose eight inches off the page. Wystan had a scholar's slouch and no scho...
...
#### Commencement of The Curia. [ Kujo Arc ]  (commencement_of_the_curia_kujo_arc.md, score 43)
[Commencement of The Curia. [ Kujo Arc ]] He had the halberd across his back. He had not spoken to anyone since the muster. The first village was called Ashgate and had eleven houses and a mill. They did not fight there. Nobody in the column drew. Kaalabad turned the draconic horse off the road at a walk and went up the length of the village street once, and b...
...
...ss suddenly rose from his body.  Xevorith spread behind Kujo until the ruined district seemed to lose its chronology. Broken buildings appeared briefly intact in their shadows, falling snow hung beside the memory of snow th...
...t mean lesser.”  The states stopped arranging themselves as a ladder.  “You looked at my life and mistook chronology for rank.”  The Crevice throbbed once.  “That was careless.”  Kujo’s Void reached backward not to rewrite...

#### The True King of the North, Part 15  (the_true_king_of_the_north_part_15.md, score 42)
[The True King of the North, Part 15] The counting was the habit, and the habit was the man, and the man was standing at the northern gate of Kharven-Seat with his dark wool coat buttoned against the polar wind and his right thumb pressing against his right index finger in the silent rhythm that anyone who had spent more than a week in the Arithmetic's pre...
[The True King of the North, Part 15] Kurosetsu slashed in a diagonal descending arc from high-right to low-left, the specific Lion Stance commitment cut that the Shinken-ryū used when the cut's purpose was not to sever but to declare, and the declaration was the blade meeting the Droval's extended forelimb at the joint where the massive paw connected to t...
...not know yet, and the not-knowing was the thing Lambert was walking toward the throne room to end.  Leonardo Ashmore fell into step beside him.  Leonardo moved the way Lambert had trained him to move, which was: behind and to...
...eal was the thing Lambert respected, and the respect required the setting-down to be done correctly.  "Valdís Ashmore."  The name sat in the corridor the way all names sat when Lambert spoke them, precisely, without emphasis, e...

#### The True King of the North, Part 5  (the_true_king_of_the_north_part_5.md, score 42)
...
[The True King of the North, Part 5] The Shieldwarden's bow was the northern bow, the deep inclination of the head and the settling of the right fist against the left breast that the frontier lords used when acknowledging a sovereign who was not their own, and the bow carried the specific weight of a man who did not bow often and who made the not-often co...
...
#### The True King of the North, Part 2  (the_true_king_of_the_north_part_2.md, score 41)
[The True King of the North, Part 2] He had spent most of the day reaffirming the western boundary. Whenever they reached an old territorial marker, Zaehaerys dismounted and inspected it himself rather than leaving the work to attendants, scraping away accumulated ice before driving replacement stakes where weather or movement had disturbed the ancient li...
[The True King of the North, Part 2] She reached forward and straightened the iron ring on the linen. It did not need straightening. She straightened it anyway, because the straightening was the prayer, and the prayer was the work of her own hands offered without anyone watching, and the offering was complete. She turned from the altar, crossed the room i...
...# The True King of the North, Part 2  "I will tell them the truth," Hild said. "That Stannvaard is testing us. That the winter will be har...
...and the room held its breath behind her, and the winterbell flowers stood in their jar and did not fall.  The northern wind came hard across the Ironwood March, driving loose snow in long white sheets over the hills as **Zaeh...

#### The True King of the North, Part 1  (the_true_king_of_the_north_part_1.md, score 40)
[The True King of the North, Part 1] *I wonder if she would have been proud of this. Not the fighting. She was never proud of fighting. Proud of the flowers. Proud that I remembered which kind and where they grew and that I got up in the cold to find them and that I put them here with my own hands because that is what she taught me the altar was for. The ...
[The True King of the North, Part 1] Hild stood in front of the altar and looked at her mother's face in the place where her mother's face was not. There was no portrait. There had never been a portrait. Fern Stark had not been the kind of woman whose face ended up on canvas, because canvas cost money and money had gone to food and firewood and the bribes...
...# The True King of the North, Part 1  The wind off the polar shelf hit the ship broadside and stayed there, a constant pressure that leane...
...Aether, the same electric-metal tang that made visitors' eardrums ache within hours of arriving in Satulagi's northern reaches. The deck timbers were slick with frozen spray. The lanterns at the bow and stern burned low and a...

#### THE KINGDOM OF KHARVEN  (THE_KINGDOM_OF_KHARVEN_buri.md, score 40)
...
[**VI. THE BANNER HOUSES**] *Six houses beneath the Crown, each holding territory, troops, and the conditional loyalty that is the north**'**s only currency.* ***1. House Stark*** **Seat: **Hollenmark, eastern highlands near the Ketsuen border. **Territory: **The Ironwood March and eastern frontier. **Identity: **Borders. House Stark defines wher...
...the condition was honest, and Muken valued honest conditions above comfortable ones.  House Thornwall, House Ashmore, and House Hallenfeld were conquered in the traditional sense, their lords brought to submission through mili...
...t affect their function, because their function is the wall and the wall does not have opinions.  ***3. House Ashmore***  **Seat: **Ashbury, southern lowlands.  **Territory: **The Greenhollow.  **Identity: **The breadbasket. Ho...

#### THE KINGDOM OF KHARVEN  (THE_KINGDOM_OF_KHARVEN_corrected.md, score 40)
[**VI. THE BANNER HOUSES**] When the kingdom fell, the Ashmores survived because food is the one currency that never loses its value. They traded grain for protection, protection for political access, political access for favorable positioning in whatever power structure emerged from the collapse, and the positioning ensured that whoever eventual...
[**VI. THE BANNER HOUSES**] *Six houses beneath the Crown, each holding territory, troops, and the conditional loyalty that is the north**'**s only currency.* ***1. House Stark*** **Seat: **Hollenmark, eastern highlands near the Ketsuen border. **Territory: **The Ironwood March and eastern frontier. **Identity: **Borders. House Stark defines wher...
...the condition was honest, and Muken valued honest conditions above comfortable ones.  House Thornwall, House Ashmore, and House Hallenfeld were conquered in the traditional sense, their lords brought to submission through mili...
...t affect their function, because their function is the wall and the wall does not have opinions.  ***3. House Ashmore***  **Seat: **Ashbury, southern lowlands.  **Territory: **The Greenhollow.  **Identity: **The breadbasket. Ho...

### wiki "Called Late" (hit list and snippets only; full pages trimmed)

#### Wystan Ashmore — Late Bell  (Volume I — Character Cards/Wystan Ashmore — Late Bell.md, score 98)
[XVII. Fracture Log] Consolidated: three, all Band II, all ordinary. **Unconsolidated: one.** The six hours. He carries forty-one minutes of other people and one of them is Keld's, taken off a door handle, and in Keld's minute Keld is still lucid and still waiting for relief to arrive. Anchoring 420 is the only reason that minute is filed ...
[X. Techniques] *Effect:* he receives the operator's final minute as first-person memory, with the mechanism legible inside it. *Cost:* the minute does not leave. He carries forty-one of them. *Limit:* he gets the hand, never the purse. He can name who performed and never who paid, which is precisely what Article XV requires the Divis...
...rests at near-zero saturation, so free residue in a closed volume runs its gradient toward him without being called. **The Quiet Man.** Suppression 460, held continuously, waking and sleeping. It tires him and he does not dro...
...sion to prove. *Counterplay:* Fixatio-seal the object, handle it through an intermediary, or wait a season. **Called Late** · *Trigger:* a scene more than six hours cold. *Function:* reconstruction from a degraded field. *Mech...

#### The Called · Summon Register  (Summoned and Bound/The Called · Summon Register.md, score 76)
[The Five Summon Tiers] | Tier | Categories Active | Temperance | Duration | Stability Facet | |---|---|---|---|---| | **I · Ephemeral** | Animatria | IV to VI | 1 to 10 seconds | None recorded | | **II · Basic** | Animatria + Arts | VI to VIII | Seconds to minutes | E to D | | **III · Greater** | Vocatia + Animatria + Arts | IX to XI | Minut...
[The Entry Skeleton] ---
...# The Called · Summon Register  *The register of things called, and what answers when they are.* > Every summon entry answ...
...# The Called · Summon Register  *The register of things called, and what answers when they are.* > Every summon entry answers the same questions in the same order, and **th...

#### A Reader's Codex  (Reference Table/A Reader's Codex.md, score 42)
...d mountain range. Wherever one plane's law borders another's, a threshold has to exist, and that threshold is called the Veil. Every act of magic in this world crosses all three planes at once, and every named power in it, hum...
...al fact about someone before it is a service. Unmetered draw is illegal everywhere, universal everywhere, and called a spur. None of this is run by the Guild Accord itself. It is run by chartered Draw Boards, one per city or p...

#### The Ledger, structured  (The Table — Running Pieces/The Ledger, structured.md, score 40)
[The Ledger, structured] Generated from table/ledger.yaml by WOTR MCP. 28 open lines. `due()` says what comes due tonight.
[injuries and reserve] - `L006` **Sodoku Moto:** no full night since the ninth hour, eleven months and standing. Kurosetsu's remembering costs a vibration (Borin). Standing.  *(due: 1)* - `L007` **Bram Greymane:** three fingers, the hip. Walked in from the Stormfold road for the signing and would not sit down.  *(due: 1)* - `L008` **Brida:**...

#### The Open Crucible — Kwon Mu-jin's Book of Summons  (The Disciplines/The Open Crucible — Kwon Mu-jin's Book of Summons.md, score 40)
...# The Open Crucible — Kwon Mu-jin's Book of Summons  **A Ledger of Called Things** · *Kwon Mu-jin, Book of Summons and Techniques* > Every called thing that answers him arrives alread...
...-jin's Book of Summons  **A Ledger of Called Things** · *Kwon Mu-jin, Book of Summons and Techniques* > Every called thing that answers him arrives already annotated: readable, gradeable, correctable — the same way he has been...

#### The Sky, the Hour and the Year  (Cosmology & Metaphysics/The Sky, the Hour and the Year.md, score 38)
[The Sky, the Hour and the Year] > *The Accord asks what hour it is. The Sohai asks whose hour it is. Only one of those questions has ever had an answer everybody accepted.*
[The Guild hour, which is equal] **Ordinary people run both and do not find this strange.** A man works to the notch and catches the coach on the hour, and if the two disagree he is late for one of them and not the other, and which one he chooses to be late for is a statement about who he is.


---- full text of Wystan Ashmore — Late Bell ----

### wiki "Ferriby" (hit list and snippets only; full pages trimmed)
...
state.json facts naming the cast or the place, newest first (all from ch3; nothing about Yinzhi, Tally, the cut or the marker is in memory yet):

- ch3 · Edwyn Brack · fact: Brack heard Wystan say he will get a hand and not a purse. Quote: ""I will get a hand and not a purse.""
- ch3 · Wystan · misreading: MISREADING: Wystan believes the residue settling in a shut room falls on everyone alike; in fact it runs to him (H13). Quote: "It was what any shut room did by this hour, with the main running under it and people at work in it all day, and it came down on everybody in the room alike; Lyle had simply never sat a night on the Register, and had nothing on her hands to feel it with."
- ch3 · Bureau field sheets · object: Brack gave Wystan the Bureau's raw Ferriby field sheets with coil calibration, in a green-taped folder, unasked. Quote: ""No. Master Brack gave them to me in the passage.""
- ch3 · Elspeth Lyle · fact: Lyle refuses to put the Night Register on the return quarrelling with the Bureau. Quote: ""I will not put the Night Register on that return quarrelling with the Bureau over deer.""
- ch3 · Wystan · fact: Wystan initialled both position and term; his hand shook on the second initial. Quote: "His hand shook on the second initial and he did not stop to steady it."
- ch3 · Night Register file · fact: The Register's position, copied into Lyle's minute: a dose goes where it is put, and every site will show the same margin. Quote: "The Register's position is that a dose goes where it is put, and that every site will show the same margin when somebody walks it with a rule."
- ch3 · Night Register file · promise: The Register may keep the file open until the quarterly inspection of the gauge-housing and not a day longer; entered in Lyle's minute in ink under her silver seal, initialled by Wystan. Quote: "*The Register may keep this curiosity open until the quarterly inspection of the gauge-housing, and not a day longer. E. Lyle, Prime Warden.*"
- ch3 · Wystan · fact: Six people alive know what Stage Wystan holds; Keld knew first but is not counted among the six. Quote: "Keld was alive."
- ch3 · Keld · fact: Keld taught Wystan the druggist's fold in the back room of the old office on the river. Quote: "Keld had taught him to fold a paper the druggist's way."
- ch3 · Keld · fact: Keld counts under his breath to varying numbers (twelve, nineteen, seven, four, thirty); Wystan cannot find what he counts. Quote: "He could find nothing in the street that Keld was counting."
- ch3 · Brass token · fact: The Register's token is brass because the Night Register is not a full desk; carried four years, never asked to change it. Quote: "He had carried it four years and had never asked to have it changed."
- ch3 · Wystan · object: He retrieved the brass from the tin lid and put it in his waistcoat. Quote: "He put it in his waistcoat."
- ch3 · Wystan · object: His brass token was left on the tin lid at Cutler Row at the sixth division; he went to the medical house without it. Quote: "His brass was lying on a tin lid on Cutler Row, where he had left it at the sixth division, and he gave his name at the porter's hatch with nothing in his hand."
- ch3 · Wystan · fact: Wystan was the second man through the landing door and took the minute off the handle; the relief came late. Quote: "The first had his arms full, so it was Wystan who put his hand on the handle, and that was how he had the minute."
- ch3 · Keld's minute · fact: The written record's exact text, in brown ink gone tea-coloured, folded in four in Wystan's coat. Quote: "*Keld, O. Door on the landing. Handle iron, cold. Right hand. Lamp behind. Count at thirty-one. Legs tired. Not afraid. Bread, dark, butter. Says: "Sixth. They said the sixth. Hold it to the sixth."*"
- ch3 · Keld's minute · fact: Keld's minute is held by Wystan and checked each morning against a written record; the minute first, then the paper. Quote: "The minute came first and the paper after, because a record read first is a record remembered, and after that the minute would only agree with it."
- ch3 · Wystan · injury: Holding himself suppressed asleep leaves his jaw and shoulders aching each morning. Quote: "He had kept himself down all night, asleep, the way he kept himself down awake, and this was what it came to in the mornings."
- ch3 · Wystan · injury: His hands shake with a fine fast tremor at waking, worse in the right; the Division filed it as a disciplinary observation. Quote: "The Division had entered it in his file under a different heading, in the copying hand, as a disciplinary observation."
- ch3 · Wystan · time: Chapter runs Day 1 from noon to the ninth division. Quote: "He woke at noon with the shutters closed and the house humming under him."

### Summaries of prior chapters

state.json `summaries` holds ch3 only. Ch1 and ch2 are from each chapter's `final_notes.md` (the writer's own, as carried in the ch3 brief); ch4 has no draft.

- **Ch1, "The Docket Head" (Wystan POV).** The same night, from the fourth division to the sixth. Wystan checks and blots Yinzhi's full name at the docket head (the name is not rendered) and enters her as assay of record. Gloved, he moves the Ferriby wedge with forceps into a fresh Division Fixatio tin, seals it with brass wax and strikes his brass into the seal. He logs it in the day book as Register file Ferriby, exhibit one, "crown +¼ in sealed." He collects the four pieces of chapter wax: two were on the front-room blotter and two under the desk. The pieces fit the join. He folds them in a druggist's paper, dates it on the outside and keeps it for custody. Over grounding tea he asks whether the bracelet is still pulling, and Yinzhi says no. He drafts a nine-word wire, rejects it and writes a letter to Tally instead: walk the line and measure into a notebook, a second dataset from the same observer, who set the marker, and what the animals put their mouths to. He signs it "Night Register, Cutler Row." He sends Yinzhi home. He enters the Register's position, "A dose goes where it is put," and records the forty-second minute. The main returns at the sixth division. At the day desk he writes his memorandum under Brack's closed classification, with *edges* in the margin. A day clerk reads only the classification and shelves the book.
- **Ch2, "Twenty-Two Drops" (Vesk POV).** Day one, the second division to the ninth, at Greyshaft Nine. Nuvalik brings the ninth hind down off the rail onto the slate table. Vesk has built the contractile matrix into the third-dilution formulation on one pour and lets it stand, then carries the flask in both palms and works it in at four places along the near flank, the count of forty between each. The colour clears inland, faster at the two forward pours; Foss, at the glass, gives the reason (the trunk quit last, the forward channel is finest, the finest channel pulls hardest) and calls the synthesis filthy and correct, wanting both findings in the book. Malphas asks Foss to get the Arbitration Division's field manual for its unsigned attribution paragraph; Foss refuses a wire and says it will take a season, and Malphas accepts a season. Nuvalik states what the hind is: no Crystal, no self, a net that shortens toward the emptier end. Malphas orders the night written up in ink under the project's name by four hands. The hind does not stand. Vesk sees the hide at her shoulder draw up once, tells nobody, and counts the drip to twenty-two.

Declared in ch1: lie (Qiu Yinzhi) "It went quiet when you were at the sink." — false, the bracelet never stopped pulling; uncorrected. Misreading (Wystan): the dose stops where the formulator stopped putting it — entered as the Register's position "A dose goes where it is put," stands until ch15–16. Declared in ch2: lie (Nuvalik) "Everything the fourth hind gave me is written down." (H08); misreading (Vesk) the Lord's warm hands explained by the ice press exhaust.

- **Ch3, "The Morning Check" (Wystan POV).** Day 1, noon to the ninth division. Wystan wakes with his hands shaking. He recalls Keld's minute, then reads the written record against it word for word. It has not moved. At the medical house the porter admits him by his face, because his brass is on the tin lid at Cutler Row. Keld sits at the window counting under his breath at something Wystan cannot find. He asks "Is that them" and says "They said the sixth." At the day desk Prime Warden Elspeth Lyle reads the edges memorandum and calls the file a curiosity. The Register may keep it open until the quarterly inspection of the gauge-housing and not a day longer. In the upper passage Brack stands by bleed and hands over the Bureau's raw Ferriby field sheets unasked. In Lyle's shut room the position and the term go into her minute in ink, under her silver, and he initials both. Residue settles on his skin and he does not remark it. Lyle orders the sheets entered as received unasked and denies sending for Brack. At the ninth division Wystan tells Brack: "I will get a hand and not a purse."

Declared in ch3: lie (Elspeth Lyle) "I did not send for Master Brack." Misreading (Wystan): residue in a shut room falls on everybody alike (H13; corrected ch44).
- **Ch4, "A Number in the Room" (Xu Deming POV).** Not written: gate escalated, no draft in four rounds. Nothing from it is canon yet.

### Hook agenda

Hooks planted or advanced and due within 3 chapters (due ch5–ch8), and any overdue:

- **H08-concealed-contraction** (planted ch2, due ch6, status planned). Nuvalik got contraction out of the fourth hind's shoulder twice and did not report it; Malphas 'will discuss with her separately'. Paid when the discussion happens. Keywords: contraction, shoulder, separately, twice. Nuvalik/Malphas side (ch6); do not touch.
- **H01-far-side-of-the-marker** (planted ch1, due ch7, status planned). Tally found clean ground on the far side of the parish marker, twenty-two paces past the last carcass, and checked it twice; Wystan writes 'ask Tally who set the marker'. Paid when the lick-keeper's round is found to end at the marker: the carrier turned home there. Keywords: marker, far side, lick, turned. This chapter sets it up (the marker identified, the round found); ch7 pays it. Do not pay early.
- OVERDUE: none (no unpaid hook has a due_ch before 5).

Note: state.json still reads status "planned" for the ch1/ch2 plants (H01–H11, H21; H23 and H24 read advanced; H12–H15 and H32 read planted); the ch1/ch2 memory pass has not marked them planted. H16–H19 are "planned" and genuinely unplanted, because ch4 was never drafted: H16 (due ch22) and H17 (due ch47) have room; nothing in ch5 should plant or cite them (they are Deming-side and Wystan cannot know them).

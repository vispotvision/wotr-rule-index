# Brief — Chapter 6, "Separately"

Book: night-watch-zombification. POV: Nuvalik. Culture: Accord. Proposed Front: project-zombification. Assembled 2026-09-24 from outline.json, bible.md, state.json and the read-only book tools. Nothing here is written to the table.
...
```json
{
 "number": 6,
 "title": "Separately",
 "beat": "In the ice-press room Malphas has the discussion he promised: Nuvalik says she hid the twitch in the fourth hind's shoulder because a thing that twitches is a thing that will walk, and he asks her to make it happen again by morning. Foss reads the Division field manual aloud, the unsigned paragraph on anamnetic reading and its counters: seal the object, use an intermediary, wait a season, move a wall. Malphas makes each counter a house rule (every flask Fixatio-sealed, no live dose touched bare, everything through a second pair of hands) and tells Foss that when the work is done he will be released with his own name. The cell now works against the Night Register as against a form it has read.",
 "scene_type": "talky",
 "pov": "Nuvalik",
 "cast": [
  "Nuvalik",
 ...
 "place": "Greyshaft Nine, the coldhouse, the ice-press room",
 "front_id": null,
...
- **H20-the-field-manual-paragraph** (planted ch6, due ch71, status planned). Foss reads the Division field manual's unsigned paragraph on anamnetic reading and its counters; Malphas adopts them as house rules. Paid when a moved wall makes Wystan's Called Late at Greyshaft Nine confidently wrong. Keywords: field manual, paragraph, wall, moved. **Plant it here:** Foss reads the unsigned paragraph aloud and Malphas adopts the counters. "Move a wall" must be on the page in Foss's reading; it pays at ch71 (a moved wall makes Called Late at Greyshaft Nine confidently wrong). Do not move a wall in this chapter.
- **H28-foss-released** (planted ch6, due ch70, status planned). Malphas promises Foss release with his own name when the work is done. Paid when Foss takes a bench under his own name and informs no one. Keywords: released, own name, bench, Oath. **Plant it here:** Malphas tells Foss that when the work is done he will be released with his own name. It is true, and it pays at ch70. It is not this chapter's lie.

### Hooks this chapter pays

- **H08-concealed-contraction** (planted ch2, due ch6, status planted). Nuvalik got contraction out of the fourth hind's shoulder twice and did not report it; Malphas 'will discuss with her separately'. Paid when the discussion happens. Keywords: contraction, shoulder, separately, twice. Event ch2: Vesk asks about the fourth hind's twice-reported contraction; Nuvalik says it is all written down. Quote: "Everything the fourth hind gave me is written down." **Pay it here:** the discussion happens. Nuvalik says she hid the twitch because a thing that twitches is a thing that will walk, and Malphas asks her to make it happen again by morning. Canon caveat (audit C3): Malphas already knew of the contraction in ch2 r0, and the "separately" line exists only in r1. What she hid is the entry in the book. See Protocol.

### Hooks the beat touches without paying

- **H07-warm-hands** (planted ch2, due ch60, status planted). Malphas's hands keep a living man's colour in a four-degree coldhouse. Paid in the hearing gallery, at the verdict, as a detail Wystan notices and never explains; never recognition. Keywords: hands, warm, cold, gallery. Event ch2: Malphas's fingers keep a living man's colour after sitting ungloved at four degrees; Vesk explains it away by the press. Quote: "What there was instead was the one thing Vesk could not get past: the Lord had been sitting on an iron bench in a room the housing gauge had at four degrees since the first division, with no gloves on and his coat folded beside him and not under him, and his fingers were the colour of a living man's fingers." Malphas sits in the four-degree coldhouse. His hands may be seen again, never explained. Audit: it trips dormancy this chapter unless touched.
- **H09-nuvaliks-three-names** (planted ch2, due ch55, status planted). Nuvalik carries a name three people carried before her and thinks she has spent all three on this work. Paid when she sets down the name she wears in the cell and leaves; she does not inform. Keywords: name, three, set down, leaves. Event ch2: Nuvalik tells Vesk her name was worn by three before her and she has spent all three in this room. Quote: "The name I wear was worn by three people before me." The POV carries it. The beat's "released with his own name" to Foss sits next to her spent names. It can be touched, but it is not paid (ch55).
- **H10-vesks-grafts** (planted ch2, due ch46, status planted). Vesk's grafted fingers, the ridged yellow nails that will not stop growing; the village that put stones on its graves. Paid when he dies of his own formulation and Nuvalik lays stones on his walking body. Keywords: grafts, nails, stones, grave. Event ch2: Vesk's two grafts and ridged yellow nails; his village's nine grave stones. Quote: "The second had taken in the way that a thing takes when it has been asked twice, which was well enough for holding and badly for gripping, and the nails on the two fingers that took had come in ridged and yellow and had never stopped growing since." Vesk is in the room. "No live dose touched bare" lands on the man whose grafts grow on his own formulation. Touch it, don't pay it (ch46).
- **H21-the-ninth-hind** (planted ch2, due ch10, status planted). 'The ninth hind is the freshest and she is the one I want.' Paid when she stands up off the table and leans to the standpipe. Keywords: ninth hind, table, stood, standpipe. Event ch2: The ninth hind on the table with the matrix pour in her; she does not stand, the hide draws up once. Quote: "The ninth hind is the freshest and she is the one I want." "Make it happen again by morning" points at the table, and the standing is ch10's. Print no day count that fights ch2 (audit C9).
...
**This chapter's tick:** segment 1, "The dose walks", second of its three pushes (ch2, 6, 10; ch10 fills it when the ninth hind stands). Mention is not advancement (bible). The world changes here in two ways. First, the concealed contraction is brought into the book and ordered reproduced by morning: the cell now works toward a walk, not a twitch. Second, the counters to anamnetic reading become house rules: every flask Fixatio-sealed, no live dose touched bare, everything through a second pair of hands. The POV sees the consequence: the cell now works against the Night Register as against a form it has read, and her own hands are under the new rules. The segment is not filled. `front_id` stays null, and nothing is written to `table/fronts.yaml` (that needs `add_front` on Isaac's word).
...
- **No PC in this book.** The standing book rule from bible.md applies in its place: **neither Wystan nor Malphas ever learns of the other.** Malphas knows his hunter only as "the Night Register" (the clerk told Tally it "was a person") and at most "a desk on Cutler Row with a brass token." In this chapter he designs against the field manual's unsigned paragraph **as against an institution, a form it has read**, never a man. The copy Foss reads carries no issue name, no issue number and no mark that leads to Wystan, to Keld or to Cutler Row (audit carry-forward 3; ch2 fact: the manual "is a numbered issue" logged against a name). Wystan is never named, described or hinted at. Nothing noticed across that line is ever paid as recognition, and the narration never winks at the reader who knows both (voice note anti-exemplar: "Somewhere out there a man with warm hands was watching..." is exactly what is forbidden, in either direction).
- **POV and interiority.** POV is Nuvalik, close, in her craft (the knife; bible voice note: "Crew chapters run in their POV's craft"). Her tell: she wipes the blade on her apron before she speaks. **Malphas is seen, never entered** (bible: until Movement VI). **R39-7 binds over Table Rule 10** (bible, POV and narration): only the POV (Nuvalik) thinks in italics; Malphas, Foss and Vesk get no private italic thought.
- **Length:** 3,500 words (outline target), set-piece band (Table Rule 2: set piece 2,500 minimum with full scene standards). Scene type is talky: the chapter is a discussion and a reading aloud; its weight is in what is said, withheld and ruled, with body language over talking heads.
- **One deliberate lie by an NPC** (Table Rule 8; the NPC is Malphas, Foss or Vesk, the only NPCs present) and **one misreading by the POV character** (R6-4, R5-C1), both declared verbatim in the notes. Do not spend the lie on Malphas's promise to release Foss with his own name: H28 pays it as true (ch70, Foss takes a bench under his own name). Nuvalik's misreading must be well-reasoned and stay wrong; the bible's standing misreadings are Wystan's, not hers, so hers is originated here and declared.
- **H08 as canon has it (audit C3, carry-forward 1).** Canon is ch2 r0. Malphas never says "separately" there, and Vesk already heard "The Lord said contraction. Twice, he said." Malphas therefore already knows the shoulder contracted. What Nuvalik hid is the **record**: she kept it out of the book ("Everything the fourth hind gave me is written down" was her lie to Vesk, fact #85). Write the discussion as Malphas taking up her omission from the book, not as a revelation to him. Open on, or return to, her line "Everything the fourth hind gave me is written down." Her reason is the beat's: "a thing that twitches is a thing that will walk". His order is to make it happen again by morning.
- **H20 and the season (audit C2, carry-forward 2).** On Day 1 Foss said "It will be a season" and Malphas said "A season is acceptable." This is Day 5. Show on the page how a copy came early (ch5: "The whole of the chapter's bench had read the field manual": copies are about), and have Foss remark that the season came short. The copy's provenance must not run toward Wystan (see the book rule above).
- **The counters become house rules.** Foss reads four counters (seal the object, use an intermediary, wait a season, move a wall). Malphas makes each a house rule. The beat names three concretely (every flask Fixatio-sealed; no live dose touched bare; everything through a second pair of hands). "Wait a season" and "move a wall" are read, and they stand as the cell's future (the season: ch50; the moved wall: ch66 and H20's payment at ch71). Do not pay them here.
- **Numbers:** none invented. Numbers reach the page only in a mouth, an instrument, a document or a private count (R14-4, R12-5). Nuvalik, Foss and Vesk have no figures on their cards ("Pending Isaac"). Malphas's card is the lich form, and **none of it reaches the page** (bible). No Stage is named or implied for him. Attested figures usable in the room: the drip at twenty-two a minute (Vesk counts it); the housing gauge at four degrees; nine carcasses on the rail; the main capped four years. Time is in divisions only (audit C16), on Day 5.
- **Register:** the crew idiom. The dead are reported flat. The coldhouse has no hum: the main under Greyshaft Nine is capped. The hum's absence is the room's condition, and the book's clock is the hum and the moment it stops. Standing Inventory: two recurrences minimum (bible list). Available here: the standpipe, iron, waist-high, capped (the dead housings along the west wall); the gauge-housing and its quarterly inspection (Foss has it open, seal broken); the nine-word wire (Foss would not wire for the manual); the roll and the entry in ink (the project's book, "by four hands, in one book"); the salt bar is not yet planted (H22 is ch8).
- **Malphas's hands** keep a living man's colour at four degrees (H07). This may be seen again from Nuvalik's side. It is never explained and never connected to anything.
...
`scene_brief "<beat>" --thread "Wystan Ashmore" --type talky --culture Accord --cast "Nuvalik" "Malphas" "Ilmar Foss" "Vesk"` (the loadout is dropped because it is §3). The tool's header names the thread (Wystan Ashmore), but this chapter's POV is Nuvalik. Malphas's FOW lines are the lich card, and **none of them reach the page** (bible).
...
Last 1451 words of `ch05/final.md` (raw, cut at a paragraph boundary). Ch5 is Wystan-side, and nothing in it is known to the cell.

Then he took out what he knew.

Tally's line up the middle, the ninth and the tenth and every day since the letter: a worn strip of broken ground with a clock in it for every day he had walked it, each newer than the last. Yinzhi's, on the ninth, from the cut to one of the dead and back, and a place where she had knelt in the wet. The three of them tonight, bright and raw. He took them out one at a time and set them aside.

Across the rise the fire had caught. He could hear it crack, and their voices under it, low and not for him, and he did not attend to them and heard them anyway.

"...not doing anything," Tally said, at some point. "He's stood there."

"He is." Yinzhi. "It's... Everything that came off them goes on coming apart. At a rate. If you know the rate you know how long since. He's putting it back where it was."

"Like age on a track."

"I don't know tracks."

"Edge of a print goes soft. Rain on it, frost. A day's print and a week's, you can tell them. Anybody can."

"Then like that. Only everywhere at once."

A while after, Tally again. "Is it safe? For him."

"It's not touching. He isn't touching anything, it's not the..." Her voice went and came back lower. "It's the other kind."

The thirteenth. His feet had begun to swell in his boots, and the laces bit across the instep. The cold came up out of the ground through the soles and settled in the bones of his shins. He was hungry, and then at some point in the fourteenth he was not, which was worse; the hands started, the fine fast tremor he woke with, and he let them shake at his sides and did not look at them. His calf knotted on the left. He did not shift his weight. He kept the cut.

In the first division, with the day turned over, there was something left over.

It lay just inside the birch on the east side, on the estate's round. The round had been trodden bare long before any of this. What the dead had shed lay differently on bare ground than on grass, so the round showed in the field as a shape before anything else did. Down its middle the shed had been broken at intervals, at the length of a man's stride when he walks and is not hurrying. He followed the breaks north. They came up the round out of the birch from the south, from beyond the reach of the ground he had built, and stopped short of the stone. Well short. There they stood a while, the ground broken close and several ways at once, as ground is broken by a man standing and shifting his feet. Then they went back south down the round the way they had come.

He went over it again, and there were more of them under the first. The breaks lay over one another on the same line, at the same stride, and their clocks did not agree. The newest were weeks old. Under them lay older, and under those older again, and he could not get to the bottom of them. None went on past the place where they stopped, or followed the round where it bent west along the bound. Nothing of his came near the stone.

He held that, and went through it again from the beginning, and again. The second division. The third. His vision began to go grey at the edges when he blinked, and come back slow. The fourth, and the fifth. Across the rise the fire had sunk to embers. One of them slept.

The sixth division came, and nothing came back with it. Eight divisions. He had counted every one. There was no main out here to return. He stood in the cut with his hands shaking and heard the whole of the country be quiet around him, the burn and the birch and a wren somewhere, and nothing under any of it.

He said, "Come across."

They came round the stone, Yinzhi first, her coat buttoned to the throat and her face grey with the night. Tally stopped a pace behind her and did not come nearer the dead than he had to.

"Somebody came up from the south," Wystan said. His voice came out low and rough and he waited for it and went on. "Along the estate's round. Through the birch. He stopped short of the stone, well short, and stood a while, and went back the way he came. On foot. Not a horse, not a cart. At a walking pace, not hurried. And more than once."

"How many times?" Tally said.

"More than once." He swallowed. "I will not give you a number I cannot swear to. There are more under the ones I can count."

"Who?"

"Somebody. I have his feet. I have nothing else of him."

"The divisions," Yinzhi said. "Can you..."

"They go in the book."

"What did he do?" Tally was looking past him at the birch. "Stood there. Doing what?"

Wystan went back to it. The ground broken close, several ways at once, in the same place on the round each time, short of the stone. A man standing, shifting his feet. It did not come up in the field as anything else, and nothing he had built of the cut would make it more.

"He stood," he said. "I cannot give you what he did standing."

Tally said nothing. Yinzhi was watching Wystan's hands.

Nobody had set the marker for this. It had been there since before the roll, and a man who wanted a line did not need to cut one; he needed only to know where one was. *A boundary means somebody chose one.* He had turned short of the stone so that the dead would lie on this side of it. That was the edge. Tally had found it and checked it twice, and the far side was clean because nobody had come past the stone to make it otherwise.

He turned to look at the birch, and the ground went away from under him.

It did not go far. The grey came in from the edges of his eyes all at once and the cut tipped, and his knee was on the grass and his hand was on the stone, flat, on the cold grit, before he knew he had put it there. His heart was going fast and thin. He stayed where he was and let it come back. Yinzhi had him by the upper arm.

"Legs," Tally said. "You've stood all night. Blood goes to the feet. Put your head down."

He put his head down. After a while the grey went back to the edges and stayed there.

He took his hand off the stone. He had not held it by the edge. He looked at his palm, at the grit pressed into it and a smear of yellow lichen, and found nothing there but stone. Then he sat back against the south face, over the letters, and both calves cramped at once, and he waited that out too.

Tally cut bread and cheese on his palm again and held them out, and this time Wystan took the bread. He took it by the edge of the crust, two fingers and a thumb. It was dark and dense and tasted of the pack, and he ate it slowly, and his hands shook over it, and he did not try to stop them.

When he could, he took out the day book and opened it on his knee at the page with the margin. He wrote the sequence in the plain words he had said it in, and the divisions against each pass as near as the field would give them, and under it, *stood, short of the stone; what, not had.* Beneath *edges* and *ask Tally who set the marker* and *the estate. before the roll.* he wrote two words.

*the round.*

"Where does it go, south?"

"Round the estate. Their ground, the whole of it." Tally slid the knife into its sheath. "It's theirs. It's not my line."

He got up by stages, a hand on the stone, and stood until he was sure of it. Then he walked to where the round came out of the birch, and looked down it.

It went away south between the pale trunks, trodden bare down its middle, no wider than a man, and now that it was light he could see a long way down it.

## Cast

state.json holds facts about all four cast members, so each gets the FOW line (`fow_line NAME`), not the full card.

### Nuvalik (POV)

Bible line: **Nuvalik.** Card stub. Far-Northern; carries a name three people carried; wipes the blade before she speaks; the sky proverb. Leaves ch55 with Tally's rule, informing no one.
...
Bible line: **Ilmar Foss.** Card stub. Instrument-maker struck from the Hexagonal Oath for "a rounding convention"; steadiest hands; explains like a man expecting an appeal. Released ch68; lives under his own name, informs no one (ch70). Roll-name question (R23-11) left open.
...
Bible line: **Vesk.** Card stub. Formulator; grafted hands that no longer close, ridged yellow nails; the village that put stones on its graves; counts the drip. Dies ch45 of his own Verdantia in his grafts; walks; stones.
...
`voice_fingerprints`. Only Malphas appears among this cast (8 lines, the minimum). Nuvalik, Foss and Vesk have fewer than eight attributed lines. Rule: if two characters' lines could be swapped and nobody noticed, the scene failed (R15-1-VOICE_DIFFERENTIATION).
...
### scene_recall "ice-press room contraction fourth hind shoulder field manual anamnetic reading counters Fixatio seal intermediary house rule"

##### Commencement of The Curia. [ Kujo Arc ]  (commencement_of_the_curia_kujo_arc.md, score 99)
[Commencement of The Curia. [ Kujo Arc ]] *He drilled the over-under against a partner who was allowed to attack from any position, eleven times, and would not tell me the point, and I asked on the ninth and he said HOO and nothing else. It is not a wrestling tie. It is a subtraction. It is the same shape as my own Trait and he built it into my hands before he...
...
...me they started on the thighs, which was the only benefit the abscesses had conferred.  They gave him water twice a day and they gave him enough. That was the part that had told him most about who was giving the instruction...
...he bottom of it was a thing he had never written down and could no longer clearly remember, and the whole edifice released from the bottom on a schedule nobody had ever explained to him.  The lamp on the wall bracket stood...

##### The_Path_of_Sorrow  (The_Path_of_Sorrow.md, score 94)
[The_Path_of_Sorrow] "I did not ask what your documentation says. I told you what your number means." The interruption was surgical. Not rude, not aggressive, not the dominance-display of a young fighter establishing territory. Simply the precise insertion of a sentence into the space where another sentence had been forming, occupying the ...
[The_Path_of_Sorrow] Temür sheathed Kurosetsu. The guard settled into the scabbard mouth. *Tck.* The sound was small and final and meant something different tonight than it had meant in the corridors of Kharven or on the ridge above the Tenrai settlement. In Kharven it had meant the verdict is complete. On the ridge it had meant the senten...
....  *Father. Mother. Tomuka. Kharven. The Ashen Mandate. The War Court. The Covenant Archives. The warding lattice. The corridors I knew by distance. The throne room where Muken's scars glowed when the kingdom pressed too ha...
....  *Father. Mother. Tomuka. Kharven. The Ashen Mandate. The War Court. The Covenant Archives. The warding lattice. The corridors I knew by distance. The throne room where Muken's scars glowed when the kingdom pressed too ha...
...
...om the wash-tray where the evidence tins sat draining.  The insert had come up from the Society's bulletin office in a bundle of nine and it was the only one he had read twice.  *Filed 14th, Tally, N., Timberline chapter, N...
...sert had come up from the Society's bulletin office in a bundle of nine and it was the only one he had read twice.  *Filed 14th, Tally, N., Timberline chapter, North Ferriby walk.* The Night Watch Society printed its insert...

##### The Fire of the Undeserving  (01_verinus_fire_of_the_undeserving.md, score 74)
[The Fire of the Undeserving] Consent is required of every soul the seal will cross. The received register holds that consent must be spoken aloud before the third mark is lit. The older register holds that a soul consents when the bill is set in front of it and it does not look away. Both readings are filed. The Court has ruled for neither, and fo...
[Notes (author-facing, not canon)] **Canon conflicts surfaced, need your ruling.** 1. *Palinate* in your rough. Every Verinus scene and the Vaeloris Sequence header have **Palatine**. Used Palatine. 2. *Nalūn shaking.* Sanctum Lux puts the Grand Church in the Kingdom of Altherion; Nalūn is the salt basin and its Wellsprings are Contraxis and Fixatio. I ...
...use the words do not wait.  The bill is set once and paid once. What the rite takes, it keeps. There is no office to petition, and the Court has stopped pretending there is.  Consent is required of every soul the seal will...
...ither, and four Palatines have declined to be the one who does.  Do not close the seal with any part of the price unpaid. The record holds five attempts. In each the seal closed on the celebrant, and in each the celebrant i...

##### The True King of the North, Part 15  (the_true_king_of_the_north_part_15.md, score 73)
[The True King of the North, Part 15] He dodged it. The word dodged was insufficient. The movement was the Edict Step at combat frequency, three compressed relocations in the space of one second, each step leaving a frost-trail on the ice, each trail carrying the Mandate Weave's architecture, each architectural trail connecting to the previous trail and th...
[The True King of the North, Part 15] The massive body settled. The hind legs folded beneath the torso. The forelimbs extended forward, the great paws pressing flat against the ice in the specific posture that the bestiary documented as the Droval's bonding-acceptance position, the position in which the creature's body made itself available for mounting by...
...ntensity, the low owl-like vocalization carrying the dual-frequency weapon: the audible component shaking the ice beneath the column's boots, the sub-audible Harmonic resonance striking the crew's thermoregulatory systems w...
...he Dawi stood with his hammer across his chest and his malachite eyes tracking the Droval's claw-marks in the ice, reading the depth and the angle and the specific material-science data that the claw-marks contained, becaus...

##### The House of Abscene ( Kujo Arc )  (the_house_of_abscene_kujo_arc.md, score 51)
...regarded conquest as an ambition but as an administrative necessity. “The Material Plane,” he said, and his voice moved through the shattered village with the low, ruinous smoothness of something spoken directly into the bo...
...“A miner loses several seconds inside a tunnel and assumes fatigue. An assay master reads the same sample twice and remembers only one result. A lift operator forgets whether a gate was closed and checks it again. A forge...

##### Continuity map  (CONTINUITY.md, score 51)
...Sorrow.md`  ### Kharven — the return (the eleventh year)  (19 scenes)  Two strands braided: the column on the ice (7, 8, 9, 12b, 13, 14, 15a) and the north waiting for it (1b, 10, 11, 12a, 15b, 16). They converge at the gat...
...t); ends firing Unravel at the arriving Dova'Kan. | Names the loophole the arc turns on: Cozbi's Pneumata Lattice dresses conscription in the architecture of extension, so Rescind found no claim to withdraw consent from, an...

##### WAR OF THE REALMS  (WOTR_Vaeloris_Sequence.md, score 50)
...Vaeloris** · The valley, the flame, the count. Verinus, Fend, Thole, Nuru Zettari. 4. **One Reading, Taken Twice** · The return and the quarantine negotiation. Verinus, Thole, Barrow. 5. **Three Poppy Heads** · The letter...
...sh off them. He could feel the grain of the stone through the sole of his left shoe, which had been resoled twice and was due a third time, and he had been meaning to send it down to the cobbler for eleven days.  There were...

### scene_recall "Nuvalik Malphas Ilmar Foss Vesk Greyshaft Nine coldhouse ice-press room"
...
...bout to say that the purity was the elegant part and it now seemed better not to.  Malphas lifted his head.  "Nuvalik. The bodies."  She was down at the tail of the rail with a knife and her sleeves pushed past the elbow, and s...
...aid so twice."  "Say it a third time."  "A carcass no bird will touch is a carcass that stays where it fell." Nuvalik went back to the hind's shoulder and opened it in one draw. "Four ravens sat over the Ferriby cut for a full...
...
[The War in the North I — The Kharven-Seat] Tabitha Hallenfeld came in with the cold behind her and the road still on her, six days of it, the hem of her riding coat frozen into a plate and cracking as she walked. She got two paces in, saw the room, and did not bow at all. "Nineteen in the party," she said. "Grey, and a chapter escort in proofed plate, sword and...
...
##### The Weight of a Courier  (wotr_the_weight_of_a_courier.md, score 42)
[II. WHAT THE COURIER WEIGHED] "There is a death-house at Coldbeck with forty in it," he said. "They cannot bury them. The ground is shut until Ice-out and the man who reads the names is a cooper because the last one who could do it properly died four years ago and the liturgy went with him. I stopped there on the sixth night. A woman gave me half a...
[The Weight of a Courier] *Kharven-Seat · The Alabaster Court · Altherion* ---
...ed to open."  He stopped.  He had not planned any of it and had no idea where the rest was.  "Her name is Ada Foss," he said. "I asked. I did not have to ask. I asked because I wanted to be able to say it somewhere that matt...
...did not want to be talked out of it.*  "I have an answer. The answer costs an evening, and we have a courier nine days out, and I would sooner spend the evening on the thing that can still be changed." Sodoku pulled the pla...

##### Nine Hours of Daylight  (nine_hours_of_daylight.md, score 38)
...
##### The Hatch  (the_hatch.md, score 37)
...
##### The True King of the North, Part 9  (the_true_king_of_the_north_part_9.md, score 36)
[The True King of the North, Part 9] The sentence sat in the cold air for a moment before the wind took it. The sentence was new. The fourth slot, empty for forty years, acknowledging for the first time that the emptiness might not be permanent. That the work on this ice sheet, on these chains, for these brothers, might be the work that filled the slot. T...
[The True King of the North, Part 9] Borin picked up the hammer. The hammer was his. Not the forge's. Not the ship's. His. The hammer he had carried since his apprenticeship, the hammer whose weight his arm knew the way his lungs knew air, the hammer whose face had been reground four times and whose haft had been replaced twice and whose identity had pers...

##### The True King of the North, Part 13  (the_true_king_of_the_north_part_13.md, score 36)
[The True King of the North, Part 13] The throne room was cold. Not the building's cold, not the climate's cold, not the cold that the collapsed roof sections admitted through gaps that the rebuilding had not yet sealed. A different cold. A cold that had arrived three seconds ago, when the Ashmore man had been pushed through the doors, and that had settled...
[The True King of the North, Part 13] "So here is what I want you to carry back to your house, Pietro Ashmore. Carry it back to every lord who calls me Ice and thinks the calling is the dismissal. Carry it back to every family that chose the Tenrai because the Tenrai have an army and I have a broken throne and dangling feet and a name that sounds like wint...

### wiki "Fixatio" (hit list only; snippets and full page trimmed for length)

- Sigillum Fixatio  (Techniques/Sigillum Fixatio.md, score 102)
- Kaelan Vorn · The Axiomatic Sovereign  (Volume I — Character Cards/Kaelan Vorn · The Axiomatic Sovereign.md, score 80)
- Cael Dareth · The Pale Crucible  (Volume I — Character Cards/Cael Dareth · The Pale Crucible.md, score 79)
- Ser Caldran Veiss · The Pale Knight of Vergegate  (Volume I — Character Cards/Ser Caldran Veiss · The Pale Knight of Vergegate.md, score 77)
- Anryū Ichimonji  (Volume I — Character Cards/Anryū Ichimonji.md, score 76)
- Kaelric Varnier · The Silver Veil  (Volume I — Character Cards/Kaelric Varnier · The Silver Veil.md, score 73)

### wiki "Night Register" (hit list only; snippets and full page trimmed for length)

The top hit is Wystan's card. It is here for the writer's reference only. **Nothing in it reaches this chapter**, and the cell knows the Register only as a form.

- Wystan Ashmore — Late Bell  (Volume I — Character Cards/Wystan Ashmore — Late Bell.md, score 97)
- Nol Tally  (Volume I — Character Cards/Nol Tally.md, score 59)
- Errata to the Received Registers  (Cosmology & Metaphysics/Errata to the Received Registers.md, score 55)
- Haelvorn · Housecat  (Summoned and Bound/Haelvorn · Housecat.md, score 55)
- The Called · Summon Register  (Summoned and Bound/The Called · Summon Register.md, score 54)
- The Bestiary  (Bestiary/The Bestiary.md, score 53)

## Continuity

### Facts (cast or place, newest first)

- ch4 · Malphas · fact: Malphas sent for Deming to the coldhouse after the ninth division (the work already named) and ordered the Project name onto the letter; Deming argued against it with the precedent, and Malphas answered only 'I would prefer the file be built off a word I chose.' Quote: "He had sent for him to the coldhouse after the ninth division, when the work already had its name, and told him there, while Deming stood by the door with his hat in his hands and the rain on his shoulders and argued."
- ch2 · Vesk · fact: Vesk ends the night writing the division in the book's margin. Quote: "Then he went to the shelf for the book and wrote the division in the margin."
...
- ch2 · Vesk · fact: Vesk claims she needs only eleven feet since the building is the emptiest place in four streets; Malphas answers she has not yet got up. Quote: "Then she will not need four days."
- ch2 · Vesk · misreading: MISREADING: Vesk believes the ice press's warm air along the east wall explains why Malphas's hands never take the cold (worked out the fourth night, never said). Never corrected; never paid as recognition. Quote: "The press threw its warm air along the east wall and the gauge bench stood in the middle of it, and that was the whole of why the Lord's hands never took the cold."
...
- ch2 · Ilmar Foss · fact: Foss, at the glass, calls the synthesis filthy and correct and wants both findings in the book. Quote: "It is filthy, and it is correct, and those are two separate findings and I want both in the book."
- ch2 · Vesk · fact: The pour: four places along the near flank, not the wound, a count of forty between each; the colour cleared inland, faster at the two forward pours. Quote: "He worked it in at four places along the near flank, a little at each, and between each he stopped and gave it the count of forty and watched the colour go out of the surface as the channels took it away inland."
- ch2 · Nuvalik · fact: Nuvalik's name was worn by three people before her; she says she has spent all three of hers in this room. Quote: "The name I wear was worn by three people before me."
- ch2 · Nuvalik · fact: Nuvalik's tell: she wipes the blade on her apron before she speaks; it frightens Vesk. Quote: "She wiped the blade on her apron before she spoke, which was the one thing about her that frightened him, and it did not frighten him less for happening every day."
- ch2 · Nuvalik · lie: **LIE** LIE: Nuvalik tells Vesk everything the fourth hind gave her is written down. It is not: she got contraction twice and did not record it (tell: blade wiped on the apron first). Uncorrected (H08). Quote: "Everything the fourth hind gave me is written down."
- ch2 · Nuvalik · fact: Malphas told Vesk the fourth hind's shoulder gave contraction twice; Vesk has had nothing like it from the others. Quote: "The Lord said contraction."
- ch2 · Ilmar Foss · promise: Foss will ask men in turn for a copy of the manual; it will take a season, and Malphas accepts a season. Quote: "It will be a season."
- ch2 · Ilmar Foss · fact: Foss refuses to wire for the manual: a wire is nine words and the flimsy is kept at both ends for a turn of fourteen days. Quote: "A wire is nine words."
- ch2 · Ilmar Foss · fact: Foss held a numbered instrument for eleven years; when struck they took the instrument before the oath. Quote: "I had a numbered instrument off the same kind of book for eleven years and the day they struck me they wanted the instrument before they wanted the oath back."
...
- ch2 · Ilmar Foss · fact: Foss has the gauge-housing open, its seal broken on a quarterly inspection that stopped coming nine years ago. Quote: "He had the coil out again, in pieces, the jeweller's glass screwed into his eye, and the brass of the gauge-housing open beside him with the slate back off it and the seal broken on a quarterly inspection that had stopped coming nine years ago."
- ch2 · Ilmar Foss · name: Malphas calls Foss by his given name, Ilmar. Quote: ""Ilmar," Malphas said."
- ch2 · Vesk · fact: Vesk's home village laid flat beck stones on graves, one a year for nine years, until the ground was finished. Quote: "Flat ones, out of the beck, one a year for nine years, until the nine were on and the ground was finished."
- ch2 · Vesk · injury: Two grafts on Vesk's hand: the first clean, the second holds but grips badly; its two fingers grow ridged yellow nails he cuts every fourth day and hides from the lamp. Quote: "The second had taken in the way that a thing takes when it has been asked twice, which was well enough for holding and badly for gripping, and the nails on the two fingers that took had come in ridged and yellow and had never stopped growing since."
- ch2 · Vesk · injury: Vesk's hands close only two thirds of the way; he carries anything in both flat palms. Quote: "He looked at his hands on the bench and made them close, and they got two thirds of the way and stopped."
- ch2 · Vesk · injury: Vesk has gone four days without sleep. Quote: "That was the whole of the last four days and he had not slept through any of them."
- ch2 · Vesk · fact: Vesk built the contractile matrix into the third-dilution formulation on one pour (in since the eleventh hour, stood just under an hour). Quote: "Into it, at the dilution, so that the thing that grew and the thing that pulled came off the same pour and arrived in the same tissue at the same time."
- ch2 · Greyshaft Nine · number: The housing gauge reads four degrees in the coldhouse. Quote: "What there was instead was the one thing Vesk could not get past: the Lord had been sitting on an iron bench in a room the housing gauge had at four degrees since the first division, with no gloves on and his coat folded beside him and not under him, and his fingers were the colour of a living man's fingers."
- ch2 · Greyshaft Nine · number: The drip in the coldhouse's far corner runs twenty-two drops a minute; Vesk counted it a year ago and still counts it. Quote: "Twenty-two drops a minute."
- ch2 · Greyshaft Nine · fact: The main under Greyshaft Nine has been capped four years; the standpipe housings on the west wall are dead, there is no meter and no bill; the row was struck off the Board's schedule. Quote: "The main under Greyshaft Nine had been capped four years, and the standpipe housings along the west wall stood there in their brackets with nothing in them, iron gone the colour of an old kettle, capped and unbilled and quietly rusting into the slate."
- ch2 · Greyshaft Nine · time: Chapter 2 runs one night at the Greyshaft Nine coldhouse, the second division to the ninth; it is the twelfth day Vesk has watched Malphas (eleven days, the twelfth begun at the second division). Quote: "The twelfth had started at the second division and he had never asked."

The beat's object (not a cast or place subject, included because the chapter turns on it):
- ch2 · Arbitration Division field manual · fact: The field manual is a numbered issue logged against a name in an issue book and surrendered when an officer is struck off, dies or goes to the Bench. Quote: "It is a numbered issue."
...
Planted or advanced hooks due within 3 chapters (ch6–ch9):
- **H01-far-side-of-the-marker**, due ch7, advanced (not this chapter's; ch7 pays it on the Wystan side)
- **H08-concealed-contraction**, due ch6, planted (**pays this chapter**)

Overdue (due_ch passed, unpaid): none.

Planned hooks this chapter plants: H20-the-field-manual-paragraph, H28-foss-released.

### Audit carry-forward

From `AUDIT_ch05.md` (the latest audit). Critical contradictions, verbatim:
...
Carry-forward list, verbatim (items 1–3 bind this chapter):

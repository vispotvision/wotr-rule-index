# Brief — Chapter 7, "The Lick-Keeper"

Book: night-watch-zombification. POV: Wystan Ashmore. Culture: Accord. Scene type: talky. Proposed Front: the-night-register-file. Day 7. Assembled 2026-09-24 from outline.json, bible.md, state.json and the read-only book tools. Nothing here is written to the table.
...
{
 "number": 7,
 "title": "The Lick-Keeper",
 "beat": "On the estate round Wystan finds the salt licks, one every half mile, the last twenty-two paces short of the marker, and the lick-keeper Josse Garretsohn, who says the estate steward paid for the new tonic blocks. Wystan takes a block bare-handed and receives his forty-third minute: Josse setting it, content, nobody else anywhere in it. The far side of the marker was clean because the round stopped there and the carrier turned home; the carrier is Josse, and Josse is an intermediary. Wystan has the hand, and the hand is the wrong one.",
 "scene_type": "talky",
 "pov": "Wystan Ashmore",
 "cast": [
  "Wystan Ashmore",
 ...
 "place": "the Ferriby estate lick round",
 "front_id": null,
...
- **H01-far-side-of-the-marker** (planted ch1, due ch7, status advanced). Tally found clean ground on the far side of the parish marker, twenty-two paces past the last carcass, and checked it twice; Wystan writes 'ask Tally who set the marker'. Paid when the lick-keeper's round is found to end at the marker: the carrier turned home there. Keywords: marker, far side, lick, turned. Event ch1: Wystan's letter asks Tally who set the parish marker and what the animals on the line drank from; Tally's clean far side, checked twice. Quote: "Tell me who set the parish marker on the Ferriby line, and when, if anybody knows." Event ch5: Tally's letter identifies the marker as the Ferriby estate's old survey stone; Called Late reads a walker on the estate's round turning short of it, more than once; Wystan writes 'the round.' Quote: "It is the Ferriby estate's old survey stone, the corner of their ground, set by the estate before the parish was on the roll." **Pay it here:** the lick circuit is found to end short of the marker, and the carrier (Josse) turned home there; that is why the far side was clean. Placement per audit C4/C5 and carry-forward 4–5 (see Protocol): the last lick sits at the walker's stopping place, inside the birch on the east side of the estate's round, well short of the stone; the outline's "twenty-two paces short" is where the last hind lies. Any block Wystan takes at the Ferriby end was set weeks back.

### Hooks the beat touches without paying

- **H32-hand-never-purse** (planted ch3, due ch76, status planted). His technique gets the hand, never the purse; Article XV prosecutes only the purse. This case inverts it. Paid when he teaches it: the hand or the purse, never both. Keywords: hand, purse, never, both. Event ch3: Wystan tells Brack he will get a hand and not a purse; Brack answers that Fifteen wants the purse. Quote: ""I will get a hand and not a purse."" The beat's close ("Wystan has the hand, and the hand is the wrong one") is this hook turned: the technique returns a hand, and the hand is an intermediary's. Touch, don't pay (ch76).
- **H06-edge-held-cup** (planted ch1, due ch78, status planted). Wystan holds everything by the very edge, two-fingered, even a cup. Paid in VI: Salter sees a man holding a cup that way across the quad, notes it, and nothing follows. Keywords: cup, rim, two fingers, window. Event ch1: Wystan holds his tea by the rim, thumb and two fingers, away from his palm. Quote: "He gave her one and took the other to the window, and he held it there by the rim, the thumb on one side and two fingers on the other, so that none of the heat came near his palm." He takes the block bare-handed; against his edge-holding habit that grip is a choice. Touch, don't pay (ch78).
- **H23-edges-in-the-margin** (planted ch1, due ch16, status advanced). Wystan's margin note: edges. Paid when the walkers erase them and he strikes the word in public. Keywords: edges, margin, struck, bleed. Event ch1: Wystan writes 'edges' in the docket-book margin level with Brack's line. Quote: "In the margin, level with Brack's line, he wrote one word." Event ch3: Lyle reads 'edges' in the margin; the position goes into her minute. Quote: "She read *edges* and the plain sentences underneath it, and then *A dose goes where it is put*, and took up her pen, and copied the line into the minute in a small upright hand, and wrote the date and the division beside it." Event ch5: Wystan reads the walker's turn as a chosen edge; the margin grows to 'the estate. before the roll.' and 'the round.' Quote: "That was the edge." The edges position still stands; the paid H01 explains the clean far side as where a round stops, not a chosen edge, but the edges theory is struck only at ch16. Do not strike it here.
- **H04-tallys-second-dataset** (planted ch1, due ch41, status advanced). Wystan asks Tally to keep walking and measuring: 'I want a second dataset from the same observer.' Paid when the notebook is taken from Tally's walking body, complete to the night he died. Keywords: second dataset, same observer, notebook, Tally. Event ch1: Wystan asks Tally for a notebook kept on his person: a second dataset from the same observer. Quote: "I want a second dataset from the same observer." Event ch5: Tally shows the notebook kept daily since the letter, 'North of the stone. Nothing.', without letting go of it. Quote: "Tally took the notebook off its thong and opened it." Tally is off-page. His notebook may be cited for the round's figures; nothing he knows passes to the cell (audit §4).
- **H05-night-register-a-person** (planted ch1, due ch68, status planted). The bulletin clerk told Tally the Night Register was a person. The cell knows its hunter only as the Night Register. Paid when the Register is folded and Malphas closes the line. Keywords: Night Register, person, folded, somewhere else. Event ch1: The bulletin clerk told Tally the Night Register was a person; one line in a minute could fold the desk. Quote: "A desk could be folded into another desk by one line in a Prime Warden's minute." Wystan presents himself to Josse as the Register with the brass, never by name; ch8's carter carries back only "a man from the Register" (carry-forward 3).
- **H14-brass-token** (planted ch3, due ch72, status planted). The Register token is brass, not silver, because the Night Register is not a full desk, and he has never asked to have it changed. Paid when he hands it in. Keywords: brass, token, silver, handed. Event ch3: Brass token explained against silver; carried four years, never asked to change it. Quote: "The Register's token was brass because the Night Register was not a full desk." The brass is what he shows Josse at the door of the conversation. Touch, don't pay (ch72).
- **H12-kelds-minute** (planted ch3, due ch72, status planted). Keld's minute, taken off a door handle, lucid, waiting for relief; checked every morning against a written record. It slips by a word after Cutler Row; paid when it is set right at Keld's bedside. Keywords: Keld, minute, written record, relief. Event ch3: Keld's minute checked against the written record; it has not moved; relief came late. Quote: "It had not moved." The forty-third minute joins the count Keld's minute heads; do not move Keld's minute (it slips at ch41).
...
**This chapter's tick:** segment 1, "Exhibit one", fourth of its five pushes (ch1, 3, 5, 7, 12; ch12 fills it). The segment names "the round and its intermediary"; ch5 found the round and this chapter finds the intermediary. Mention is not advancement (bible). The world changes here: the lick circuit and its keeper are found, Wystan takes the forty-third minute off a tonic block, and the minute has Josse in it and nobody else. The POV sees the consequence: the carrier route is closed as an answer (the hand he can derive is an intermediary's), and the file now holds Josse's minute (ch12 argues edges "with the lick round drawn on the board and Josse's minute in the file"). The segment is not filled. `front_id` stays null, and nothing is written to `table/fronts.yaml` (that needs `add_front` on Isaac's word).
...
- **No PC in this book.** The standing book rule from bible.md applies in its place: **neither Wystan nor Malphas ever learns of the other.** Wystan knows his quarry only as "the formulator," "the man who never goes near them" (never "the Lord", which he has never heard); no file he can read names the hand. Nothing noticed across that line is ever paid as recognition, and the narration never winks at the reader who knows both (voice note anti-exemplar: "Somewhere out there a man with warm hands was watching..." is exactly what is forbidden). In this chapter that means: **Josse's minute has nobody else anywhere in it** (beat). No face, hand, coat, voice or warm hands behind Josse; the chain behind the blocks ends, for Wystan, at what Josse says (the estate steward paid). The carter chain (ch8) is not named or implied here beyond what Josse himself knows.
- **The name stays home (audit carry-forward 3).** Wystan gives Josse only the brass token and "the Register" (or "the Night Register"), **never "Ashmore"**. Ch8 depends on it: the carter carries back only "a man from the Register" who asked the Ferriby lick-keeper about blocks. Yinzhi, if she names him aloud in Josse's hearing, uses his title only.
- **POV and interiority.** POV is Wystan, close and procedural (bible). R39-7 binds: only Wystan thinks in italics; Yinzhi and Josse get no private italic thought.
- **Length:** 3,500 words (outline target), set-piece band (Table Rule 2: set piece 2,500 minimum with full scene standards). Scene type is talky: the weight is in what Josse says, what he does not know he is saying, and what the block gives Wystan's hand. Body language over talking heads.
- **The working on the page** is The Hand That Held It (card: trigger "bare contact with an object that carried a working"; effect "he receives the operator's final minute as first-person memory, with the mechanism legible inside it"; cost "the minute does not leave"; limit "he gets the hand, never the purse"; counterplay "Fixatio-seal the object, handle it through an intermediary, or wait a season"). This chapter is the intermediary counterplay working exactly as the card says: the last operator on the block is Josse. The card still reads "He carries forty-one of them"; the book's count is forty-two at the source's close (bible), so this is the forty-third; the card lag is recorded, not resolved. He takes a block **bare-handed** (the gloves he forgets; H06 is that he holds everything by the very edge, so a full-palm grip is a deliberate choice and should read as one). The minute is his **forty-third** (Wystan's private count; he had forty-two at the source's close). Its content, per the beat: Josse setting the block, content, nobody else anywhere in it. The minute is kept (it does not leave him); it becomes a Ledger proposal only after approval, by the Judger, never by the writer.
- **One deliberate lie by an NPC** (Table Rule 8; the NPC is Josse or Yinzhi, the only NPCs present) and **one misreading by the POV character** (R6-4, R5-C1), both declared verbatim in the notes. Constraints: the lie must not break ch8 (a carter chain supplies Josse's blocks; ch8's carter hears that "a man from the Register has asked the Ferriby lick-keeper about blocks") and must not carry Wystan's name out. Yinzhi's standing ch1 lie (the bracelet stopped pulling) is already on the books and uncorrected; do not correct it here, and do not re-spend it as this chapter's lie. Wystan's misreading must be well-reasoned and stay wrong. The bible's standing wrong beliefs available: **(2) the formulator "never goes near them"** (a minute with nobody else in it reads to him as proof that the hand behind the blocks never touches anything; never corrected, never pointed at by the narration), and **(5) the edges** (still his position until ch15–16; do not break it here). Ch5's declared misreading (the walker turned short of the stone *as a chosen edge*) is **paid** here: the round simply stopped there and the carrier turned home.
- **H01 placement (audit C4/C5, carry-forward 4 and 5; binding).** The outline row says the last lick is "twenty-two paces short of the marker". Ch5 canon puts the last hind twenty-two paces from the stone (Wystan stood there eight divisions) and the walker's stopping place "just inside the birch on the east side, on the estate's round," "well short" of the stone and out of sight of the cut. **Working reading (the audit's):** put the last lick at the walker's stopping place, inside the birch on the east side, well short of the stone; pay H01 as the lick circuit turning home there while the estate's round itself goes on west along the bound. Called Late put the newest passes "weeks old" on Day 5: Josse has not been to the Ferriby end since, so any "new tonic block" Wystan takes at that end was set weeks back, and Josse's minute shows it being set then. Josse, met elsewhere on the round on Day 7, is still keeping the other licks (ch8 moves them only after this).
- **Physics already known (carry-forward 8).** Wystan knows shut-room residue runs "always" to him (ch5). Never restate ch3's "came down on everybody in the room alike." Out on the round there is no shut room; do not invent a lean toward him here (the sink is ch44's).
- **Numbers:** none invented. Numbers reach the page only in a mouth, an instrument, a document or a private count (R14-4, R12-5). Attested: a lick every half mile (the beat); the last hind twenty-two paces from the stone; eleven hinds and a stag (Tally's count; never "nine", audit C6); Wystan's forty-three minutes (private count). Josse has no card: give him no figure. Yinzhi's card is "Pending Isaac": give her none. Time in divisions only (audit C16), on Day 7.
- **Josse Garretsohn, first seen.** No card in the wiki mirror ("check Notion before writing anything numeric about them"); the bible originates him: lick-keeper of the Ferriby estate, a rural live patronymic (R20-3 / R23-2 Northern stratum). His physical inventory (build, hands, clothes, what he carries, the tonic-block cart or pack) is the writer's origination and must be declared in the notes. His want and his refusal line are the writer's too; he is an honest intermediary who is content, and the minute must agree with whatever the page shows of him.
- **Register:** Wystan-side idiom (voice note): numbers, not adjectives; the division of the hour; the day book's margin; **one object handled per chapter: the tonic block.** The dead are reported flat. There is no main on the estate round: the hum's absence is the condition, and a rural parish off the main is where the book's clock goes quiet. Standing Inventory: two recurrences minimum (bible list). Available here: the hum and its absence; **the bill** (the steward paid for the blocks: a bill, an entry, a chit); the roll and the entry in ink (the day book, the margin: "the round." was ch5's last note); the nine-word wire (to the Timberline bench or the northern office); "Still on the main?" as a question put to a countryman; the salt bar exists but is **H22's plant in ch8** (Foss pays the carter in salt bars): do not plant or pay it here.
- **Identity near-misses (audit §4).** Tally holds the name "Ashmore" (ch5) and stands one step from the round. Tally is not in this chapter's cast; if he is mentioned, he passes nothing on.
- **Ending.** The beat's last clause is the chapter's turn: Wystan has the hand, and the hand is the wrong one. End on a physical action, a line, or a thing he can now see (e.g. the margin entry), never on a question.
...
Nothing pending or proposed, so no escalation.

## Scene brief

`scene_brief "<beat>" --thread "Wystan Ashmore" --type talky --culture Accord --cast "Wystan Ashmore" "Qiu Yinzhi" "Josse Garretsohn"` (the loadout is dropped because it is §3). Josse has no card, so the tool prints no FOW line for him.
...
no card for 'Josse Garretsohn' in the wiki mirror; check Notion before writing anything numeric about them

## Previous chapter

Last 1477 words of `ch06/final.md` ("Separately", Nuvalik POV, Day 5; raw, cut at a paragraph boundary). Ch6 is cell-side and nothing in it is known to Wystan. The last Wystan-side chapter is ch5 (Days 4 to 5, the stone and Called Late); its summary is under Continuity.

"Third: nothing comes from a flask to me, or from the substrate to me, without a second pair of hands between. Vesk makes it up. Nuvalik or Foss carries it. Nuvalik goes into the tissue. I do not touch a live dose and I do not touch the substrate, and if I want a thing lifted, somebody lifts it."

"You have not touched one of them yet," Nuvalik said.

"No."

"You put your hand on the ninth hind's flank on the first night. I watched you do it. She was poured."

"She was poured four divisions before, and I took the hand off her." He said it without any interest in it. "It was a bad habit and this is where it stops. Put all three on the door in a hand a man can read standing at it, Ilmar, and put under them that they are not the reason, and that the reason is in the book."

"The wall," Foss said.

"What about it."

"You have taken three of the four. The season and the wall you have left on the page."

"I have not left them anywhere. They are not house rules, because a man cannot do them on a Tuesday. A season is a thing you wait and a wall is a thing you move, and both are the end of a piece of work and not the running of it." He got up then, and took the coat over his arm, and stood looking at the west wall, where the dead standpipe housings sat in their brackets with nothing in them. "When this work is done, something will be waited and something will be moved. Write them both under the three and put a rule across, so the two do not read as instructions."

"Yes, Lord."

"And while you have the pencil." Malphas turned round. "You came here off a bench with a number on it and a coat you were not allowed to keep, and you have been Foss in this building and nothing else in any paper that leaves it. When the work is done you will be released with your own name. Not a roll-name. Not a made one. Ilmar Foss, on a bench, with hands. I will not ask what you do with it and I will not send anybody to look."

Foss had the pencil in his hand and did not write with it.

"That is not in your gift," he said.

"No. It is in mine to do and not in mine to give. There is a difference and you know it better than I do."

"I do." Foss turned the pencil over once and set it down. "I will want it in the book."

"It is going in the book."

Nuvalik stood with her hands in the eighth hind and the cold coming up through the slate into her wrists, and thought: *released with his own name, and it is the name he had before, and he will pick it up off the bench where he left it.*

Hers had been carried by three people before her. It had come to her whole, with all of them in it, and she had spent what it was worth in this room, on nine hinds and a name for the work and a book with four hands in it. There was nothing to release her to. A name was not a coat. You did not get it back with the buttons still on.

She wiped the blade on her apron.

"The dilution," she said. "If it tempers half a division slower, she is poured at the fifth division and not the fourth, and she stands a division less than the fourth hind did before I go in at her."

"Then the book says a division less," Malphas said, "and does not say they are the same. They will not be the same tomorrow either, and the day after there will be a third thing that is not the same. That is what the book is for. Pour her sealed."

Vesk got the gloves. They were the yard gloves, canvas, stiff with the cold, the only pair in the building, and he stood a long moment with his hands in them and his hands not closing all the way. Then he made the dilution up inside the flask with the seal on, and it took longer than it had ever taken, and nobody said anything about that either.

Nuvalik opened the near flank at four places and stood back. Foss carried the flask from the bench to the table in both hands, because Foss was the second pair, and set it down beside her and took his hands off it. She broke the seal at the table. It came away in a thin rind and Vesk took the rind off her in a dish before it touched the slate, and she put the tundish in and poured at the first place and gave it the count of forty.

The colour went out of the surface and away inland, faster at the two forward pours and slower at the two behind, the way it had in the ninth and in the fourth. Foss called the division. Vesk wrote it. She poured at the second place and watched the channels take it away under the hide toward the emptier end of her, and the room was as quiet as a room with no main under it gets.

Between the pours she looked round once. Malphas was at the door with his coat over his arm, in the part where the lamp did not reach, and nothing in his hands but the coat. Through all four pours no sound came from that corner that she could hear.

"Eighth division," Foss said, when it was done. "And the three on the door before I sleep."

"Before you sleep."

Malphas went out. The door came to on its own weight the way it always did and did not quite shut, and Nuvalik went and shut it, and it was then that she saw that the three of them had not put a hand on one another's work all night, and that this was what he had bought.

She went to the shelf for the book.

She wrote the fourth hind first, both days, the divisions, the cranial border of the scapula, the point going in, the draw, the count of two, the letting go, twice and then once and each smaller. Then the date and the division she was writing in, and under it *held back by me, three days, so that nobody could spend it*. She read it over. It was the first entry in the book in her hand that had her in it at all. She did not like it, and left it standing.

Behind her Foss was cutting the three rules into a board with a knife. He said ink on a door in a coldhouse would be gone inside a turn. The small knocks went on while she wrote the eighth hind up in the ordinary way: four places, the count of forty, poured sealed, two hands.

The ninth hind was still on the table at the far end, under sacking, where she had lain since the first night. Nuvalik had written nothing about her in three days because there had been nothing to write. She went down with the lamp and turned the sacking back off the shoulder and stood and looked at the hide over the joint.

Nothing. The hide over the scapula lay the way hide lies.

She put the sacking back, squared it at the corners, and went out to the yard with her hands under her arms. Above the wall the sky had gone clear and hard, and the stars in it stood small and set in a row down toward the river, like nails in a board.

*A thing that twitches is a thing that will walk.* She had said it in a room with the Lord in it and it had cost her nothing, and by the eighth division tomorrow she had to make it true, with two hands on it and the division called out and Foss's pencil going. Her own hands had done it three times already, alone, with nobody to say so. There was not a man in that building who could ever tell that from her say-so.

Through the wall she could hear Foss's knife on the board, and the press going over on its cam, and under both of them, in the corner where it always was, the drip.

She went back in and took the big knife off the hook to start the ninth hind's hide off her, because a hind that had done nothing in five days was a hind you learned from by opening.
...
state.json holds facts about her, so the FOW line (`fow_line "Qiu Yinzhi"`):
...
Bible line: **Qiu Yinzhi.** Card stub: no numbers. Twenty-three, capped eight months, Measurewright line, artificer's apprentice, Timberline chapter coil-carrier; the regulation bracelet pulls toward a suppressed practitioner; her master died of anamnetic contact. The assay of record. Her full name (generation character, given, courtesy) is on the docket and is never rendered.

### Josse Garretsohn

No card (`character "Josse Garretsohn"`: "no card for 'Josse Garretsohn' in the wiki mirror; check Notion before writing anything numeric about them"). No facts about him in state.json. Bible (Originated in this plan): **Josse Garretsohn**, lick-keeper of the Ferriby estate (a rural live patronymic). Names line: "Names (Concord pool plus byname, R20-3 / R23-2 Northern stratum)". Ledger proposals line: Wystan's minutes "forty-two at the source's close, then Josse ch7". Ch8 (outline): "the carter who meets the carter who supplies Josse"; the carter says "a man from the Register has asked the Ferriby lick-keeper about blocks."

### Voice fingerprints

`voice_fingerprints`: none of this chapter's cast (Wystan Ashmore, Qiu Yinzhi, Josse Garretsohn) appears in the table (30 characters with eight or more attributed lines). Voices come from the cards, the bible and the prior chapters. Rule: if two characters' lines could be swapped and nobody noticed, the scene failed (R15-1-VOICE_DIFFERENTIATION).

## Recall

### scene_recall "salt licks half mile marker lick-keeper tonic blocks steward carrier turned home intermediary"

##### WAR OF THE REALMS  (WOTR_Vaeloris_Sequence.md, score 79)
[The Sounding Walk] "That is the first honest thing anyone from Altherion has said to me in nine years," he said. "Thank you. I will not answer it, because you have earned an answer and the answer is bad." "Sire." "Do you expect me to stand on a wall and watch my men be slain in a channel I sounded myself?" He turned back toward the water...
[The Cabin, II: Two Halves of the Same Wall] "I withdraw it. Not conditionally and not with the clause you gave me about the physicians exhausting everything first, though I accept that clause and will hold to it. I withdraw the pressure of it." He met the other man's eyes and kept his own there. "I have spent my life inside an instrument that reads what a thing ...
...and entered it nowhere.  ---    ---  # The Sounding Walk  The wind came off the harbour carrying tar and cold salt and, beneath both, a thin iron edge that had not been in it at dawn. Verinus stood at the sea wall with his h...
...would be obliged if nobody wrote it down as courage. It is an occupation. It is the same as a man who weighs salt bars on a dock at Coldwater Steps, and it happens that the thing I have been given to weigh is heavier, and i...

##### The Night's Watch  (the_nights_watch.md, score 71)
[FORTY-TWO] A quarter inch, perhaps, out along the crown face, in a fresh pale band that stood clear of the older tissue. Eleven days inside a Fixatio-anchored tin with the chapter's wax across the join. Fixatio holds what it is given. That is the entire reason the Division buys the tins, and it is why an evidence seal is admissib...
[FORTY-TWO] "Residue is Aether that has been coupled," he said. "That is the whole of the science and it is four sentences long. A practitioner draws ambient Aether, couples it into his Crystal, spends it, and what he leaves in the room is coupled Aether carrying the signature of the thing that coupled it. The signature is the cou...
...ed that line." He underscored it twice. "Which means the answer is not in the cut. It is in the water, or the licks, or whatever those animals all put their mouths on, and then it is in the ledger of whoever paid for two myri...
...quiet around him.  The Lattice Classification Bureau had already had it. Edwyn Brack, whose signature was on half the classifications out of the northern office and who had never in Wystan's experience been wrong in a way t...

##### The Revolution Of The Inner World  (the_revolution_of_the_inner_world.md, score 67)
[The Revolution Of The Inner World] Take the tunnels and you hold rock. The value is in the seals, and the seals answer to the Wellsprings, and the Wellsprings do not recognise occupation. A Parun-bound instrument enforces itself. That is the whole of Nalūn and it is the reason a bill drawn at Ironlink Hold is honoured in the Ring smelters and in the wes...
...
##### The Vacancy  (01_the_vacancy_korvaeth_arc.md, score 62)
...
[II. THE BROTHER] The chamber still smelled of salt. It came out of the walls and had never stopped, eleven years after the panelling went up, a dry mineral edge under the tannin and the wax and the old smoke from a chimney that had never drawn properly. Black drown alder, from the groves below the Vessel Coast where Eresse opened the s...
...
##### The True King of the North, Part 1  (the_true_king_of_the_north_part_1.md, score 55)
[The True King of the North, Part 1] Dunstan the Brine worked the galley hatch amidships, passing up bowls of something thick and grey-brown that smelled of salt pork and barley and the faint undercurrent of whatever spice he had found in the stores that was strong enough to make the salt pork forgettable. He was a Concord man of indeterminate age, somewh...
[The True King of the North, Part 1] Hild took the mug. She did not ask what was in it. She drank. The willowbark hit the back of her throat and the rosehip chased it and the honey smoothed what the bark and the hip could not, and the warmth spread down from the palate into the chest in the specific way that warmth spread when it was delivered by a woman ...
...d became architecture, something the body lived inside rather than felt on the surface, and the air tasted of salt and iron and the faint mineral wrongness of high-latitude Aether, the same electric-metal tang that made visi...
...eck timbers were slick with frozen spray. The lanterns at the bow and stern burned low and amber behind their salt-crusted glass, and the light they threw was the colour of old honey, warm enough to look at and useless for w...

##### The_Path_of_Sorrow  (The_Path_of_Sorrow.md, score 50)
...
##### Continuity map  (CONTINUITY.md, score 43)
...sterday (the holding cleared;  | The first attested Valorin conversation on the landward frontier: Kethyrros, salt-crossed and a day and a half past empty, holds the inhale register through eight sentences rather than kill...
...minutes, and the one in his own Crystal - the coordinate Gimbzo, Tsuiji and its brother have shared since the salt flat - the fracture that had been four for six years - "Your house has one of those in it right now" — a man...

### scene_recall "Wystan Ashmore Qiu Yinzhi Josse Garretsohn Ferriby estate lick round"

The House Ashmore / Edric Ashmore hits are the Kharven Banner House; bible Flags: "no link is asserted and Wystan's family is never named on the page."

Trimmed for length (the brief passed ~40k tokens; the trim order drops this recall after wiki snippets). Hit list only:

- The Night's Watch  (the_nights_watch.md, score 95)
- The True King of the North, Part 13  (the_true_king_of_the_north_part_13.md, score 72)
- The True King of the North, Part 5  (the_true_king_of_the_north_part_5.md, score 69)
- The True King of the North, Part 11  (the_true_king_of_the_north_part_11.md, score 66)
- THE KINGDOM OF KHARVEN  (THE_KINGDOM_OF_KHARVEN_corrected.md, score 62)
- THE KINGDOM OF KHARVEN  (THE_KINGDOM_OF_KHARVEN_buri.md, score 62)
- The True King of the North, Part 15  (the_true_king_of_the_north_part_15.md, score 60)
- On Foot  (on_foot.md, score 37)

### wiki

No call made: the beat's only capitalised terms that are not sentence-initial are cast names (Wystan, Josse Garretsohn).

## Continuity

### Facts (cast or place, newest first, at most 40)

- ch5 · the estate's round · fact: Per Tally the round goes south round the whole estate, the estate's ground, not Tally's line. Quote: "It's theirs. It's not my line."
- ch5 · Wystan · fact: Wystan finally eats Tally's bread, holding it by the crust's edge. Quote: "He took it by the edge of the crust, two fingers and a thumb."
- ch5 · Wystan · fact: In the faint Wystan's bare palm touched the stone, his one lapse from holding things by the edge; he finds nothing on it. Quote: "He had not held it by the edge."
- ch5 · Wystan · injury: On turning Wystan faints briefly to one knee, bare palm flat on the stone; both calves cramp when he sits. Yinzhi and Tally witness it. Quote: "It did not go far."
- ch5 · Wystan · misreading: MISREADING: Wystan concludes the walker turned short of the stone so the dead would lie on this side, i.e. the edge is a chosen line. Wrong: it is where an ordinary round stops. Quote: "He had turned short of the stone so that the dead would lie on this side of it."
- ch5 · the walker · fact: Called Late cannot say who the walker is or what he did while standing. Quote: ""He stood," he said. "I cannot give you what he did standing.""
- ch5 · the walker · fact: The walker's passes lie layered with disagreeing clocks; the newest are weeks old and at least some broke ground the dead had already shed on; none went past the stopping place or followed the round west; nothing of him came near the stone. Wystan will not give a number. Quote: "The newest were weeks old."
- ch5 · Wystan · fact: Called Late reads, off the estate's round: somebody came up from the south, stopped well short of the stone, stood a while, went back the way he came, on foot at a walking pace, more than once. Quote: ""Somebody came up from the south," Wystan said."
- ch5 · Wystan · fact: The working's price falls on the body, not the Crystal; a following-week debt is owed. Quote: "The week after would send its own bill."
- ch5 · Wystan · injury: Wystan stood eight divisions (twelfth to sixth) without food calling the scene late: swollen feet, cold shins, tremor, left calf knot, greying vision. Quote: "Eight divisions. He had counted every one."
- ch5 · the burn · fact: Per Tally, the burn runs the foot of the timber down the whole cut and on north under the rise: the same water both sides of the stone; Wystan concludes it is not the burn. Quote: "So it was not the burn."
- ch5 · Yinzhi · fact: Yinzhi ran a fresh coil twice north of the stone and confirms the far side clean, as assay of record. Quote: ""Nothing," she said. "Clean.""
- ch5 · the estate's round · fact: The Ferriby estate's round comes up out of the birch from the south on the east side, meets the stone at its south-east corner and bends west along the estate's bound; north of the stone is parish ground. Quote: "Comes up out of their ground through the birch and goes along their bound, west."
- ch5 · the parish marker · fact: Wystan touched the stone and felt nothing carried on it. Quote: "It had carried nothing that he could feel, and he had not thought it would."
- ch5 · the parish marker · fact: The stone is a hip-high squared block of grey grit leaning west, yellow lichen on its north face, a surveyor's sighting groove on the dressed top; the south face bears TERM, the estate's name cut shallower and later, and an illegible line that may have been a year. Quote: "*TERM*, and the rest of a word the chancery still used, and under it the estate's name cut shallower, by somebody else, later."
- ch5 · the carcasses · fact: The dead show no scavenging: eyes whole, a faint sweetish smell without rot; Wystan did not count them this chapter. Quote: "The eyes were whole."
- ch5 · the last hind · number: The stone stands twenty-two paces north of the last carcass, a hind lying toward the stone. Quote: "He stopped with his toe against the stone."
- ch5 · Wystan · fact: Wystan had not slept since the noon before the ride; he rides badly, Yinzhi rides well. Quote: "He rode badly, with his weight too far back and the reins in the tips of his fingers, and had not slept since the noon before, and he let the hack follow hers."
- ch5 · the parish marker · fact: Per Tally's letter, the marker is the Ferriby estate's old survey stone, the corner of their ground, set by the estate before the parish was on the roll; the parish adopted it as its bound afterwards; nobody knows who cut it or when. Quote: "It is the Ferriby estate's old survey stone, the corner of their ground, set by the estate before the parish was on the roll."
- ch5 · Yinzhi · fact: Yinzhi knocks once and enters Cutler Row without waiting for the first time. Quote: "She had not done that before."
...
- ch1 · Wystan · object: At the end of the night the Ferriby tin sits on the scullery sill beside the chapter-wax fold, with his brass lying on the lid. Quote: "Wystan picked up the tin by its rim, two fingers and a thumb, and carried it back down the passage over the hum to the sill, and set it beside the fold of chapter wax, and laid his brass on the lid."
- ch1 · Wystan · fact: Wystan's memorandum opens Register file Ferriby under the red rule, does not dispute the measurement, and puts 'edges' in the margin by Brack's line; the docket form is folded in at the page. Quote: "In the margin, level with Brack's line, he wrote one word."
- ch1 · Wystan · number: The Ferriby hind is the forty-second minute in the back of his day book. Quote: "At the back of the book, on the pages he kept for them, he entered the forty-second minute beneath the other forty-one."
- ch1 · Wystan · misreading: MISREADING: Wystan concludes the formulator's dose stops where it was put, so every site will show a hard edge. True of Ferriby's first site only; false of every dose after. Quote: "Whatever the formulator had put into those animals had stopped where he stopped putting it, because a man who works at a distance from his own work has to choose the distance, and every site in the four counties would show the same hard margin once somebody walked it with a rule."
- ch1 · Wystan · fact: His Register position, written in the day book under 'edges': a dose goes where it is put. (Held as true by him; see the misreading.) Quote: "A dose goes where it is put."
- ch1 · Ferriby site · fact: Four ravens in the birch would not come down to the carcasses. Quote: "Four ravens in the birch that would not come down."
- ch1 · Ferriby site · number: Eleven hinds and a stag died inside a quarter mile, the last twenty-two paces short of the parish boundary marker; clean ground beyond, checked twice by Tally. Quote: "The last of them twenty-two paces short of the parish boundary marker."
- ch1 · Qiu Yinzhi · fact: Yinzhi knows Wystan counts forty-two minutes, and tells him to eat something at the sixth. Quote: ""Then you counted.""
- ch1 · Qiu Yinzhi · fact: Wystan sends Yinzhi home; she may tell the chapter the tin is under his brass at Cutler Row and they may write. Quote: "Tell them it is under my brass at Cutler Row and they may write."
- ch1 · Qiu Yinzhi · number: Yinzhi was eight months capped and burned two coils. Quote: "If it comes to a hearing, and it will not come soon, somebody will stand up and say the assay was eight months capped and burned two coils and cannot say what she read."
- ch1 · Qiu Yinzhi · lie: **LIE** LIE: Yinzhi tells Wystan her bracelet stopped pulling at the sink. It did not (her thumb is on the badly struck mark as she says it). Uncorrected; Wystan believes it. Quote: "It went quiet when you were at the sink."

Related, not cast or place (Tally is off-page but his line and his lie bear on the round):
- ch5 · Tally · lie: **LIE** LIE: Tally says nothing is set out (troughs, anything filled) on his line or near it. He knows better; not true. Quote: ""Nothing set out on my line, nor near it.""
- ch5 · Tally's notebook · object: Tally's oilcloth notebook, on a thong at his belt, logs every day since the letter with the same walk in the same order, 'North of the stone. Nothing.'; he shows it but does not let go of it. Quote: "He held it for Wystan to read and did not let go of it."
- ch5 · Tally · fact: Tally and Wystan meet in person for the first time; Tally calls Yinzhi 'Qiu' and Wystan shows him the brass token and gives the name Ashmore. Quote: "Wystan took the brass out of his waistcoat and showed it on his palm before he gave the name."
- ch5 · Tally's letter · fact: Tally's letter answers who set the marker but not Wystan's second question (what the animals drank from). Quote: "He had asked two things. Tally had answered one."
- ch5 · Tally · promise: Tally is walking his line every day since Wystan's letter, the same way, writing it at the time, and is at the stone most days at dusk writing up. Quote: "I am walking again, every day since, the same way as before, and writing it at the time like you said."
- ch1 · Tally · fact: The letter asks who set the parish marker on the Ferriby line and when, and what the animals drank or licked from. Quote: "Tell me what the animals on that line put their mouths to: water, licks, troughs, anything that is set out and filled."
- ch1 · Tally · promise: Wystan's letter asks Tally to rewalk the line as before the 11th, measure the same way and log each find at the time in a notebook kept on his person: a second dataset from the same observer. Quote: "I want a second dataset from the same observer."
- ch1 · Tally · fact: Tally's insert was dated the 14th and is held open at the Night Register. Quote: "Your insert of the 14th has been read at the Night Register and is open here."
...
Planted or advanced hooks due within 3 chapters (ch7–ch10):
- **H01-far-side-of-the-marker**, due ch7, advanced (**pays this chapter**)
- **H21-the-ninth-hind**, due ch10, advanced (not this chapter's; cell-side, ch10)

Overdue (due_ch passed, unpaid): none.

Next chapter plants (outline, for awareness only; do not pre-empt): H22-the-salt-bar.

### Audit carry-forward

From `AUDIT_ch05.md` (the latest audit). C4 and C5 bind this chapter; C1 binds via carry-forward 8. Critical contradictions, verbatim:
...
Carry-forward list, verbatim (items 3, 4, 5 and 8 bind this chapter; 1–2 were ch6's):

# Brief — Chapter 8, "Rounding"

Book: night-watch-zombification. POV: Ilmar Foss. Culture: Accord. Scene type: standard. Proposed Front: project-zombification. Days 8 to 9. Assembled 2026-09-24 from outline.json, bible.md, state.json and the read-only book tools. Nothing here is written to the table.
...
```json
{
 "number": 8,
 "title": "Rounding",
 "beat": "Foss rides to the Swale road inn to meet the carter who meets the carter who supplies Josse, and pays him in salt bars because salt bars leave no bill. The carter mentions that a man from the Register has asked the Ferriby lick-keeper about blocks. Foss carries it back; Malphas stops Ferriby for a season and moves the licks to the Swale walks, and Foss spends the ride home rehearsing the explanation he still gives about a rounding convention. The dosing network loses one route and gains a wider one.",
 "scene_type": "standard",
 "pov": "Ilmar Foss",
 "cast": [
  "Ilmar Foss",
  "a carter on the Swale road",
  "Malphas"
 ],
 "place": "the Swale road inn and Greyshaft Nine, the coldhouse",
 "front_id": null,
...
- **H22-the-salt-bar** (planted_ch 8, due_ch 29; status in state.json: planned). "Foss pays the carter in salt bars because salt bars leave no bill; the salt bar is money that can be eaten. Paid when the parish dead walk out of the pit with the bars in their purses." Keywords: `salt bar`, `money`, `eaten`, `pit`. The plant needs the first three on the page in some form (the bar handed over as payment, that it leaves no bill, that it is money a man can eat). The pit is the ch29 payoff: do not foreshadow it, do not put a parish or a pit in this chapter.
...
- **H20-the-field-manual-paragraph** (planted ch6, due ch71). Keywords: `field manual`, `paragraph`, `wall`, `moved`. Malphas's answer to the news ("stops Ferriby for a season") is counter three of the unsigned paragraph, *wait a season*, applied to a route. Ch6 wrote the season and the wall under the three house rules "with a rule across, so the two do not read as instructions" (the end of the work, not a rule). Using the season on one route now is a new use of it, not a contradiction; let Foss notice the difference if the page wants it. **The wall is not moved here** (that is ch66).
- **H28-foss-released** (planted ch6, due ch70). Keywords: `released`, `own name`, `bench`, `Oath`. The ride home is where Foss rehearses the rounding-convention explanation; the promise of release under his own name (ch6, "it goes in the book") is in his head if anything is. Do not pay it.
- **H17-eleven-weeks** (planted ch4, due ch47). Keywords: `eleven weeks`, `Logistics`, `return`, `Swale`. Moving the licks to the Swale walks widens use of the Swale line Deming's column hides. Deming is not in the cast; do not bring him on. The Swale is half off the main (ch4: "Half the Swale's off it").
- **H07-warm-hands** (planted ch2, due ch60). Keywords: `hands`, `warm`, `cold`, `gallery`. If Foss is in the coldhouse with Malphas at four degrees, Malphas's hands keep a living colour. Foss may see it; he explains it to himself in his own craft or not at all. Never recognition, never paid.
- **H05-night-register-a-person** (planted ch1, due ch68). Keywords: `Night Register`, `person`, `folded`, `somewhere else`. The carter's "a man from the Register" is the cell's second contact with the Register as a person. It stays a form: no name, no face.
...
**This chapter's tick:** segment 2, "Release", first of its three pushes (ch8, 13, 17; ch17 fills it). Segment 1 is not yet filled (ch2 and ch6 done, ch10 fills it when the ninth hind stands): the bible lists ch8 under segment 2 while segment 1 is still open. Recorded, not resolved; the tick is written as segment 2's first push, as the bible lists it. Mention is not advancement (bible). The world changes here: the Ferriby route is stopped for a season and the licks go out along the Swale walks, so the dosing network "loses one route and gains a wider one" (beat), and the edges the Register's position rests on (ch3, ch5) start to go, because the salt no longer stops where one man's round turns home. The POV sees the consequence: Foss carries the order, and the ride home is the order being carried out in his head (the new route, the new carters, the salt bars it will take). The segment is not filled. `front_id` stays null, and nothing is written to `table/fronts.yaml` (that needs `add_front` on Isaac's word).
...
- **No PC in this book.** The standing book rule from bible.md applies in its place: **neither Wystan nor Malphas ever learns of the other.** Malphas knows his hunter only as "the Night Register" and at most "a desk on Cutler Row with a brass token"; he designs against the field manual's paragraph as against an institution, never hears or reads Wystan's name. Nothing noticed across that line is ever paid as recognition, and the narration never winks at the reader who knows both (voice note anti-exemplar: "Somewhere out there a man with warm hands was watching..." is exactly what is forbidden; its mirror here would be Foss or Malphas sensing a particular man behind the word "Register").
- **What crosses, exactly (audit carry-forward 3; binding).** The carter chain carries **only** "a man from the Register" who asked the Ferriby lick-keeper about blocks. In ch7 Wystan gave Josse the brass and "Night Register" / "the Register" and nothing else; Josse saw a young woman with a bracelet and a coil case and a man with stained hands. The chain is carter-to-carter hearsay two removes from Josse: it may lose detail, never gain it. **No "Ashmore", no Cutler Row, no description of his person, no Stage, no Called Late, no "Hand".** Malphas's inference must stay at the institution: the Register has reached a lick-keeper, so the route goes quiet for a season. He does not ask what the man looked like, or if he does, the answer is nothing (the carter does not know). Tally holds the name (ch5, audit near miss) and is not in this chapter; nothing reaches the cell from him.
- **The ch7 lie stands on Wystan's side.** Josse told Wystan the blocks come from the steward's barn at the home farm ("Steward keeps them in the barn, I load up there"), marked in state.json as an uncorrected lie; this chapter shows the reader the carter chain behind him. Nothing in ch8 travels back to Wystan, and the narration does not point at the discrepancy. How the chain meets the barn (a carter who drops at the home farm, or delivers to Josse) is the writer's origination; declare it in the notes, and keep the steward's payment on the split tally (ch7) true.
- **POV and interiority.** POV is **Ilmar Foss**, close, in his craft (instruments: the coil, the jeweller's glass, the gauge-housing, readings and tolerances; he explains like a man expecting an appeal). R39-7 binds: only Foss thinks in italics; the carter and Malphas get no private italic thought. **Malphas is seen, never entered** (bible): no thought, no motive stated by the narration, no card figure, no Stage, no Remnant; he is a living man who sits with his forearms on his knees and whose hands never take the cold.
- **Length:** 3,500 words (outline target), set-piece band (Table Rule 2: set piece 2,500 minimum, with full scene standards). Scene type is standard: three movements are in the beat (the inn and the carter; Greyshaft Nine and Malphas's order; the ride home and the rehearsal). Weight them as the page needs; the ride home is where the chapter lands.
- **One deliberate lie by an NPC** (Table Rule 8; the NPC is the carter or Malphas) and **one misreading by the POV character** (R6-4, R5-C1), both declared verbatim in the notes. Constraints: the lie must not carry a name or a description across the line, must not break later chapters (ch13 and ch17 continue Release; H22 pays at ch29 with salt bars in the parish dead's purses), and must not be corrected on the page. Foss's misreading must be well-reasoned and stay wrong. A candidate the facts support (writer's choice, not required): Foss concludes the Register found the lick-keeper **through the road**, the same carters and bundles his nameless print of the field manual came up in (ch6: "It came up the road in a carter's coat with four other books in the bundle"), and so blames his own asking; in fact Wystan came by Tally's marker and Called Late (ch5, ch7). It must not bring him any nearer the man.
- **Numbers:** none invented for any card. Numbers reach the page only in a mouth, an instrument, a document or a private count (R14-4, R12-5). Attested and usable: the coldhouse gauge at four degrees; the drip at twenty-two a minute; the main under Greyshaft Nine capped four years; Foss's numbered instrument held eleven years, struck off eleven years ago for "a rounding convention"; a lick every half mile on the Ferriby round (ch7). The price in salt bars the carter takes is a price in a mouth: the writer's origination, declared in the notes. Foss's card is "Pending Isaac": give him no stat. The carter has no card: give him no stat. Time in divisions only (audit C16), Days 8 to 9.
- **The rounding convention.** Attested only as Foss's own description of why he was struck from the Hexagonal Oath ("a thing he still described, when drunk, as a rounding convention"; card: "explains like a man expecting an appeal"). The beat has him rehearse "the explanation he still gives". What the convention actually was is not in any source. The rehearsal is his version, in his words, and may be self-serving; the narration does not certify it as the truth. Declare in the notes what his version says; it is the writer's origination, overridable by Isaac.
- **The carter, first seen.** No card in the wiki mirror ("check Notion before writing anything numeric about them"). The bible lists him as an unnamed role: "a carter on the Swale road (and the carter behind him)". Keep him unnamed unless the page needs a name; if it does, use the Concord pool plus byname (R20-3 / R23-2 Northern stratum) and declare it. His physical inventory (build, hands, clothes, the cart, what he carries), his want and his refusal line are the writer's origination and must be declared in the notes. The carter behind him (who supplies Josse) is spoken of, not seen.
- **Register:** crew-chapter idiom (voice note): Foss's craft, instruments and tolerances; the dead reported flat. **One object handled:** the salt bar (the voice note's list includes "bar"). Standing Inventory: two recurrences minimum (bible list). Available here: **the salt bar, money that can be eaten** (H22's plant); **the bill** (salt bars leave no bill, the beat's reason); **the hum, and its absence** (the inn on the Swale road: on the main or off it, "Still on the main?"; Greyshaft Nine's main capped four years, no meter and no bill); **the nine-word wire** (Foss will not wire: "A wire is nine words", ch2, and the flimsy is kept at both ends for a turn); the roll and the entry in ink (the project's book, in which Malphas orders everything written by four hands); ale at the fixed price at the inn.
- **Greyshaft Nine, as established:** the ice press and its warm air along the east wall; the gauge bench; the rail; the drip in the far corner; the standpipe housings on the west wall, dead; the gauge over the door at four degrees; Foss's board with the three house rules cut into it on the door (ch6), the season and the wall under a rule across. The three house rules bind the crew in this chapter (Fixatio seal, no live dose bare, a second pair of hands between Malphas and flask or substrate). Malphas does not touch a dose or a substrate on the page.
- **Standing canon to respect:** Nuvalik's and Vesk's concurrent work (the eighth hind poured sealed on Day 5, the reproduction ordered for Day 6; the ninth hind "has done nothing") is off-page unless Foss passes through it; **the ninth hind does not stand** (H21 pays ch10). The rail at Greyshaft Nine holds nine hinds; Ferriby's count is Tally's eleven hinds and a stag; no chapter may say the rail's nine came from Ferriby (audit C14).
- **Ending.** The beat's last sentence is the chapter's turn: the dosing network loses one route and gains a wider one. End on a physical action, a line, or a thing Foss can now see (e.g. the rehearsed sentence, the road, the bars), never on a question.

The Standing Inventory block, from `book_tools.py session_start "Wystan Ashmore" standard Accord`:
#### STANDING INVENTORY
...
`load_rules prose-law pov scene-structure dialogue register --brief` (tags from `loadout standard`), whole output:
...
`scene_brief "<beat>" --thread "Wystan Ashmore" --type standard --culture Accord --cast "Ilmar Foss" "a carter on the Swale road" "Malphas"`, from "Fill before drafting" to the loadout (loadout dropped; it is in §3). Blank 1 is Ilmar Foss (outline); blank 9 is set piece, 3,500 words (Protocol).
...
no card for 'a carter on the Swale road' in the wiki mirror; check Notion before writing anything numeric about them
...
The last 1479 words of `ch07/final.md`, raw, cut at a paragraph boundary:

Wystan stood. He let that be what it was. The dose had gone where it was put. It had been put here, in the birch, in a post a man's father had cut, and it had stopped where the posts stopped. He wrote it under *the round* in the margin, small. *the round's end. the last lick. the birch.*

The trunks round the hollow had hair on them.

He went close to see it and did not touch. On every birch that stood within a few paces of the post there was hair rubbed into the bark, red-brown, winter coat, at about the height of a hind's shoulder. It was on the north side of each trunk and not on the south. On one it had been worked in so hard the bark had gone through to the green. He looked at it for some time. He could not say what a beast did that for, at a lick, facing away from the salt.

He wrote *hair. bark. hind's shoulder. north face of each trunk.* He wrote nothing after it.

"Warden."

Yinzhi had the coil case open on her knee. She had a coil out of its paper and the paper folded back under her thumb, and she ran the coil down the near face of the block without letting it touch. The coil took. It browned from the near end down the whole of its length, and she let it finish.

"It's carrying," she said. She wrote the division on the paper and folded the coil into it and put it in the lid of the case, flat. "Or it was, and it's kept it."

"Enter it."

"It's entered." She looked at his hands. "You've got the gloves."

"I've got them."

He did not take them out. He went down on his right knee in the bare ground in front of the post, where Josse had knelt, where the man in Called Late had stood a while. He did not take the block by the edge.

He put his right hand round it. The palm went flat on the licked face and the fingers closed on the far side, and the flexors in his forearm took up the load as he began to draw it out of the hollow. The salt was tacky. It was hygroscopic and it had been pulling damp out of the birch air for weeks, and the cracks by his nails where the ink lived stung the moment it touched them.

Whatever a working leaves on an object, the last hand to close on the object lies uppermost. It is coupled Aether with the signature of whoever coupled it, a layer of residue over whatever lay under, and his Shell took nothing in of its own and so had room for what was there. The Hand took the uppermost. It had never once taken anything else.

It came.

He was kneeling in the birch with the frame off his back.

The old block came out of the post-top at the third knock, a white stub worn down to nothing, and he picked it out of the hollow with two fingers and dropped it in the sack for the hens at home. The new one was cold from the sack. He stood it on its end in the hollow, and put the heel of his hand on its top, and leaned. It went down into the cut wood and stopped. He took up the beetle and gave it two taps, one on each shoulder of the block, and felt it seat.

His knees were wet through the gaiters and he did not mind it. His back was easy with the frame off. There was dark bread in the front of his jerkin for when he was home, and a thrush up in the birch going over the same few notes, and he was humming with it and a little behind. He looked at the block standing in the post, square and new, grey with the brown gone through, and he was pleased with it. That was all there was in him. It filled him to the edges and there was room left over.

The birch closed north of him. He did not look that way. He had no call to.

He took his hand off the block and reached for the frame by its strap, and his body was already turning, south, for home.

The minute ended where the hand came off.

Wystan was on one knee in the same hollow, with the same block in his fist and a strip of it drawn out of the post, and his own knees wet. He stayed there. He went back through the minute for the edges of it, the way he went back through all of them. A voice behind. A second pair of boots in the mud. A face, a coat, a hand held out with a block in it, a word about where the block had come from or who had paid. There was the thrush, and the wet knees, and the bread. There was nobody else anywhere in it.

He had the hand. It was Josse Garretsohn's.

Garretsohn had carried the salt and set it and gone home content, and had never in his life held anything but a beetle and a block and the half of a tally. The block had come to him made. Before it came to him there had been the barn at the home farm, and a steward who paid, and back behind the steward somebody who had poured the brown into the salt soft and let it set. None of them had been in the minute. None of them would ever be in a minute off this block. The last hand on it was a lick-keeper's. The Hand gave you the last hand.

He had told Brack he would get a hand and not a purse. He had the hand.

It was the wrong one.

A man who put his dose into salt and let other hands carry it out to the beasts was a man who never went near them. Wystan could see the whole shape of him from here. He worked at a bench somewhere a long way from any post, and he sent his work out through a barn and a steward's money and a lick-keeper's frame, and he stayed where he was. He did not go near them. He did not need to.

He drew the block the rest of the way out of the hollow and held it up in the one hand. It was lighter than a new block by what the beasts had taken off it.

"Tin," he said.

Yinzhi had it open already, the widest one in the satchel, the one the chapter used for soil. He set the block down into it on its end. It went in with a finger's width to spare on two sides and none on the others. She put the lid on and pressed it down all round with the heels of both hands until it seated. He took out the brass wax and warmed the stick in his fist, the left fist, and ran the wax round the join, and struck his brass into it while it was soft.

He opened the day book on his knee.

*Register file Ferriby. Tonic block, last lick, the birch, east side of the round. Set by the lick-keeper back before the thaw. Taken bare. Assay of record: carrying.* The division. His initials.

His right palm was still white with salt. The cracks at the nails had gone from stinging to a steady burn. He did not wipe it.

"Eat something," Yinzhi said.

"When we're down."

"Now. You stood all night at the stone on nothing and you're still walking like it." She held out a heel of bread, white, array-ground, out of the satchel with the tins. "Warden."

He took it by the edge of the crust, two fingers and a thumb, with the left hand, and ate it kneeling.

When he had finished he turned to the back of the book, to the pages he kept for them. Keld's stood at the head of the column, where it always stood. Under it were forty-one more, forty-two with Keld's, the newest a hind in the North Ferriby cut. He entered the forty-third beneath them. *Josse Garretsohn, lick-keeper. The last lick in the birch. Setting it.* He looked at that for a while, and then wrote one word after it, and closed the book on the pencil.

The word was *content*.

He got up off the knee. The left calf caught and let go. Then he took the gloves out of his coat and put them on, both of them, and did up the button at each wrist, and picked up the tin by its rim.

## Cast

### Ilmar Foss (POV)

state.json has facts about him (ch2, ch6), so the FOW line, not the full card:
...
state.json has facts about him (ch2, ch4, ch6), so the FOW line. **None of it reaches the page** (bible): the card is the lich form; the prose man is alive, no figure, no Stage named or implied.
...
`fow_line`: "no card for 'a carter on the Swale road' in the wiki mirror; check Notion before writing anything numeric about them"

bible.md: "**Unnamed roles:** a carter on the Swale road (and the carter behind him); ..." (Originated in this plan). Places: "**The Swale line** (the pumping array with four years of flat wastage), **the Swale walks**, the Withering-cut hamlets with dead standpipes, **the Swale road inn**."

state.json facts touching a carter (none has him as subject):

- ch7 · lie · Josse Garretsohn: **LIE** LIE (uncorrected; Wystan believes it): Josse says the blocks come from the steward's barn at the home farm and he loads there. Per the ch8 outline, a carter supplies him. — "Steward keeps them in the barn, I load up there."
- ch6 · fact · the field manual: Foss's print leads to nobody; its provenance runs through a chapter bench and a carter. — "It came up the road in a carter's coat with four other books in the bundle, and the carrier could not have told you what any of them were."
- ch4 · fact · Deming: Deming tells the factor the carters' notes are clean and every cart up the Swale road this quarter went full (true). — "Every cart that went up the Swale road this quarter went up full and was entered full."

### Voice fingerprints

`voice_fingerprints`: of this cast only Malphas has eight or more attributed lines; Foss and the carter do not appear. Rule: if two characters' lines could be swapped and nobody noticed, the scene failed (R15-1-VOICE_DIFFERENTIATION).
...
### scene_recall "carter salt bars Swale road rounding convention licks season"

##### The House of Abscene ( Kujo Arc )  (the_house_of_abscene_kujo_arc.md, score 61)
[The House of Abscene ( Kujo Arc )] The Queen’s mouth moved slightly. “Most men who sit at this table begin by telling me how honored they are.” “Most men who sit at this table wanted to sit here.” “And you did not?” Noricc looked at her for just long enough. “I wanted to become worth inviting.” That was the first hook. Not flattery. Distinction. The Que...
[The House of Abscene ( Kujo Arc )] Noricc had been born beneath stone long before several of the younger guild halls had their current names. He remembered forge bells at shift-change, the taste of sulphur collecting at the back of the throat, the way Dawi children learned to distinguish good stone from stressed stone by sound before anyone bothered tea...
...ntly in the unnatural current moving through the dead air. Around him the remains of homes, wards, halls, and roads lay buried beneath a silence too complete to be natural, a silence that did not feel like the absence of sou...
...as though the world had not yet decided how to interpret them. One seemed too thin and too long, another too broad through the shoulders, another haloed by a dark haze that consumed the line of its own body, but none of them...

##### Commencement of The Curia. [ Kujo Arc ]  (commencement_of_the_curia_kujo_arc.md, score 59)
...in the door that Aurelian entirely recognised.  Seventy-one. Hair the white of a rope's end that has been in salt water, cropped close under the cap. A long narrow face gone to vertical lines, the nose broken once a long ti...
...doorway and did not go near it. One came through the roof of a chapter hold in the Old World, and one into a salt street at Deepvein where the watch had entered a tremor and gone back to bed, and one into a physic garden th...

##### A Silence in the Chord  (00_SUPERSEDED_wrong_names.md, score 57)
[A Silence in the Chord] *The Sunroot steps, Vaelmarr. The New World. The eleventh day of the withheld season.* ---
...
...e since he came up the steps.  ---  ## IV. THE ASHKEWE PARLEY  She took Onawa's head eleven days later at Greysalt.  Sylvenn Thaeren was not there and read the depositions afterward, all sixty of them, twice, and reads them...
...twice, and reads them still.  Onawa Ashkewe, Queen of the Tsohanto, She Who Wears the Old Faces, came to Greysalt under parley on the ninth day of the withheld season with a household of nine and a raven on her shoulder and...

##### The Revolution Of The Inner World  (the_revolution_of_the_inner_world.md, score 57)
[The Revolution Of The Inner World] Sarran Vell came north in the sixth year with eleven of the fourteen factor houses behind him and sealed at Kharven-Seat, and the instrument he sealed preserved the Council of Links, the Trial of Ten Deals, the fourteen houses, Nalūn's internal law, its judicial autonomy over sealed disputes, and its title to every foo...
...
...miles of empty country with the winter coming and eleven thousand mouths and no standing crop, and every well salted by the people who had dug them, and every root cache emptied by the families who had cut them, and the whol...
...tered in a book. Two hundred and ten feet at the narrows, counted in summer under a false name with a cart of salt fish, drawn on the back of a psalter.  The smile across two hundred paces of dead men on the ridge.  And nowh...

##### The Vacancy  (01_the_vacancy_korvaeth_arc.md, score 56)
...
[Notes (author-facing, not canon)] **9,235 words, seven movements. Verified clean.** The conversion check exempted itself under Pack Sixteen §7 — no working is performed anywhere in this arc, so the mechanism mandate is out of scope. I patched the script to recognise that instead of shoehorning magic into a political piece; regression-tested against a c...
...a fraction so that half her face read as considering and the other half did not.  She wore the coat with the salt-black facings. Cut from the same drown alder groves as the panelling in her chamber, boiled and pressed into...
...nybody has ever said to me," he said, and went inside.  ---  ## II. THE BROTHER  The chamber still smelled of salt.  It came out of the walls and had never stopped, eleven years after the panelling went up, a dry mineral edg...

##### THE KINGDOM OF KHARVEN  (THE_KINGDOM_OF_KHARVEN_buri.md, score 54)
...
[**VI. THE BANNER HOUSES**] When the kingdom fell, the Ashmores survived because food is the one currency that never loses its value. They traded grain for protection, protection for political access, political access for favorable positioning in whatever power structure emerged from the collapse, and the positioning ensured that whoever eventual...
...oath's terms are specific: military service at call, tax payment in kind and coin, maintenance of the Crown's roads and signal posts within the house's territory, and submission to the Crown's justice in disputes between hou...
...corridors between Kharven-Seat and the eastern provinces.  **Identity: **Movement. House Hallenfeld controls roads, rivers, and communication.  The Hallenfelds are the kingdom's nervous system. They control the junction whe...

##### THE KINGDOM OF KHARVEN  (THE_KINGDOM_OF_KHARVEN_corrected.md, score 54)
[**VI. THE BANNER HOUSES**] When Stannvaard cuts grain supply but keeps sending inscription substrate, the Thornwalls are the first to notice the pattern, because the Thornwalls have been tracking Stannvaard's trade behavior for generations and they know the difference between a shortage and a message. Their current analysis of the Ore Council's ...
[**VI. THE BANNER HOUSES**] When the kingdom fell, the Ashmores survived because food is the one currency that never loses its value. They traded grain for protection, protection for political access, political access for favorable positioning in whatever power structure emerged from the collapse, and the positioning ensured that whoever eventual...
...oath's terms are specific: military service at call, tax payment in kind and coin, maintenance of the Crown's roads and signal posts within the house's territory, and submission to the Crown's justice in disputes between hou...
...corridors between Kharven-Seat and the eastern provinces.  **Identity: **Movement. House Hallenfeld controls roads, rivers, and communication.  The Hallenfelds are the kingdom's nervous system. They control the junction whe...

##### The_Path_of_Sorrow  (The_Path_of_Sorrow.md, score 39)
...ld not leak out before it reached the person who needed it more than the bowl needed to be intact. A strip of salted pork, fatty enough to stabilize blood sugar without shocking a system that had been running on deprivation....
...y to leave the mouth. She had stopped eating. The bread was half-finished. The broth was two-thirds gone. The salted pork was untouched, held in her left hand, her fingers wrapped around it with the particular grip of someon...

### scene_recall "Ilmar Foss carter Malphas Swale road inn Greyshaft Nine coldhouse"

##### The Night's Watch  (the_nights_watch.md, score 92)
[WHAT DOES NOT SMELL DEAD] Ilmar Foss did not look up from the bench. He had a coil in pieces in front of him and a jeweller's glass screwed into his eye, and he had been struck from the Hexagonal Oath eleven years ago for a thing he still described, when drunk, as a rounding convention. His hands were the steadiest in the building. "He thinks i...
...
...ged to a pond in July.  Malphas did not answer for a while. That was usual and Vesk had stopped minding it.  "Ilmar," Malphas said. "Tell him why it reads clean."  Ilmar Foss did not look up from the bench. He had a coil in p...
...hile. That was usual and Vesk had stopped minding it.  "Ilmar," Malphas said. "Tell him why it reads clean."  Ilmar Foss did not look up from the bench. He had a coil in pieces in front of him and a jeweller's glass screwed i...

##### The War in the North I — The Kharven-Seat  (the_war_in_the_north_i_the_kharven_seat.md, score 45)
[The War in the North I — The Kharven-Seat] Two fingers gone off the left hand at the second knuckle, old, healed clean. She stopped four paces inside the door and bowed the way a woodward bows, which is to say she inclined her head and got it over with. "Rannvei Foss. Woodward of Cold Cross." Flat northern vowels, and the words came out short and hard and stack...
...
##### The True King of the North, Part 20  (the_true_king_of_the_north_part_20.md, score 45)
[Author notes] Isaac's manuscript, archived as delivered. Part 20 of 22: Robin names Ada Foss and the floor moves ("Entered at weight"); Verinus on the silence from the Word of Judger; Aurelian Prudentius held in a clean cell at Altherion, sends word to Dawn Guard down the thread and pays a release of held cost; Dawn Guard and Asante...
[The True King of the North, Part 20] He had not planned any of it and had no idea where the rest was. "Her name is Ada Foss," he said. "I asked. I did not have to ask. I asked because I wanted to be able to say it somewhere that mattered and I did not think this would be the room." The floor moved. It did not move. Robin knew it did not move. Something we...
...ing of the North, Part 20  He had not planned any of it and had no idea where the rest was.  "Her name is Ada Foss," he said. "I asked. I did not have to ask. I asked because I wanted to be able to say it somewhere that matt...
...floor moved.  ---  ## Author notes  Isaac's manuscript, archived as delivered. Part 20 of 22: Robin names Ada Foss and the floor moves ("Entered at weight"); Verinus on the silence from the Word of Judger; Aurelian Prudentiu...

##### Commencement of The Curia. [ Kujo Arc ]  (commencement_of_the_curia_kujo_arc.md, score 44)
[Commencement of The Curia. [ Kujo Arc ]] *Say it in the order. He told you once, in the hall, in front of everyone, say it in the order and do not say anything else, and I have got four things and I have been rehearsing the order for six miles and I have already lost one of them.* "The southern reach is still standing. Bram had the breach at the ninth hour an...
[Commencement of The Curia. [ Kujo Arc ]] Hild was inside. Yoko with her, and Osric with both, and the order had been given in the yard before light and Osric had repeated it back word for word without being asked, which was Osric. Under the main keep, in the cut chamber below the old cistern, which was stone on six sides and had one way in. Hold the walls of ...
...d thermodynamics for three decades. It was arithmetic. It was good arithmetic. He had checked it twice on the road and once in the cell.  "Omnis dolor abluetur."  He could have taken the block apart on the first morning. He...
...metic."  "It was. I have audited it. Four people and a room of books is a good number, and it was good on the road and it was good in this cell and I would have taken it myself at fifty-eight. I am seventy-one. I have more t...
...
##### The Hatch  (the_hatch.md, score 36)
...
##### The Hand of the Empress  (the_hand_of_the_empress.md, score 36)
[The Hand of the Empress] *Part One: the stock enclosure above Harrowbeck, mid-morning.* *Part Two: the Warden's house above Ollavaeth Ridge, the same day.* *POV: Aeldros Korvaeth, then Ilthára Korvaeth. RP reply. Dova'Kan, Gorgi, Xmere and Baraxes are not written; their beats stay open.* ---
[Author notes] Arc: The Elven Crisis, under the Ilthára Korvaeth / The New World thread. Two movements. Part One POV Aeldros Korvaeth at the stock enclosure above Harrowbeck; Part Two POV Ilthára Korvaeth at the Warden's house above Ollavaeth Ridge, the same day. RP post; Dova'Kan, Gorgi, Xmere and Baraxes not written. R39-7 complian...

##### In Form  (in_form.md, score 36)
...
[Author notes] Harrowbeck and the Hales answer the murdered family, and it is the holding Sennuvar Vhaeloth refused to keep the name of in The Blackmatch. Two hundred and six dead, nine of them one household, grandmother to a boy of eleven who ran messages between ridge farms because he was fast. Elegiac beat: the pear stock, grafted...

### wiki "Swale"

##### Xu Deming  (Volume I — Character Cards/Xu Deming.md, score 91)
[III · Work Architecture] Supply and ledgers. Diverted the Verdantia from a legitimate supply contract on the Swale line and drew it down as wastage against a pumping array that had shown four years of flat wastage.
[XVII · Fracture Log] Pending Isaac. --- *Source: The Night's Watch (scenes/the_nights_watch.md). The Swale-line figures (the cost of the third dilution, eleven weeks, thirty-one days) are his estimates as spoken in the scene.*
...III · Work Architecture  Supply and ledgers. Diverted the Verdantia from a legitimate supply contract on the Swale line and drew it down as wastage against a pumping array that had shown four years of flat wastage.  ### IV–V...
...s the liability on the payer and that the payer is him. Gives the Logistics Division eleven weeks to find the Swale line's bad spring, and wants it noted that he said so before it happened. Argues against naming the project b...

##### Kairen Moto · The Iron-Root  (Volume I — Character Cards/Kairen Moto · The Iron-Root.md, score 34)
[The Steel Orchard] ---
[Kairen Moto · The Iron-Root] > *"My father grew the forest. I am the iron fence that keeps the wolves out."* ---

##### Riven Eltamyr Vonnel · The Glaive  (Volume I — Character Cards/Riven Eltamyr Vonnel · The Glaive.md, score 33)
[Riven Eltamyr Vonnel · The Glaive] ---
[I · Identity] ---

##### Haelvorn · Housecat  (Summoned and Bound/Haelvorn · Housecat.md, score 33)
[XI · Counterplay] ---
[V · Bond and Standing] ---

##### Rheon Kaeth · The Emberline  (Volume I — Character Cards/Rheon Kaeth · The Emberline.md, score 33)
[Emberline] ---
[III · Wellspring Harmonizations] ---

##### The Iron Bison — A Discipline of Internal Resonance  (The Disciplines/The Iron Bison — A Discipline of Internal Resonance.md, score 33)
[Synergies] ---
[Counters and Weaknesses] ---


---- full text of Xu Deming ----
...
Supply and ledgers. Diverted the Verdantia from a legitimate supply contract on the Swale line and drew it down as wastage against a pumping array that had shown four years of flat wastage.
...
Hat in his hands and rain on his shoulders. His thumb works round the brim when he is afraid. Careful diction. Remaining inventory pending Isaac.

###### XIV · Psychology

Knows Article Fifteen puts the liability on the payer and that the payer is him. Gives the Logistics Division eleven weeks to find the Swale line's bad spring, and wants it noted that he said so before it happened. Argues against naming the project because a named project is a filed project, citing the Hollow Shaft people. His private thought on the page: he has thirty-one days of usefulness left, and Malphas has already counted them.
...
### Facts (cast or place, newest first, at most 40)

Matched on the cast (Foss, Malphas, the carter), the places (the Swale road and its inn, Greyshaft Nine, the coldhouse), and the beat's objects and people (salt bars, the rounding convention, house rules; Josse's ch7 lie matches on the carter). 40 shown.

- ch7 · lie · Josse Garretsohn: **LIE** LIE (uncorrected; Wystan believes it): Josse says the blocks come from the steward's barn at the home farm and he loads there. Per the ch8 outline, a carter supplies him. — "Steward keeps them in the barn, I load up there."
- ch6 · fact · Malphas: Malphas now knows of all three contractions and that Nuvalik held them back; Vesk and Foss heard it too. — "Why is it not in the book," Malphas said."
- ch6 · fact · the eighth hind: Malphas orders the contraction reproduced: a drawing shoulder by the eighth division tomorrow (Day 6), under two different pairs of hands, recorded in the book by both. — "By the eighth division tomorrow I want a shoulder that draws, and I want two hands on it that are not the same two hands, and I want it in the book in both."
- ch6 · fact · Foss: Foss is to hold the eighth hind's joint while Nuvalik goes in, so he cannot be told he expected the draw. — "He has the steadier hands and he has never had them in one, and if it comes in under his hand as well he cannot be told he expected it."
- ch6 · object · the field manual: Foss has a copy of the Division field manual: a grey limp-covered print taken off an issue, no number, name, chapter or mark of origin. — "This is a print somebody took off an issue, badly, with the heads set by eye."
- ch6 · fact · the field manual: Foss's print leads to nobody; its provenance runs through a chapter bench and a carter. — "It came up the road in a carter's coat with four other books in the bundle, and the carrier could not have told you what any of them were."
- ch6 · fact · Foss: Foss obtained the paragraph a season earlier than he had said. — "I said a season and I was wrong by a season."
- ch6 · fact · Malphas: Malphas had the fourth counter (move a wall) read twice and did nothing visible with it. — "Read the last one again," Malphas said."
- ch6 · fact · Malphas: Malphas spent two years designing against the paragraph from hearsay; three counters right, one backwards: he believed attribution ran up from object to hand, so the crew touched flasks bare. He puts the error in the book. — "I have had you all touching flasks bare because I believed it ran the other way, up, from the object to the hand."
- ch6 · fact · house rules: House rule one: every flask Fixatio-sealed when made up, seal broken only at the table, resealed over what is left; nothing tempers open. — "First: every flask is Fixatio-sealed when it is made up, and the seal is not broken until the flask is at the table, and it goes on again over what is left."
- ch6 · fact · house rules: House rule two: no live dose touched bare; gloves on before the seal comes off; gloves stay in the room. — "Second: no live dose is touched bare."
- ch6 · fact · house rules: House rule three: nothing from a flask or the substrate reaches Malphas without a second pair of hands; Vesk makes up, Nuvalik or Foss carries, Nuvalik cuts; Malphas touches neither dose nor substrate. — "Third: nothing comes from a flask to me, or from the substrate to me, without a second pair of hands between."
- ch6 · fact · house rules: The season and the wall are not house rules but the end of the work; written under the three with a rule across. — "Write them both under the three and put a rule across, so the two do not read as instructions."
- ch6 · object · house rules: Foss cuts the three rules into a board for the door, since ink on a coldhouse door would not last a turn. — "Behind her Foss was cutting the three rules into a board with a knife."
- ch6 · fact · Malphas: Malphas put his hand on the poured ninth hind's flank on the first night; he calls it a bad habit that stops now. — "You put your hand on the ninth hind's flank on the first night."
- ch6 · promise · Foss: Malphas promises Foss release under his own name when the work is done, and not to ask or send anyone after; it goes in the book. — "When the work is done you will be released with your own name."
- ch6 · name · Foss: Foss's given name is Ilmar. — "Ilmar Foss, on a bench, with hands."
- ch6 · number · Foss: Foss held a numbered instrument for eleven years and was struck off for a rounding convention. — "I held a numbered instrument for eleven years."
- ch6 · fact · Malphas: Nuvalik sees Malphas's hands keep a living colour at four degrees while hers go the colour of tallow. — "The gauge over the door had stood at four degrees since the first division and her own fingers had gone the colour of tallow inside the first quarter of it, the way they did every day, and his were the colour of hands."
- ch6 · misreading · Nuvalik: Nuvalik believes Malphas's hands keep colour because he comes from a warm building and sits only a division; she has no control case. — "He came from a warm building, and he sat a division, and he went back to a warm building, and a division was not long enough to take the colour out of a man who was not working in it."
- ch4 · object · Deming: Day 2, fourth division: Deming enters the second tranche of the Swale supply in the Swale book's wastage column, in his own hand, in figures and in words. — "The second tranche went out of the Swale book at the fourth division, in Deming's hand, in the wastage column."
- ch4 · fact · the Swale book: Four years of wastage at the array ran flat quarter by quarter; this quarter the first tranche (small) and the second make a step in the column. — "The column went down the page without a step in it anywhere."
- ch4 · number · Deming: Deming has kept the Swale page himself for three of its four years. — "He had kept this page himself for three of those years."
- ch4 · fact · Malphas: Malphas sent for Deming to the coldhouse after the ninth division (the work already named) and ordered the Project name onto the letter; Deming argued against it with the precedent, and Malphas answered only 'I would prefer the file be built off a word I chose.' — "He had sent for him to the coldhouse after the ninth division, when the work already had its name, and told him there, while Deming stood by the door with his hat in his hands and the rain on his shoulders and argued."
- ch4 · number · Deming: Deming privately counts thirty-one days left of his usefulness to Malphas (counted on the house almanac). — "Thirty-one days of a man who held the contract, and the pen, and the chop, and was useful."
- ch4 · fact · Deming: Deming knows Malphas counted the thirty-one days before he did and let him argue anyway. — "Malphas had counted them already."
- ch4 · fact · the Xu house: The Xu counting house is still on the main; per the factor, half the Swale is off it. — "Half the Swale's off it."
- ch4 · fact · Deming: Deming tells the factor the carters' notes are clean and every cart up the Swale road this quarter went full (true). — "Every cart that went up the Swale road this quarter went up full and was entered full."
- ch4 · promise · Deming: Deming tells the factor that in eleven weeks the capital will see a bad spring on the Swale line, and asks for it noted. — "In eleven weeks somebody in a room in the capital will look at the Swale line and see a bad spring."
- ch4 · misreading · Deming: Deming concludes the factor is a carriage man who lost interest in the Swale page once carriage was lost to him. Not true: do not treat as fact. — "Once the carriage was lost to him, the Swale page was the capital's trouble and no longer his."
- ch4 · object · the Logistics factor: The quarter's returns, with the house's Swale page, go into the front of the factor's satchel in a string bundle. — "The quarter's returns went in at the front, the house's Swale page with them, in a bundle with a string round it that he tied off with his teeth and one hand."
- ch4 · fact · the Logistics factor: If the Division wants Xu, it will wire: 'Xu, Swale, explain.' — "Nine words."
- ch2 · time · Greyshaft Nine: Chapter 2 runs one night at the Greyshaft Nine coldhouse, the second division to the ninth; it is the twelfth day Vesk has watched Malphas (eleven days, the twelfth begun at the second division). — "The twelfth had started at the second division and he had never asked."
- ch2 · fact · Greyshaft Nine: The main under Greyshaft Nine has been capped four years; the standpipe housings on the west wall are dead, there is no meter and no bill; the row was struck off the Board's schedule. — "The main under Greyshaft Nine had been capped four years, and the standpipe housings along the west wall stood there in their brackets with nothing in them, iron gone the colour of an old kettle, capped and unbilled and quietly rusting into the slate."
- ch2 · number · Greyshaft Nine: The drip in the coldhouse's far corner runs twenty-two drops a minute; Vesk counted it a year ago and still counts it. — "Twenty-two drops a minute."
- ch2 · number · Greyshaft Nine: The housing gauge reads four degrees in the coldhouse. — "What there was instead was the one thing Vesk could not get past: the Lord had been sitting on an iron bench in a room the housing gauge had at four degrees since the first division, with no gloves on and his coat folded beside him and not under him, and his fingers were the colour of a living man's fingers."
- ch2 · name · Ilmar Foss: Malphas calls Foss by his given name, Ilmar. — ""Ilmar," Malphas said."
- ch2 · fact · Ilmar Foss: Foss has the gauge-housing open, its seal broken on a quarterly inspection that stopped coming nine years ago. — "He had the coil out again, in pieces, the jeweller's glass screwed into his eye, and the brass of the gauge-housing open beside him with the slate back off it and the seal broken on a quarterly inspection that had stopped coming nine years ago."
- ch2 · fact · Malphas: Malphas wants the Arbitration Division's Warden-of-Duty field manual for its unsigned attribution paragraph; he has designed against it for two years from hearsay. — "The manual has a section on attribution and the section has a paragraph in it that nobody signed, and every officer who works a residue works it off that paragraph, and I have never read the paragraph, and I have been designing against it for two years out of what other people tell me is in it."
- ch2 · fact · Ilmar Foss: Foss held a numbered instrument for eleven years; when struck they took the instrument before the oath. — "I had a numbered instrument off the same kind of book for eleven years and the day they struck me they wanted the instrument before they wanted the oath back."
...
- H21-the-ninth-hind — advanced, due ch10. Keywords: ninth hind, table, stood, standpipe. 'The ninth hind is the freshest and she is the one I want.' Paid when she stands up off the table and leans to the standpipe. Events: ch2: The ninth hind on the table with the matrix pour in her; she does not stand, the hide draws up once.; ch6: The ninth hind has done nothing in five days; Nuvalik takes the big knife to open her.
- H22-the-salt-bar — planned, **plants this chapter**, due ch29. Keywords: salt bar, money, eaten, pit.
- No hook is overdue: H01 (due ch7) paid ch7; H08 (due ch6) paid ch6.

### Audit carry-forward

From `AUDIT_ch05.md` (the latest audit), its CRITICAL items and carry-forward. C3, C4 and C5 were resolved in ch6 and ch7 as the carry-forward directed; they are kept for the record. **For ch8, carry-forward 3 binds** (the carter chain and Foss carry only "a man from the Register").

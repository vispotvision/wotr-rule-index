# Brief — Chapter 9, "Two Myriads"

Book: night-watch-zombification. POV: Wystan Ashmore. Culture: Accord. Scene type: talky. Proposed Front: the-swale-wastage. Day 10. Assembled 2026-09-24 from outline.json, bible.md, state.json and the read-only book tools. Nothing here is written to the table.
...
```json
{
 "number": 9,
 "title": "Two Myriads",
 "beat": "In the Division archive Wystan works the metered-draw tariff by hand and arrives at the price of third-dilution Verdantia against nine hinds and a stag: two myriads and a fraction. He petitions Logistics and Supply for the draw records of the Swale line and three others and is refused on the nine-word wire: returns publish on the schedule and not before. At the Timberline chapter bench Yinzhi reproduces a threshold compound that is inert in the flask and runs in blood. Wystan files a standing request against the Swale line so that the day the return publishes it lands on his desk.",
 "scene_type": "talky",
 "pov": "Wystan Ashmore",
 "cast": [
  "Wystan Ashmore",
  "Qiu Yinzhi",
  "a Logistics clerk on the wire"
 ],
 "place": "the Division archive and the Timberline chapter bench",
 "front_id": null,
 "proposed_front": "the-swale-wastage",
 "plants": [],
 "pays": [],
 "time_elapsed": "Day 10",
 "target_words": 3500
...
**Count correction (binding; audit C6, carry-forward 6).** The row says "nine hinds and a stag". Wystan cannot know that count: nine is the cell's rail at Greyshaft Nine (ch2), and it reached the archive only in Deming's mouth in the source. The count Wystan has is Tally's, **eleven hinds and a stag** (ch1, and Lyle said it back in ch3 while the clerk wrote it down). The bible's flags say "Wystan's ch9 arithmetic uses Tally's count." So he prices the dose against eleven hinds and a stag. His result is still "two myriads and a fraction": the fraction is his, and the narration never sets it beside Deming's figure or remarks the match (bible: "the coincidence is never remarked"). What a myriad is a myriad of is not attested beyond the source's use of the word; do not define it.
...
- **H17-eleven-weeks** (planted ch4, due ch47, advanced ch8). Keywords: `eleven weeks`, `Logistics`, `return`, `Swale`. "'In eleven weeks somebody in a room in the capital will look at the Swale line and see a bad spring.' Paid when the Logistics return publishes." This is the chapter's live hook. The wire's refusal ("returns publish on the schedule and not before") and the standing request against the Swale line set the day the return publishes as the day it reaches the Register. Wystan does not know the eleven weeks: that figure is Deming's private derivation (ch4), and nothing brings it across. He may know the schedule only as Logistics publishes it. Do not pay it: the return does not publish here.
- **H32-hand-never-purse** (planted ch3, due ch76, advanced ch7). Keywords: `hand`, `purse`, `never`, `both`. "I will get a hand and not a purse." The source's line (Yinzhi, FORTY-TWO): "Verdantia at any working dilution is metered draw and metered draw is a supply contract." / "Which is a purse." / "Which is mine." The tariff is the first time the purse has a size. Advance it if the page earns it. Do not pay it, and do not have Wystan name the purse.
- **H02-quarter-inch-sealed** (planted ch1, due ch58). Keywords: `quarter inch`, `Fixatio`, `running`, `sealed`. Yinzhi's compound, "inert in the flask and runs in blood", sits beside the tin that "had gone on running under a seal". Wystan may connect a threshold to the running. Do not pay it: it pays at the hearing.
- **H03-chapter-wax** (planted ch1, due ch58). Keywords: `chapter wax`, `four pieces`, `join`, `custody`. Custody binds the bench work. Yinzhi's reproduction works from her own assay reading and her own synthesis. It does not use the Ferriby tin or the birch block tin (ch7). If either tin is opened, the break is made in the officer's presence and the seal and date go on paper, the way ch1 did it. Recommendation: neither tin is opened.
- **H05-night-register-a-person** (planted ch1, due ch68). Keywords: `Night Register`, `person`, `folded`, `somewhere else`. The petition and the standing request go to Logistics under the Register's form. Sign them the way ch1 signed the letter to Tally ("Night Register, Cutler Row", brass wax), never "Ashmore". This is a trace on the Accord's side: a Register request logged against the Swale line. It carries no name, and it must never be written as reaching the cell.

### Hook agenda check

H21-the-ninth-hind is due at ch10 (Vesk POV, Greyshaft Nine). It is off this chapter's side of the line: say nothing of it. No hook is overdue.
...
1. **Diversion.** The draw as wastage, the letters under the Project name, the salt-relief contract. Ch4, 9, 11.
2. **Used up.** A clerk's query lied closed; the thirty-first day. Ch19, 22.
3. **The hall notices.** Ch33.
...
**This chapter's tick:** segment 1, "Diversion", second of its three pushes (ch4 done, ch9 now, ch11 fills it with the salt-relief contract). Mention is not advancement (bible). Here is how the world changes. The diversion now has a price on the Accord's side, worked from the tariff in the Register's hand, and the Swale line has a standing request against it. From today the published return lands on the Register's desk the day it comes out. Wystan sees the consequence: the refusal comes back on the wire, and the request is entered and filed. Deming is not in this chapter and does not learn of the request here. Ch19 has Stower query the column early, and that must not be traced to this request on the page. The segment is not filled. `front_id` stays null. Nothing is written to `table/fronts.yaml`, which needs `add_front` on Isaac's word.
...
- **No PC in this book.** The standing book rule from bible.md takes the PC's place: **neither Wystan nor Malphas ever learns of the other.** Wystan knows his quarry only as "the formulator" or "the man who never goes near them", and no file he can read names the hand. Nothing noticed across that line is ever paid as recognition, and the narration never winks at a reader who knows both sides. The voice note's anti-exemplar is exactly what is forbidden. Its mirror in this chapter would be Wystan feeling a particular man, or a particular house, behind the price. **Specific to ch9:** the price is a number Deming said aloud in the cell (source). Wystan arrives at it himself, from the tariff, against his own count. The page must not suggest that anyone else has ever said it. Xu, Deming, the Xu house, the factor and "Project Zombification" do not reach Wystan. The draw records are refused, so he learns no contract holder's name. The Swale line is a line on a map and a column he has asked for, nothing more.
- **POV and interiority.** POV is **Wystan Ashmore**, close and procedural (bible): numbers, not adjectives; the division of the hour; the day book's margin. R39-7 binds: only Wystan thinks in italics. Yinzhi and the clerk get no private italic thought. **One object handled** (voice note): the tariff and the ledger he works it in. Suggestion: the archive's tariff book, held by the edge.
- **Length:** 3,500 words (outline target), set-piece band. Table Rule 2 sets a set piece at 2,500 minimum with full scene standards. The scene type is talky, and the beat has four movements: the arithmetic in the archive, the petition and the nine-word refusal, Yinzhi's reproduction at the Timberline bench, and the standing request filed. The talk is Wystan with Yinzhi at the bench and Wystan with the archive (the keeper, if the page wants him). The clerk speaks only in nine words.
- **One deliberate lie by an NPC and one misreading by the POV character** (Table Rule 8; R6-4, R5-C1). Declare both verbatim in the notes. Neither is corrected on the page.
  - **Lie.** The liar is an NPC present in the chapter: the clerk, or the archive keeper (a bible unnamed role). Yinzhi is not this chapter's liar. Her ch1 lie about the bracelet already stands, and a lie from her about the bench work would undercut her as assay of record, which H03 and the hearing depend on. The wire's refusal is the beat's text and is true, so it is not the lie. The lie must not carry anything across the line, and it must not unsay ch19 (Stower queries the Swale column early and Deming lies it closed) or ch47 (the return publishes). One candidate, the writer's choice: the archive keeper says the tariff book on the shelf is the current schedule when it is a season old. The wiki's Value, Coin and Trade page says Logistics' published figures are "historical the moment it is a season old". That leaves Wystan's fraction slightly wrong and never corrected, and it changes no later chapter.
  - **Misreading (Wystan).** The misreading must be well reasoned and stay wrong. A candidate the facts support: from the price, Wystan concludes the dose was **bought**. A man who could pay two myriads for Verdantia is a purse with a bill somewhere, so he looks for a buyer at metered price. In fact the Verdantia was never paid for. It was drawn down as wastage on a legitimate supply contract (source, Deming: "I cannot buy two myriads. I diverted it."; ch4). Asking Logistics for draw records is right for the wrong reason, which is what makes the misreading useful. It must not bring him any nearer the hand. The declared ch7 misreading ("the formulator never goes near them") stands, and the page may lean on it.
- **The Standing Inventory** (two recurrences minimum, bible list). What is on hand here: **the nine-word wire** (the refusal comes back on it, so count it to nine; ch1 has Wystan count a wire out on his fingers); **the meter, its seal and the bill** (metered draw is a bill, and the tariff is the bill's arithmetic); **the roll and the entry in ink** (the standing request entered, the archive's registers); **the hum, and the moment it stops** (the archive is in the Division's northern office on Cutler Row, one house with the Register, audit C17; the main there is off from the eleventh division to the sixth). The Timberline bench's main is the writer's call.
- **The wire, exactly.** The refusal is nine words and says "returns publish on the schedule and not before". Decided: the clerk stays **unnamed** on the page, as the outline row has it ("a Logistics clerk on the wire"), and the ninth word is the desk's, not a name. Example count: *Returns publish on the schedule and not before. Logistics.* That is nine words. Nella Stower is first named in ch19 as "a Logistics clerk". Do not name her here, and do not write anything that makes ch19's early query a response to this petition.
- **The petition.** It asks for "the draw records of the Swale line and three others". Name the other three lines only if the page needs them; they are the writer's origination and must be declared in the notes. Why the Swale is among the four is Wystan's reasoning (lines within reach of Ferriby; the bible puts Greyshaft Nine and the Swale road within riding distance of the city). He has never heard the Swale connected to anyone. Sign it under the Register's form, never his name.
- **The bench work.** "A threshold compound that is inert in the flask and runs in blood" is the bible's mechanism: "the ferment's threshold is crossed in blood and runs in dead tissue". The source seeds it (Yinzhi, FORTY-TWO: "Or the blood. Blood is the obvious one."). Where the blood comes from (a slaughterman's pail, a drawn sample) and the reagent steps are the writer's origination. Declare them, and use no invented figure. Yinzhi reproduces a *compound*, not the contractile matrix. The matrix and walking are the cell's (ch2, ch10), and nothing at the bench walks, leans or contracts. The bracelet pulls toward a suppressed practitioner (card stub): it may pull toward Wystan at the bench, and she may not remark it. Her ch1 lie stands uncorrected: she told Wystan the bracelet had stopped pulling, and it had not (state.json, **[LIE]**). Nothing here corrects it.
- **Numbers.** Invent none for any card. Numbers reach the page only in a mouth, an instrument, a document or a private count (R14-4, R12-5). Attested and usable: two myriads and a fraction (as Wystan's result); eleven hinds and a stag; third dilution; the wire's nine words; the turn of fourteen days; forty-three minutes (ch7). The tariff's own rates are a document's numbers. Keep them off the page, or declare any shown as originated. Yinzhi's card is "Pending Isaac", so give her no stat. The clerk has no card. Wystan's figures reach the page only in his private count. Time in divisions only (audit C16). Day 10.
- **Standing canon to respect.** Wystan already knows that shut-room residue runs "always" to him (ch5, audit carry-forward 8): do not restate ch3's "came down on everybody in the room alike". His wrong belief that the dead are *sent* to him starts at ch25, not here. Lyle's term runs until the quarterly inspection of the gauge-housing (ch3), and the edges position is already in her minute (ch3). Josse's lie (the steward's barn, ch7) stands uncorrected, and nothing here touches it. The Ferriby tin is exhibit one under brass wax, and the birch block is tinned under his brass.
- **Ending.** The beat's last sentence is the chapter's turn: the standing request filed "so that the day the return publishes it lands on his desk". End on a physical action, a line, or a thing Wystan can now see (the entry in ink, the request's slip, the margin), never on a question.

The Standing Inventory block, from `book_tools.py session_start "Wystan Ashmore" talky Accord`:
...
R42-1-TIER_NAMES_ARCHMASTER_PARAGON  [Magic System Rulings 2026-09-23 Tier names]  live
  The nine Tiers of Standing; Tier 8 Archmaster, Tier 9 Paragon.

R42-9-DOMINION_GRAVITY  [Magic System Rulings 2026-09-23 C-027]  live
...
R40-1-MOTO_ELEMENT_INVENTORY  [Naming Banks 2026-09-13 Moto]  live
...
R20C-1-BURI_DEAD_EVERYWHERE  [Pack Twenty R20C-1]  live
...
R20C-2-SATULAGI_STAYS_DEAD  [Pack Twenty R20C-2]  live
...
R20C-38-PACK_EIGHT_SECTION_TWO_ENTIRE  [Pack Twenty R20C-38]  live
  Section Two ratified entire. True name in the practitioner's own language.

R20C-40-NAMING_PASS_SCHEDULED  [Pack Twenty R20C-40]  live
...
R20C-8-HATARAKI_NO_SHO_RECEIVED_NAME  [Pack Twenty R20C-8]  live
...
`scene_brief "<beat>" --thread "Wystan Ashmore" --type talky --culture Accord --cast "Wystan Ashmore" "Qiu Yinzhi" "a Logistics clerk on the wire"`, from "Fill before drafting" up to the loadout. The loadout is dropped here because it is in §3. Blank 1 is Wystan Ashmore (outline). Blank 9 is set piece, 3,500 words (Protocol). Blanks 4 and 6 have candidates in the Protocol. Blank 3, the ignorance quota, is the writer's to fill.
...
no card for 'a Logistics clerk on the wire' in the wiki mirror; check Notion before writing anything numeric about them

## Previous chapter

The last ~1,500 words of `ch08/final.md` (Foss POV, Day 9), raw, cut at a paragraph boundary:

Foss had been ready for the rest of it, and not for that.

"The walks," he said. "The whole... That's not a lane. There's a keeper to every walk and a different carter at every crossing. It's six carters, it's more than six, it's..." He stopped, because Malphas was waiting, and made himself say it in order. "It's more hands. Every hand's a face that's seen a crate."

"Yes."

"It'll want three times the bars."

"Then it wants three times the bars. Salt is the one thing on the Swale nobody has ever asked the price of." Malphas sat back a little, the first time he had moved his shoulders. "One lane with one man at the top of it is a line, Ilmar, and a line can be walked from one end to the other by anybody with the patience to walk it, and the Register, it seems, has the patience. The walks are not a line. Nobody walks the whole of the Swale. I want it written that the licks go out on the walks where the keepers already set salt, one block to a keeper to begin with, and that the Ferriby lane is stopped from the ninth day for a season, and why."

"Why."

"On a carter's word. Written as the carter said it, in your hand. What he said. Nothing he did not say."

Foss went to the gauge bench and turned back the cloth. The book was under it, where it was always put, with the pencil in the spine. He opened it at the ribbon and wrote the date and the division, and then stopped with the pencil up.

The board was on the door behind him. He did not need to turn round to read it. He had cut it. *Wait a season* was under the rule across, where it had been put so that it would not be read as an instruction. It was the end of the work. Now it had come off the board and been laid on one lane, with the rest of the work going on around it. He turned it over twice. It was not a contradiction. The paragraph said to wait a season. It did not say what to wait a season on.

He wrote. *Ferriby lane stopped from the ninth day for one season. Carter's word, Swale road inn, the eighth day, the ninth division: "Man from the Register's been at the Ferriby lick-keeper. Asking about blocks." Nothing further known. Licks to the Swale walks.* He wrote *I. F.* at the foot, and then, because it was his hand and it was in the book, he could not leave it there.

"It'll have been the road," he said.

Malphas did not answer.

"I asked on that road for a season. For the book. I asked a spoon-woman. I asked every carter who'd stand still. The book came off an issue, they'll want their issue, and if they came asking on the road they'd hear everything else the road carries. That's how they got to the lane. That's me. It ought to be in the book."

"You will write what the carter said," Malphas said, "and not what you think of it. What you think of it is not a reading."

"No."

"Put the pencil in the spine."

Foss put the pencil in the spine.

His fingers had gone white at the nails in the time it had taken to write four lines. They always did in this room. He stood with the book shut under his hand and looked at them, and then, because he was a man who looked at things, he looked across at Malphas's hands, still hanging between his knees under the dead standpipes in the lamplight.

They were the colour of hands. The gauge over the door said four degrees. He had had that housing open himself and trusted it to the degree. He looked at the knuckles, where the colour goes first. It had not gone. He had no instrument for it and nothing he could lay against it, and after a while he stopped looking.

"Go home," Malphas said. "Sleep. Next turn you take the carter the walks."

He rode home by the Swale road because it was the long way, and he wanted to see it.

It was light by the third division, grey and flat, and the cob went along at a walk with her head down. On his left the ground fell away to the Swale, and past the river the forest went up in walks, each one a ride cut straight up the slope with a keeper's hut at its foot. He began to count them and stopped at nine. The count was not what mattered. Every ride had a crossing at its foot, and every crossing had a carter who came up to it and a carter who went on from it, and every one of them would want his bars.

He worked it as a tolerance. One lane, one man at the top, five bars and two. Then the walks: a block to a keeper, a carter to every two or three walks, none of them knowing the others. He had no figures for it. He put letters to it in his head and ran it, and it came out large and loose and very hard to walk from one end to the other.

The first hamlet at the Swale head had a standpipe at the corner of its green. Iron, waist-high, capped, the cap rusted to the pipe. A woman went past it to the well with a rope and a bucket and did not look at it. Nobody here had been on the main for years. Nobody here had a bill. They would take salt, though. Everyone took salt.

He found he was rehearsing.

He had not meant to. It came up out of him on the road the way it always came up, in the order it always came in, polished to the point where he could have said it asleep, and mostly had.

*The Oath's tables carry every figure to the third place and enter it at the second. A five in the third place goes to the even figure in the second. That is the Oath's convention. The instrument I was issued was ruled by its maker to carry a five up. I read the instrument I was sworn to. For eleven years every figure I entered was correct to the instrument.*

He stopped there and went back over *every*.

*For eleven years the figures I entered were correct to the instrument. As a rule.*

That was worse. He put *every* back.

He had given it to the examiners and to a clerk of the Oath and to a woman he had once thought he might marry. He had given it to Vesk, drunk. He had never yet given it to anyone who was asking. He tried it now for someone who was: somebody at a table, with a book open and a pencil, and no face, because he had none to give him. Somebody the Register sent. The Register had walked up one lane. It could walk up another.

*The Oath's tables carry every figure to the third place.*

It held. He ran it a third time and it held. The only thing that moved in it was that word, and he left the word where it was.

When the work was done he would be released with his own name. It was in the book. He had watched it written. He found, riding, that he did not know which name that would be: the one on the Oath's roll with a line through it, or the one on the bench at Greyshaft Nine, the one with hands. Either way, somebody at a table would ask him how he had come to be struck, and he would have the answer ready. It was the one thing he had ready.

Past the hamlet the road came down close to the river, and one of the walks came down to it on his own side of the water.

There was a lick at the foot of the ride. An oak post, squared, knee-high, with the top cut to a hollow and a block wedged in it. Two hinds stood at it in the grey light with their heads down. They lifted their heads and looked at him and did not run, and one of them put her head down again and went on licking.

He reined in. The cob stopped and blew.

The block in the post was plain salt, white, licked in on all four faces to a waist. He sat and looked at it until the hind had finished and gone back up the ride. Then he took out the little book he kept for readings and wrote down which walk it was.

## Cast

### Wystan Ashmore (POV)

state.json has 32 facts about him, so this is the `fow_line` (the facts are in Continuity):
...
state.json has 8 facts about her, so this is the `fow_line`. The card is a stub with no numbers, and the facts are in Continuity:
...
bible.md: "**Qiu Yinzhi.** Card stub: no numbers. Twenty-three, capped eight months, Measurewright line, artificer's apprentice, Timberline chapter coil-carrier; the regulation bracelet pulls toward a suppressed practitioner; her master died of anamnetic contact. The assay of record. Her full name (generation character, given, courtesy) is on the docket and is never rendered."

### a Logistics clerk on the wire

`character`: "no card for 'a Logistics clerk on the wire' in the wiki mirror; check Notion before writing anything numeric about them"

No state.json fact has this clerk as subject. bible.md does not list a Logistics clerk among its unnamed roles. The nearest line is its originated name for a later chapter: "**Nella Stower**, Logistics and Supply, the Swale returns desk", first on the page in ch19 ("A Logistics clerk, Nella Stower, queries the Swale column early on the wire"). Decided for ch9 (Protocol): the clerk is unnamed and is heard only as the nine-word wire. The Logistics factor of ch4 is a different man, on Deming's side of the line, and has no place here.

### Voice fingerprints

`voice_fingerprints`: none of this cast (Wystan Ashmore, Qiu Yinzhi, the clerk) has the eight attributed lines the table needs, so no row applies. Rule: if two characters' lines could be swapped and nobody noticed, the scene failed (R15-1-VOICE_DIFFERENTIATION). Wystan and Yinzhi talk at length at the bench, so they must not be swappable. By the source, Wystan is procedural and lets her arrive at things ("he watched her arrive at the second half of it, and he let her arrive"), and Yinzhi is clipped and technical ("Blood is the obvious one.").

## Recall

### scene_recall "metered-draw tariff Verdantia two myriads Logistics draw records Swale line threshold compound blood standing request"

#### The Night's Watch  (the_nights_watch.md, score 90)
...
[FORTY-TWO] "Enormous. Verdantia at any working dilution is metered draw and metered draw is a supply contract." She stopped with the pen down on the paper, and he watched her arrive at the second half of it, and he let her arrive. "Which is a purse." "Which is mine." He took the book back. "That is Article Fifteen, that is the on...
...at. Or pH. Or the blood. Blood is the obvious one."  "Cost."  "Enormous. Verdantia at any working dilution is metered draw and metered draw is a supply contract." She stopped with the pen down on the paper, and he watched her a...
...blood. Blood is the obvious one."  "Cost."  "Enormous. Verdantia at any working dilution is metered draw and metered draw is a supply contract." She stopped with the pen down on the paper, and he watched her arrive at the seco...

#### THE KINGDOM OF KHARVEN  (THE_KINGDOM_OF_KHARVEN_corrected.md, score 74)
...
[**Flagged, not resolved**] **Muken's descent.** The Long Reading gives his birth in Nalūn to a Kōkan mother taken by a lesser noble house, his survival through mercenary work alongside Yukazuri, and Rashani Zettari's reading as the moment his heritage was named. The wiki card is consistent with it, recording him as Moto-aligned through Shingan i...
...e partnered. A Stark rides an Icebear because the Icebear has decided to permit it, and the permission is withdrawn the moment the rider stops being worth carrying, and the withdrawal is not gentle.  House Stark's relationsh...
...ed to permit it, and the permission is withdrawn the moment the rider stops being worth carrying, and the withdrawal is not gentle.  House Stark's relationship to the Crown is the kingdom's oldest alliance and its most hones...

#### THE KINGDOM OF KHARVEN  (THE_KINGDOM_OF_KHARVEN_buri.md, score 74)
[**VI. THE BANNER HOUSES**] When Stannvaard cuts grain supply but keeps sending inscription substrate, the Thornwalls are the first to notice the pattern, because the Thornwalls have been tracking Stannvaard's trade behavior for generations and they know the difference between a shortage and a message. Their current analysis of the Ore Council's ...
[**Flagged, not resolved**] **Muken's descent.** The Long Reading gives his birth in Nalūn to a Altan mother taken by a lesser noble house, his survival through mercenary work alongside Saruul, and Rashani Zettari's reading as the moment his heritage was named. The wiki card is consistent with it, recording him as Büri-aligned through Nüdel ignit...
...e partnered. A Stark rides an Icebear because the Icebear has decided to permit it, and the permission is withdrawn the moment the rider stops being worth carrying, and the withdrawal is not gentle.  House Stark's relationsh...
...ed to permit it, and the permission is withdrawn the moment the rider stops being worth carrying, and the withdrawal is not gentle.  House Stark's relationship to the Crown is the kingdom's oldest alliance and its most hones...

#### The Vacancy  (01_the_vacancy_korvaeth_arc.md, score 71)
[IV. ELEVEN ASKED] *"You made a nine-year-old stand in a yard for three hours in the cold to watch a woman die, and then you named the woman, and the child went home not knowing what she had seen. My house has counted the cost of that and cannot make it come out. Enter us as refusing and enter the reason, all of it, including this senten...
[IV. ELEVEN ASKED] Ilthára Korvaeth asked in form and paid the messengers, and the refusals had to be entered as refusals. That is the whole of what she did, and it was the single most damaging administrative decision of the war, and Aeldros told her so on the night she gave the order and told her so again eleven weeks later when the led...
...g the same breath at slightly different times, which in a cold enclosed space produces a noise like water withdrawing off shingle, and Maren had heard it at four of the six and had never once got used to it.  Onawa turned he...
...ling went up, a dry mineral edge under the tannin and the wax and the old smoke from a chimney that had never drawn properly. Black drown alder, from the groves below the Vessel Coast where Eresse opened the sea gates in the...

#### THE YUKARI BLOODLINE  (THE_YUKARI_BLOODLINE.md, score 71)
[**The Seikai and the Yukari — Fear of the Audit**] A Yukari with an active Ketsumyōgan can see the Claim threads in real time. Can see how much Essence is being taken, where it is going, what the Null-Light refinement process is doing to the stolen energy, and, most disturbingly for the Seikai, what the Claim is costing the executor. The Seikai do not discuss the cost ...
[**MARKS OF MASTERY**] Eye Markings: A line, curve, or sigil placed near the eyes signifies mastery of the ability to see fate. The mark is ceremonial and personal, applied in dark ink or luminous psionic dye. Forehead Markings: A symbol placed upon the forehead declares mastery over Psionics, recognition that the individual has disciplined ...
..., and remembered everything. When they intervened, they intervened quietly, by adjusting a thread rather than drawing a sword, by seeing a crisis forming three steps before it arrived and repositioning themselves so that whe...
...d.  ### **III. The Sight and Its Cost**  Senri's Ketsumyōgan was the first in existence. It manifested not as two specialized types, one per eye, but as raw, undifferentiated thread-perception, the proto-form from which the...

#### Commencement of The Curia. [ Kujo Arc ]  (commencement_of_the_curia_kujo_arc.md, score 59)
...been taught at nineteen never to look at directly, and he looked. The Well's own nature, the thing the Guild metered and the ward drank and nobody had ever seen, drawn up out of the ground in a column with a turn in it, and wh...
...n somebody upstairs still believed this would take an afternoon: a wedge between the back teeth and a pair of drawing pliers, and four molars out of the lower jaw before Sesk arrived and put a stop to it on the grounds that...

#### The House of Abscene ( Kujo Arc )  (the_house_of_abscene_kujo_arc.md, score 59)
...in his mind considerably more valuable.  As the planning continued, Kujo’s enormous black wings began to withdraw. Feather by feather, they folded inward without bending naturally, sinking into his back as though the darkne...
...beneath land that had once belonged to another people. Kujo stood at the head of the table with his wings withdrawn entirely, appearing almost human if one ignored the exquisite wrongness of his stillness. Around him waited...

#### Continuity map  (CONTINUITY.md, score 53)
...ve hundred and ninety-one"), and the one entry he made and did not explain - The Cloister Ward drawing on the metered Well under the Church since the shutdown, and the choir that has not sung since - The Judger's Flame, the Cou...
...evious beat. | DHAERIN DIES. He layers Sacrament, Oblation and Rescind into one covenant event: the world withdraws consent from every soul Cozbi conscripted, leaving him "exactly as strong as the truth of | | Cozbi_Sealed_R...

### scene_recall "Wystan Ashmore Qiu Yinzhi Logistics clerk Division archive Timberline chapter bench"

Trimmed under the trim order (the second recall goes after the wiki snippets). Its only on-thread hit was *The Night's Watch* (the source), which the first recall already covers.

### wiki

Trimmed under the trim order (wiki snippets go first). `wiki "Verdantia"` and `wiki "Logistics and Supply"` returned only off-cast cards and general pages. The one usable line is from Value, Coin and Trade: Logistics publishes the metal price and it is "historical the moment it is a season old". It is quoted in the Protocol (the lie candidate).

## Continuity

### Facts (cast or place, newest first, at most 40; lies marked **[LIE]**)

<!-- 41 matched; showing 40 -->
- ch7 · Wystan · misreading: MISREADING (uncorrected): from a minute with nobody else in it, Wystan concludes the formulator never goes near the beasts. — "A man who put his dose into salt and let other hands carry it out to the beasts was a man who never went near them."
- ch7 · Wystan · injury: Wystan's left calf still carries the knot from the night at the stone. — "The left calf caught and let go."
- ch7 · Wystan · injury: Salt entered the ink-cracks at the nails of Wystan's right palm; stinging went to a steady burn and he did not wipe it. — "The cracks at the nails had gone from stinging to a steady burn."
- ch7 · Wystan · fact: Wystan grips the birch block bare-handed with his right hand, deliberately; Yinzhi witnesses it. — "He did not take the block by the edge."
- ch7 · Wystan · fact: Wystan now knows his ch5 reading (the walker turned short of the stone to keep the dead on this side) was wrong: the walker turned because it was the last post. — "He had turned because this was the last post."
- ch5 · Wystan · fact: Wystan finally eats Tally's bread, holding it by the crust's edge. — "He took it by the edge of the crust, two fingers and a thumb."
- ch5 · Wystan · fact: In the faint Wystan's bare palm touched the stone, his one lapse from holding things by the edge; he finds nothing on it. — "He had not held it by the edge."
- ch5 · Wystan · injury: On turning Wystan faints briefly to one knee, bare palm flat on the stone; both calves cramp when he sits. Yinzhi and Tally witness it. — "It did not go far."
- ch5 · Wystan · misreading: MISREADING: Wystan concludes the walker turned short of the stone so the dead would lie on this side, i.e. the edge is a chosen line. Wrong: it is where an ordinary round stops. — "He had turned short of the stone so that the dead would lie on this side of it."
- ch5 · Wystan · fact: Called Late reads, off the estate's round: somebody came up from the south, stopped well short of the stone, stood a while, went back the way he came, on foot at a walking pace, more than once. — ""Somebody came up from the south," Wystan said."
- ch5 · Wystan · fact: The working's price falls on the body, not the Crystal; a following-week debt is owed. — "The week after would send its own bill."
- ch5 · Wystan · injury: Wystan stood eight divisions (twelfth to sixth) without food calling the scene late: swollen feet, cold shins, tremor, left calf knot, greying vision. — "Eight divisions. He had counted every one."
- ch5 · Yinzhi · fact: Yinzhi ran a fresh coil twice north of the stone and confirms the far side clean, as assay of record. — ""Nothing," she said. "Clean.""
- ch5 · Wystan · fact: Wystan had not slept since the noon before the ride; he rides badly, Yinzhi rides well. — "He rode badly, with his weight too far back and the reins in the tips of his fingers, and had not slept since the noon before, and he let the hack follow hers."
- ch5 · the Timberline bench · fact: Wystan wires the Timberline bench (nine words) that the assay of record is with the Register at Ferriby, returning tomorrow. — "*Assay of record with Register at Ferriby. Returns tomorrow.*"
- ch5 · Yinzhi · fact: Yinzhi knocks once and enters Cutler Row without waiting for the first time. — "She had not done that before."
- ch3 · Wystan · misreading: MISREADING: Wystan believes the residue settling in a shut room falls on everyone alike; in fact it runs to him (H13). — "It was what any shut room did by this hour, with the main running under it and people at work in it all day, and it came down on everybody in the room alike; Lyle had simply never sat a night on the Register, and had nothing on her hands to feel it with."
- ch3 · Wystan · fact: Wystan initialled both position and term; his hand shook on the second initial. — "His hand shook on the second initial and he did not stop to steady it."
- ch3 · Wystan · fact: Six people alive know what Stage Wystan holds; Keld knew first but is not counted among the six. — "Keld was alive."
- ch3 · Wystan · object: He retrieved the brass from the tin lid and put it in his waistcoat. — "He put it in his waistcoat."
- ch3 · Wystan · object: His brass token was left on the tin lid at Cutler Row at the sixth division; he went to the medical house without it. — "His brass was lying on a tin lid on Cutler Row, where he had left it at the sixth division, and he gave his name at the porter's hatch with nothing in his hand."
- ch3 · Wystan · fact: Wystan was the second man through the landing door and took the minute off the handle; the relief came late. — "The first had his arms full, so it was Wystan who put his hand on the handle, and that was how he had the minute."
- ch3 · Wystan · injury: Holding himself suppressed asleep leaves his jaw and shoulders aching each morning. — "He had kept himself down all night, asleep, the way he kept himself down awake, and this was what it came to in the mornings."
- ch3 · Wystan · injury: His hands shake with a fine fast tremor at waking, worse in the right; the Division filed it as a disciplinary observation. — "The Division had entered it in his file under a different heading, in the copying hand, as a disciplinary observation."
- ch3 · Wystan · time: Chapter runs Day 1 from noon to the ninth division. — "He woke at noon with the shutters closed and the house humming under him."
- ch1 · Wystan · object: At the end of the night the Ferriby tin sits on the scullery sill beside the chapter-wax fold, with his brass lying on the lid. — "Wystan picked up the tin by its rim, two fingers and a thumb, and carried it back down the passage over the hum to the sill, and set it beside the fold of chapter wax, and laid his brass on the lid."
- ch1 · Wystan · fact: Wystan's memorandum opens Register file Ferriby under the red rule, does not dispute the measurement, and puts 'edges' in the margin by Brack's line; the docket form is folded in at the page. — "In the margin, level with Brack's line, he wrote one word."
- ch1 · Wystan · number: The Ferriby hind is the forty-second minute in the back of his day book. — "At the back of the book, on the pages he kept for them, he entered the forty-second minute beneath the other forty-one."
- ch1 · Wystan · misreading: MISREADING: Wystan concludes the formulator's dose stops where it was put, so every site will show a hard edge. True of Ferriby's first site only; false of every dose after. — "Whatever the formulator had put into those animals had stopped where he stopped putting it, because a man who works at a distance from his own work has to choose the distance, and every site in the four counties would show the same hard margin once somebody walked it with a rule."
- ch1 · Wystan · fact: His Register position, written in the day book under 'edges': a dose goes where it is put. (Held as true by him; see the misreading.) — "A dose goes where it is put."
- ch1 · Qiu Yinzhi · fact: Yinzhi knows Wystan counts forty-two minutes, and tells him to eat something at the sixth. — ""Then you counted.""
- ch1 · Qiu Yinzhi · fact: Wystan sends Yinzhi home; she may tell the chapter the tin is under his brass at Cutler Row and they may write. — "Tell them it is under my brass at Cutler Row and they may write."
- ch1 · Qiu Yinzhi · number: Yinzhi was eight months capped and burned two coils. — "If it comes to a hearing, and it will not come soon, somebody will stand up and say the assay was eight months capped and burned two coils and cannot say what she read."
- ch1 · Qiu Yinzhi · lie: **[LIE]** Yinzhi tells Wystan her bracelet stopped pulling at the sink. It did not (her thumb is on the badly struck mark as she says it). Uncorrected; Wystan believes it. — "It went quiet when you were at the sink."
- ch1 · Wystan · fact: Appearance: tall and narrow, hair tied at the nape and hanging to the waist, dark red in lamplight, a white line through the left eyebrow. — "The black glass gave him back a tall, narrow man with his hair tied at the nape and hanging to the waist, dark red where the lamp caught it, and a white line through the left eyebrow."
- ch1 · Wystan · fact: A taste of green from the wedge stays at the back of his tongue through three rinses and grounding tea; he does not record it. Unresolved. — "He had nothing to put against that. He did not write it down."
- ch1 · Wystan · fact: He has lived with the smell of brass wax for eleven years. — "Resin came up off it, and under the resin a metal smell he had lived with for eleven years and still could not have named."
- ch1 · Wystan · injury: His hands tremor; the brass strike needed his elbow on the bench and his left hand pressed over his right. — "He set his elbow on the bench and laid his left hand over the back of his right and pressed, and the tremor went down into the bench instead of into the seal."
- ch1 · Qiu Yinzhi · fact: Yinzhi is entered on the Register docket as assay of record, over Wystan's signature as Warden of Duty for the Night Register. — "He wrote *assay of record* under her name, and under that his own, *W. Ashmore, Warden of Duty, for the Night Register*, and the division."
- ch1 · Qiu Yinzhi · name: Yinzhi wrote her full four-part name (surname, generation character, given name, courtesy name) at the docket head in the lineage-hall hand; Wystan checked and blotted it; the name is never rendered on the page. — "Surname, generation character, given name, courtesy name."

### Related facts: the Swale line and Logistics (not cast or place; for the petition and the tariff)

- ch8 · Swale head hamlet · fact: The first hamlet at the Swale head has a capped, rusted standpipe; nobody there has been on the main for years. — "Nobody here had been on the main for years."
- ch8 · Swale walks · fact: The Swale walks are forest rides up the slope past the river, each with a keeper's hut at its foot; Foss counts nine and stops. — "He began to count them and stopped at nine."
- ch4 · the Logistics factor · object: The factor leaves upriver on foot along the river road with the satchel (and the letter), not looking back. — "The factor came out below onto the river road and turned upstream along it, stooping, with the satchel against his hip and one mitt resting on the flap."
- ch4 · the Logistics factor · fact: If the Division wants Xu, it will wire: 'Xu, Swale, explain.' — "Nine words."
...
- ch4 · the Logistics factor · lie: **[LIE]** The factor's lie: covering letters go in the stove at quarter-day. The letter was filed flat between boards; his 'I've still got a...' self-repairs to 'Stove had it.' Do not treat as true. — "Covering letters stop on my desk and go in the stove at quarter-day."
- ch4 · the covering letter · object: The letter goes apart from the returns, into a flat folder between two boards at the back of the factor's satchel. — "It went into the back of the satchel, into a flat folder between two boards, and the boards were pressed shut on it and the strap buckled over."
- ch4 · the Logistics factor · object: The quarter's returns, with the house's Swale page, go into the front of the factor's satchel in a string bundle. — "The quarter's returns went in at the front, the house's Swale page with them, in a bundle with a string round it that he tied off with his teeth and one hand."
- ch4 · the covering letter · object: The factor reads the second line twice and makes a small hooked mark in the margin beside it: neither his query cross nor his initial; Deming has never seen it. Uninterpreted. — "A short downstroke with a hook at the foot of it, turned to the left."
- ch4 · Deming · misreading: MISREADING Deming concludes the factor is a carriage man who lost interest in the Swale page once carriage was lost to him. Not true: do not treat as fact. — "Once the carriage was lost to him, the Swale page was the capital's trouble and no longer his."
...
- ch4 · the Logistics factor · fact: The factor pushes to move the loss into carriage on the house's bond; Deming holds it to wastage and the factor accepts it on his word. — "Wastage. On your word."
...
- ch4 · the Logistics factor · name: The Logistics factor stays unnamed; Deming knows his name and has never used it; the house calls him the factor. — "Deming had known his name for years and had never once used it."
...
- ch4 · the covering letter · object: Deming signs the letter for the house and presses the Xu chop under the signature in red paste. — "He wrote the house's compliments, and signed for the house, and pressed the chop beneath the signature in red paste out of the lacquer box, rocking it once each way so the corners took."
- ch4 · the covering letter · object: The letter names Verdantia: the second tranche drawn down as wastage for loss at the array housings. — "The second tranche of Verdantia under the Swale supply contract drawn down against it as wastage and entered this day in the house's book."
- ch4 · the covering letter · object: The Xu covering letter to the Logistics factor names the account as Project Zombification, second tranche, in Deming's copying hand. — "On the account of Project Zombification, second tranche."
- ch4 · Deming · number: Deming has kept the Swale page himself for three of its four years. — "He had kept this page himself for three of those years."
- ch4 · the Swale book · fact: Four years of wastage at the array ran flat quarter by quarter; this quarter the first tranche (small) and the second make a step in the column. — "The column went down the page without a step in it anywhere."
- ch4 · Deming · object: Day 2, fourth division: Deming enters the second tranche of the Swale supply in the Swale book's wastage column, in his own hand, in figures and in words. — "The second tranche went out of the Swale book at the fourth division, in Deming's hand, in the wastage column."
...
- **H21-the-ninth-hind** (planted ch2, due ch10, advanced ch6). Keywords: `ninth hind`, `table`, `stood`, `standpipe`. It pays in ch10 at Greyshaft Nine (Vesk POV). It is on the cell's side of the line, so it is not in this chapter and must not be foreshadowed from Wystan's side.
- **Overdue:** none. H01 (due 7) was paid in ch7, and H08 (due 6) was paid in ch6.
- Live and touched here (not due): H17 (due 47), H32 (due 76), H02 and H03 (due 58), H05 (due 68). See The beat.

### Audit carry-forward

From `AUDIT_ch05.md` (the latest audit), the items that bind this chapter:
...
- **C6: CRITICAL ⇢ ch9.** The outline carries the cell's count into Wystan's head.
  ...
  - **Carry-forward 6:** "Ch9: Wystan prices the dose against eleven hinds and a stag (ch1 and ch3), never the outline's 'nine hinds and a stag'. Nine is the cell's rail count, and he cannot know it."
- **Identity (CRITICAL if found).** No line has crossed through ch8. The near misses stand: Tally holds "Ashmore" (ch5), and each field-manual copy is numbered against a name. Carry-forward 3 still binds: only "a man from the Register" crosses. In ch9 the Register's petition and standing request are signed under the Register's form and never under his name (Protocol).
- **C1: CRITICAL ⇢ ch44, and carry-forward 8.** "Ch6 onward: Wystan already knows that shut-room residue runs 'always' to him (ch5). Never restate ch3's 'came down on everybody in the room alike'. Keep his wrong belief (ch25–44) as the dead being *sent* to him, and have ch44 pay only that nobody sent them."
- **C7: CRITICAL ⇢ ch12** (not this chapter). Lyle's term and the Register's position are already in her minute (ch3). Nothing in ch9 may enter them again.
- **C11: WARN (H17).** Eleven weeks from Day 2 is Day 79, and the outline puts the return at Day 77. Ch9 gives no date for the publication. The request is standing and waits on the schedule.

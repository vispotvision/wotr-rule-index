# Chapter 11 brief: "Salt" (night-watch-zombification)
...
```json
{
 "number": 11,
 "title": "Salt",
 "beat": "The licks are watched, so Malphas wants the dose in salt bars, and Deming's lineage holds the parish-relief contract that pays the Wicket Lane poor in salt bars, money that can be eaten. Deming works out what salt in a parish means and does it anyway, over a meal he does not eat, with his thumb going round his hat brim. He moves the relief contract's next delivery to a press Foss built. The dose is now in currency.",
 "scene_type": "talky",
 "pov": "Xu Deming",
 "cast": [
  "Xu Deming",
 ...
 "place": "the Xu counting house and the parish-relief warehouse",
 "front_id": null,
...
The outline row plants nothing and pays nothing (`plants: []`, `pays: []`). No hook must be planted or paid here. Hooks the beat touches (by keyword), which it may advance but must not pay:

- **H16-thirty-one-days** (advanced, planted ch4, due ch22; keywords: thirty-one, days, counted, useful). Deming: thirty-one days of usefulness left, and Malphas has already counted them. Paid on the thirty-first day.
- **H17-eleven-weeks** (advanced, planted ch4, due ch47; keywords: eleven weeks, Logistics, return, Swale). 'In eleven weeks somebody in a room in the capital will look at the Swale line and see a bad spring.' Paid when the Logistics return publishes.
- **H18-the-project-name-is-the-file** (advanced, planted ch4, due ch57; keywords: Project Zombification, word, file, chose). 'I would prefer the file be built off a word I chose.' Every letter names Project Zombification. Paid when the Bench titles the file by the word and every thread ends in it.
- **H19-the-hollow-shaft-people** (planted, planted ch4, due ch58; keywords: Hollow Shaft, correspondence, name, precedent). 'That is how they found the Hollow Shaft people. They found a name in a private correspondence.' Paid when the precedent is read into the record at Deming's hearing.
- **H22-the-salt-bar** (planted, planted ch8, due ch29; keywords: salt bar, money, eaten, pit). Foss pays the carter in salt bars because salt bars leave no bill; the salt bar is money that can be eaten. Paid when the parish dead walk out of the pit with the bars in their purses.

**H22 note:** its payoff is ch29, when the parish dead walk out of the pit with the bars in their purses. This chapter puts the dose into the relief bars. It does not show anyone eating one or dying.

### Front tick (proposed, from bible.md; `front_id` is null, and nothing is written to table/fronts.yaml)
...
**This chapter's tick:** segment 1, *Diversion* (ch4, 9, 11). Ch11 **fills** it with the salt-relief contract. Chapters 4 and 9 are done, so this is 2/3 going to 3/3 (AUDIT_ch10 §5). The tick counts only if the world changes on the page and the POV sees the consequence: Deming moves the relief contract's next delivery to Foss's press, and he knows what salt in a parish means.

## Protocol

- **desktop/NATALIE.md applies**, with these chapter adaptations:
  - **No turn-taking.** Table Rule 1's answer-the-PC half is off. Its ending rule stays: end on a physical action, an NPC line, or a thing the POV can now see, never on a question.
  - **There is no PC in this book.** The standing rule from bible.md applies: neither Wystan nor Malphas ever learns of the other. Nothing noticed across that line is paid as recognition, and the narration never winks. Malphas knows the hunter only as "the Night Register" or, at most, "a desk on Cutler Row with a brass token". In this chapter no name, description or face of Wystan reaches Deming, Foss or Malphas.
  - **Length:** 3,500 words (target_words), in the set-piece band (2,500+).
  - **One deliberate lie by an NPC** and **one misreading by the POV (Xu Deming)**, both declared in the notes.
  - Malphas is seen, never entered (bible: POV and narration). R39-7: only Deming thinks in italics. No card figure, Stage or number for Malphas reaches the page. Deming's craft is columns.

### Standing Inventory (session_start "Wystan Ashmore" talky Accord)
...
`book_tools.py load_rules prose-law dialogue register pov naming --brief` (from `loadout talky`)
...
`book_tools.py check_docket prose-law dialogue register pov naming`

```
-- 0 pending/proposed for ['dialogue', 'naming', 'pov', 'prose-law', 'register']
```

Nothing is pending, so nothing changes this chapter. No escalation.
...
*Malphas's FOW figures are the lich form. The bible says none of them reach the page: the prose man is living, and he has no figure.*

## Previous chapter

*Last 1511 words of ch10/final.md, cut at a paragraph boundary.*

She came up against it with her drawn shoulder first. The iron took her weight. The lamp was behind her now, in Foss's hand, and her shadow went up the brick and over the capped top of the housing and across the dead pipe above. She leaned there. The bands in the bare shoulder went on shortening against the iron a little way, and a little way more, and then they did not.

Her legs folded under her. She went down along the housing's side, slowly, the way she had come up, the hindquarters first and then the fore, until she lay on her breastbone on the slate with her chest against the foot of the iron and her neck laid along the brick where the housing met the wall.

She lay still.

Vesk waited for her to draw again. He stood with the flask in his palms and waited through a long count with no drip in it. Nuvalik had come off the stool at last and stood a pace behind the table's end with her hands at her sides. Foss held the lamp.

The hind did not move. The ridge over her scapula had gone down. The muscle lay over the blade the way muscle lies on a dead beast that has been dead a long time.

"She's done," Vesk said. It came out quieter. "Is she... is that her done?"

Nobody answered him, and after a while Nuvalik took the small knife off the table and wiped it, point to heel, on the rag.

"Look at the housing," Foss said.

He had brought the lamp down to it. He crouched with the lamp in one hand and his glass in the other and held the glass to the cap, and the lamp behind it, so that the seam where the cap met the pipe stood out large. The rust ran across the seam unbroken, the colour of an old kettle, with dust along its top.

"That's how it's sat four years," Foss said. "Since the main was capped. Nobody's had that cap off. That's the emptiest iron in the building. It has been the emptiest iron in the building every day any of us has been in it, and I could have told you on the first night which way she'd go if anybody had asked me which way." He did not look round. "Nobody asked me which way. I want that in the book as well."

"Asked you what," Vesk said.

"Which way the slope ran." Foss took the glass off the cap. "Anything that runs on a difference runs to the low side, and the draw does, that's the whole of a main. We put something into every flask we carry, and into our hands and the table and the rail, a little, every day, and nothing has put anything into that pipe for four years. She's the same. She had somewhere lower than where she was, and it was eleven feet off, and she went down to it." He stood up, and his knee cracked. "It's simple. I don't want it written simply. I want it written as measured."

"There's nothing in her to go anywhere," Nuvalik said. "That's what I keep... there is no Crystal in her. There is nobody in her. There's nothing in her that wants the pipe. There's only the net, and the net shortens toward the empty end, and she was the net." She wiped the blade again, though it was clean. "Now she's at the empty end and the net has nothing left to shorten into."

Vesk looked at the hind lying against the iron with her neck along the brick.

At home they put stones on the graves. It was the beck stones, the flat grey ones out of the water, one to a visitor, laid on the turf over the head. He had asked his mother once what they were for and she had said they were to keep the dead where they were put, and he had thought, even small, that that was a thing people said. Nobody in his village had ever got up. He had laid a good many stones and never known what a single one of them was doing.

*Now I know what they're for,* he thought.

He stood with that for a while. There was no stone in the building, and there was nobody to lay one, and the ninth hind was lying where the pipe had put her and not where anybody had.

Behind him Deming came back in.

He came in slowly, with one hand on the door frame, and the Lord moved aside for him again without a word. Deming's face was grey and wet at the mouth. The hat had been crushed, and he was pushing the crown back out with his thumb from the inside, going round, and he did not speak until it was the right shape. He did not look toward the corner.

"I beg the room's pardon," Deming said. "It was the ford." He put the hat's brim right with his thumb, round and round. "It is... I had eel at the inn at the ford on the way up, and I was told not to have it, the girl told me not to, and I had it. It has been coming on since the eighth division." He swallowed. "That was the eel."

Nobody said anything to that either. Foss had gone to the rail for the rule, the long one with the brass ends that hung on the last hook, and he came back with it and put one end on the slate at the table's west edge, and walked the other out along the floor, and set it down, and picked up the first end and walked it over, end over end, to where the hind's near shoulder lay against the iron. He crouched. He read it with the lamp held close.

"Eleven feet," he said. "On the rule, from the table's edge to the point of her near shoulder. Anybody who wants it again can put the rule down again."

Vesk did not say anything.

Foss went to the shelf over the press and took the book down, which Vesk had never seen anybody but Nuvalik do, and Nuvalik watched him do it and said nothing. He opened it on the gauge bench in the warm air. He turned to the last written leaf, where his own hand had put down that Deming had been read the book and heard it, and he wrote under that. Vesk came and stood at his shoulder with the flask. The pen went steadily. Foss wrote the date, and *the twelfth division*, and then a line, and then the distance, and the words *table's edge to near shoulder, measured on the rule*, and then he stopped with the pen off the paper.

"How do you want it said," he said. "That she got up."

"Stood," Nuvalik said, from across the room. "Write that she stood. She stood, and she leaned, and she went down."

Foss wrote *stood*.

The Lord had not come in from the door. He stood where he had stood, with the board over his shoulder and the coat over his arm, and he was looking at the hind against the housing, at the length of her along the iron and the foot of the pipe and the brick. The lamp was on the gauge bench now, by the book, and the door was the dark end of the room. Vesk could see the shape of him there and the coat's fold and not much else.

"Write where she went, and write it as the place and not as anything she meant by going there," Malphas said, "because the sink is the quiet, and she has found the quietest thing in this building without any of us showing it her, and that is the whole of what I wanted proven on a table."

Foss wrote for a while after that. When he had done he turned the book round on the bench so that Vesk could read it without being given it.

It said the date, and the division. It said *the ninth hind* in Foss's square small hand, and under it, on a line of its own, it said *stood*, and then what she had done, in the order she had done it, and the eleven feet on the rule, and at the head of the leaf, where every leaf in the book was headed, it said the name of the work.

Vesk read it twice. Then he looked for somewhere to put the flask, and set it down on the gauge bench beside the book, sealed, and took his hands out from under it, and they stayed open.

*It walks,* he thought.

In the far corner the drip came down off the ceiling onto the slate, and he had it again.

Over by the housing the ninth hind lay against the iron where she had put herself, and stayed down.

## Cast

Each cast member has facts in state.json, stored under the short forms "Deming", "Foss"/"Ilmar Foss" and "Malphas" (AUDIT_ch10 §2), so this section gives FOW lines rather than full cards.
...
- **Malphas (the living man, pre-Becoming).** The card is the lich form (Stage XIV Zenith, Level 475, Class VI Voidic, Dissolution/Mortalis/Solfatara/Nihiloth, the Golden Remnant). **None of it reaches the page.** The prose man is living, not large, fills no room, sits with his forearms on his knees, reads a forester's life like a bill of lading, and his hands never take the cold. No figure exists for him alive; no Stage is named or implied. Expelled from the Pyraeon Forge Academy (card); the book never says so on the page.
- **Ilmar Foss.** Card stub. Instrument-maker struck from the Hexagonal Oath for "a rounding convention"; steadiest hands; explains like a man expecting an appeal. Released ch68; lives under his own name, informs no one (ch70). Roll-name question (R23-11) left open.
- **Xu Deming.** Card stub. The purse. Hat in his hands, thumb round the brim; careful diction; thirty-one days, eleven weeks. Convicted as payer ch60, refuses to name the hand.

### Voice fingerprints

Of the cast, only Malphas appears in `voice_fingerprints` (8 or more attributed lines). Xu Deming and Ilmar Foss have fewer than eight.
...
Malphas is in none of the closest (most swappable) pairs.

## Recall

### scene_recall "salt bars parish relief contract Wicket Lane currency press"

WAR OF THE REALMS  (WOTR_Vaeloris_Sequence.md, score 80)
[The Witness Schedule] The tide had gone out over the chalk during the night and come back in dirty, and the whole of the Rimward shallows lay white to the depth of a man's arm, a flat milky suspension that took the morning light and gave none of it back. Alabaster in the water. The blow three days ago had torn the shoal and the sea had been...
[The Sermon He Was Not Allowed To Give] His mother and father had come out to the Alabaster coast as frontier people, before the seaward parishes had walls worth the name, and had cut peat and set nets and buried two children in ground they had cleared themselves, and had never once in their lives been inside a court of any kind. His father had weighed salt ...
...
#### The Revolution Of The Inner World  (the_revolution_of_the_inner_world.md, score 59)
...
[The Revolution Of The Inner World] Nobody explains any of this. The Guild of Measurewrights wrote the addresses down and maintains the housings and issues the certificates, and the standing instruction to a Measurewright asked why a thing failed is to state the condition and stop. They know where. They have never claimed to know why, and the Hexagonal O...
...
#### The Night's Watch  (the_nights_watch.md, score 55)
...
[THE THING WITH EDGES] It was a good answer. It fitted the residue, it fitted the tissue, and it had the great institutional virtue of costing nobody anything. Wystan turned the insert over and read Tally's last paragraph again, the one the bulletin office had nearly cut for length. *Ravens would not take them. Counted four in the birch acro...
...d clean, no carcasses, no mass, nothing sick. Went back and found the last one. Twenty-two paces short of the parish boundary marker. Clean ground on the far side of it. I checked the far side twice.*  That was the thing. That...
..., thinning at the margins until nobody can say where it stopped. It does not stop twenty-two paces short of a parish boundary marker. It does not check the far side.  A boundary means somebody chose one, and a choice means a h...

#### The Fire of the Undeserving  (01_verinus_fire_of_the_undeserving.md, score 53)
...
...d on.*  *Deepvein station, the Nalūn basin. Extract from the Fixatio watch-log. Same night, fourth hour.* The salt rang. The station floor moved under the bench. Every sealed instrument in the lower vaults took weight at onc...
...in the door that Aurelian entirely recognised.  Seventy-one. Hair the white of a rope's end that has been in salt water, cropped close under the cap. A long narrow face gone to vertical lines, the nose broken once a long ti...

#### A Silence in the Chord  (00_SUPERSEDED_wrong_names.md, score 52)
...
[V. THE FRACTURE] The declarations came in over four weeks, and the New World broke along the seams the language had been marking for four Eons. **Velthaeir declined.** The Floating Archive-City entered a finding in the sealed register and published nothing, and the finding was eleven words long, and Sylvenn Thaeren wrote the second hal...
...
#### The Vacancy  (01_the_vacancy_korvaeth_arc.md, score 51)
...
#### The_Path_of_Sorrow  (The_Path_of_Sorrow.md, score 47)
...
### scene_recall "Xu Deming Malphas Ilmar Foss Xu counting house parish-relief warehouse"
...
#### Commencement of The Curia. [ Kujo Arc ]  (commencement_of_the_curia_kujo_arc.md, score 78)
[Commencement of The Curia. [ Kujo Arc ]] It came up out of the ground under the whole of the narrows at once. The lifted slabs of the road ground against each other and settled. Frost came off the ditch bank in sheets. Every loose stone in four hundred paces began to travel in small hops, and the men who had been standing went to their knees, and the men who ...
...
[The House of Abscene ( Kujo Arc )] “That is important,” Kujo continued. “Do not let it remain long enough to become measurable. Let them recover. Let physicians find nothing. Let Sancta Lux take readings and discover only people who are tired, frightened, overworked, or uncertain.” His gaze sharpened. “Certainty is what gives institutions permission to...
[The House of Abscene ( Kujo Arc )] The Dawi General did. Stannvaard could repair a destroyed bridge. It could ration damaged infrastructure. It could replace tools, reinforce mines, redistribute grain, and mobilize labor. But if repair itself became less efficient each season if metal fatigued too quickly, wards leaked more than they retained, roads deg...
...
#### The_Path_of_Sorrow  (The_Path_of_Sorrow.md, score 57)
...
...ing sound that the rain almost covered but not quite, and the sound followed him down the road like something counting his steps.  The holding pens came into view through the rain at thirty meters.  The structures were built in...
...ly V. His Aether output sat in the 3,000-4,000 AU/s range, and his Flux Density, while nowhere near the Forge-House compression that Temür's Coagulatio produced, was concentrated enough in the sword-arm and the shield-arm to...

#### The Revolution Of The Inner World  (the_revolution_of_the_inner_world.md, score 56)
...
[The Revolution Of The Inner World] That is the part nobody says out loud in the halls. The host was already broken. The starving was already done. What came over the Stormfold crossings in the fifth month was a thing that had stopped being an army and had become eleven thousand desperate creatures moving north because north was where the food had gone, ...
...xists because of what he is.  He runs the War Court's forward planning and he does it on maps and reports and counting, as any other officer does, and he is good at it, and every officer under him believes he is being given the...
...
#### The Count  (sodoku_the_count_supply_report.md, score 54)
...
[The Count] "Quiet is what a thing sounds like when it is not currently pointed at you. I never saw a body. Neither did you. Neither did anyone we can name." He said it without heat. "I will not build a plan on a corpse nobody has produced. If he is dead then the world is a smaller and better place and I have lost nothing by havin...
...pen and the children sleeping in the same house for three days because there is nowhere else to put them. Ada Foss kept her husband three days in a room ten feet by twelve with four children in it, and she did it correctly,...
...ised when it snows."  Beyond the yard, three streets up, past the broken fountain and the black stumps of the counting-house, a lamp burned in an upper window of a house that had no business having lamp oil.  Sodoku found it wit...

#### What the Ground Was Owed  (10_wotr_what_the_ground_was_owed.md, score 53)
[What the Ground Was Owed] That is the part nobody says out loud in the halls. The host was already broken. The starving was already done. What came over the Stormfold crossings in the fifth month was a thing that had stopped being an army and had become eleven thousand desperate creatures moving north because north was where the food had gone, ...
...
#### The Holy Inquisition, Part 1B: The Empty Chair  (the_holy_inquisition_part_1b_the_empty_chair.md, score 53)
[Author notes] **Status:** Originated, pending ruling. Part 1B of The Holy Inquisition Arc. **POV:** Edward Lambert, close register. Narration fuses with Edward's idiom: the counting, the arithmetic, the second-sentence reading. **Isaac's Dialogue:** Fixed text per R19-2. Typos corrected per R19-2-PERMITTED_CORRECTIONS. **NPCs Origin...
[The Holy Inquisition, Part 1B: The Empty Chair] Oswin said nothing. Oswin was listening to the second sentence. Oswin was a Lambert. Beside him, the men and women of the border houses filled four more chairs. Lord Renwyck of House Vellane, whose estates ran along the southern approach and whose southern approach was the road that anything marching on Alabaster from ...
...ble was a question that everyone in the room had to answer for themselves, and the answering told him who was counting.  The chamber was long and low-ceilinged, built for a purpose older than the council that now occupied it. St...
...he thing Edward noticed, because a six-year-old who watched hands instead of faces was a six-year-old who was counting without knowing he was counting, and the not-knowing was the stage before the knowing, and the knowing was th...

### wiki "Wicket Lane"

Wicket Lane is originated in the bible (Originated: Places) and has no wiki page. The top wiki hits (Hataraki, Omnara and the Division, The Three Epochs, The Veil) are unrelated, so they are left out. The beat has no other capitalised term that is not a cast name.

## Continuity

### Facts: cast and place (newest first, 40 of 56; subjects Deming, Malphas, Foss/Ilmar Foss, the Xu house, salt bars)

- ch10 · Malphas · fact: Malphas: the sink is the quiet; she found the quietest thing in the building unshown, and that is what he wanted proven on a table. Quote: "Write where she went, and write it as the place and not as anything she meant by going there," Malphas said, "because the sink is the quiet, and she has found the quietest thing in this building without any of us showing it her, and that is the whole of what I wanted proven on a table."
- ch10 · Deming · lie **[LIE]**: LIE (uncorrected): Deming tells the room he was sick from eel at the ford inn, coming on since the eighth division; the cause was the hind. Quote: "That was the eel."
- ch10 · Foss · fact: Foss says he could have predicted her direction on the first night, nobody asked him, and he wants that in the book. Quote: "Nobody asked me which way."
- ch10 · Foss · phenomenon: Foss: anything that runs on a difference runs to the low side; the capped pipe is the emptiest iron in the building and she went down to it. Quote: "Anything that runs on a difference runs to the low side, and the draw does, that's the whole of a main."
- ch10 · Deming · fact: Deming saw the hind come off the table and went out into the yard and was sick against the wall, twice. Quote: "The Lord moved half a pace aside for him, and Deming went past him and out into the yard, and they heard him in the yard at once, being sick against the wall, and then being sick again."
- ch10 · Malphas · fact: As the hind leaned toward his corner Malphas rose, took his coat over his arm, and stood at the door with his back to the board of three rules. Quote: "He did it without any hurry."
- ch10 · Malphas · fact: Vesk saw Malphas's hands keep their colour on the cold west bench while his own ached; he made nothing of it. Quote: "They were the colour of hands."
- ch10 · Deming · knowledge: Nuvalik read Deming the book (the pour, the fourth hind's entries, her concealment) as far as the fifth day, then Malphas stopped her. Quote: "She got as far as the fifth day."
- ch10 · Deming · fact: Deming arrived at the coldhouse at the ninth division of day 12, off the Swale road. Quote: "Deming had come in at the ninth division off the Swale road with river mud to his ankles and his hat already in his hands."
- ch8 · Foss · object: Foss keeps a little book for readings and writes in it which Swale walk has a white salt lick with hinds at it. Quote: "Then he took out the little book he kept for readings and wrote down which walk it was."
- ch8 · Foss · promise: Foss is to be released with his own name when the work is done; he does not know which name that will be. Quote: "When the work was done he would be released with his own name."
- ch8 · Foss · fact: Foss has given his rounding account to the examiners, a clerk of the Oath, a woman he once thought he might marry, and Vesk, drunk; never yet to anyone asking. Quote: "He had given it to Vesk, drunk."
- ch8 · Foss · fact: Foss's rounding-convention account (his rehearsal, not certified): the Oath enters at the second place with fives to even; his issued instrument carried fives up; 'every figure I entered was correct to the instrument' for eleven years. Quote: "For eleven years every figure I entered was correct to the instrument."
- ch8 · Foss · fact: Foss counts the Greyshaft drip at twenty-two. Quote: "The drip. Foss counted it without meaning to, and made it twenty-two, and stopped."
- ch8 · Malphas · fact: Malphas's hands keep their colour at four degrees while Foss's go white at the nails; Foss has no instrument for it and stops looking. Quote: "They were the colour of hands."
- ch8 · Malphas · fact: Malphas orders Foss next turn to take the carter the walks. Quote: "Next turn you take the carter the walks."
- ch8 · Malphas · fact: Malphas declines Foss's self-blame about the road; it is not written in the book. Quote: "What you think of it is not a reading."
- ch8 · Malphas · fact: Malphas asserts the lick-keeper 'is exactly what he says he is'. This is his belief only and is wrong: Josse lied about the barn (ch7). Do not treat as true. Quote: "They will have the lane, and at the end of the lane a man who sets salt for his living and was paid to set it, and he is exactly what he says he is."
- ch8 · Malphas · fact: Malphas moves the licks to the Swale walks, one block to a keeper to begin with, where keepers already set salt. Quote: ""The licks go to the Swale walks.""
- ch8 · Foss · misreading: MISREADING (uncorrected): Foss concludes the Register reached Ferriby up the road, carter by carter, because of his own asking after the manual. Actually it came via Tally's survey stone, Called Late and the estate's round. Quote: "The Register had come to Ferriby the way he had come to the book, carter by carter, asking, until it found a man who carried something up a lane."
- ch8 · Foss · fact: Foss spent a season asking on the Swale road (carters, chapmen, a horn-spoon woman at the crossing) for the Division's field manual. Quote: "He had asked carters and chapmen and a woman who sold horn spoons at the crossing below the inn, a little at a time and never twice to the same face, whether anybody had a grey limp-covered thing with the Division's heads in it, because a man he did work for wanted to read a paragraph."
- ch8 · Foss · fact: Foss refuses to wire: a wire is nine words and the flimsy is kept at both ends for a turn. A wire office stands at the crossing below the inn. Quote: "There's a wire office at the crossing."
- ch8 · salt bars · number: Foss pays the two extra bars from his saddlebag: seven bars in all on Day 8. Quote: "The carter tucked them into the smock with the others without looking."
- ch8 · salt bars · object: The salt bars are coast-pan salt, unmarked, a hand long and a thumb thick, snapped off the sheet; they leave no bill at either end. Quote: "Pan salt would not hold a stamp through a wet season, and nobody paid the extra to try."
- ch8 · salt bars · number: Foss pays the carter five salt bars for the last load to the ford and the one before. Quote: ""The last load to the ford, and the one before.""
- ch6 · Malphas · fact: Nuvalik sees Malphas's hands keep a living colour at four degrees while hers go the colour of tallow. Quote: "The gauge over the door had stood at four degrees since the first division and her own fingers had gone the colour of tallow inside the first quarter of it, the way they did every day, and his were the colour of hands."
- ch6 · Foss · number: Foss held a numbered instrument for eleven years and was struck off for a rounding convention. Quote: "I held a numbered instrument for eleven years."
- ch6 · Foss · name: Foss's given name is Ilmar. Quote: "Ilmar Foss, on a bench, with hands."
- ch6 · Foss · promise: Malphas promises Foss release under his own name when the work is done, and not to ask or send anyone after; it goes in the book. Quote: "When the work is done you will be released with your own name."
- ch6 · Malphas · fact: Malphas put his hand on the poured ninth hind's flank on the first night; he calls it a bad habit that stops now. Quote: "You put your hand on the ninth hind's flank on the first night."
- ch6 · Malphas · fact: Malphas spent two years designing against the paragraph from hearsay; three counters right, one backwards: he believed attribution ran up from object to hand, so the crew touched flasks bare. He puts the error in the book. Quote: "I have had you all touching flasks bare because I believed it ran the other way, up, from the object to the hand."
- ch6 · Malphas · fact: Malphas had the fourth counter (move a wall) read twice and did nothing visible with it. Quote: "Read the last one again," Malphas said."
- ch6 · Foss · fact: Foss obtained the paragraph a season earlier than he had said. Quote: "I said a season and I was wrong by a season."
- ch6 · Foss · fact: Foss is to hold the eighth hind's joint while Nuvalik goes in, so he cannot be told he expected the draw. Quote: "He has the steadier hands and he has never had them in one, and if it comes in under his hand as well he cannot be told he expected it."
- ch6 · Malphas · fact: Malphas now knows of all three contractions and that Nuvalik held them back; Vesk and Foss heard it too. Quote: "Why is it not in the book," Malphas said."
- ch4 · Deming · fact: Deming tells the Hollow Shaft story aloud to the factor, as a joke about careless men. Quote: "That is how they found the Hollow Shaft people."
- ch4 · Deming · misreading: Deming concludes the factor is a carriage man who lost interest in the Swale page once carriage was lost to him. Not true: do not treat as fact. Quote: "Once the carriage was lost to him, the Swale page was the capital's trouble and no longer his."
- ch4 · Deming · promise: Deming tells the factor that in eleven weeks the capital will see a bad spring on the Swale line, and asks for it noted. Quote: "In eleven weeks somebody in a room in the capital will look at the Swale line and see a bad spring."
- ch4 · Deming · fact: Deming tells the factor the carters' notes are clean and every cart up the Swale road this quarter went full (true). Quote: "Every cart that went up the Swale road this quarter went up full and was entered full."
- ch4 · the Xu house · fact: The Xu counting house is still on the main; per the factor, half the Swale is off it. Quote: "Half the Swale's off it."
...
**Ch10: The Ninth Hind.** Day 12, the coldhouse. Deming arrives off the Swale road. Nuvalik reads him the book to the fifth day, and Foss enters that he heard it. The ninth hind lies on the slate table, opened along the near shoulder and flank since the fifth night. Vesk, making up a sealed flask, sees the Lord's hands keep their colour on the iron bench under the dead standpipes, away from the press. He makes nothing of it. At the twelfth division the ninth hind draws, rolls and stands up on the table. She leans west toward the corner. The Lord rises, takes his coat and stands at the door before she reaches it, and Vesk takes it for courtesy. She comes off the table and chips the slate. Deming is sick in the yard. She crosses to the capped standpipe housing, lies down against it and stays down. Foss reads the standpipe's cap through his glass: rust unbroken across the seam, nothing in the pipe for four years. Nuvalik says there is nobody in her, only the net. Deming blames eel at the ford. Foss measures eleven feet on the rule and writes *stood*. Malphas: the sink is the quiet.

### Hook agenda (due ch11–14, and overdue)

- **Due within 3 chapters (ch11–14):** none.
- **OVERDUE:** none. H08, H01 and H21 were each paid on their due chapter.
- **Next due:** H23-edges-in-the-margin, ch16 (advanced ch1, 3, 5, 7). H16-thirty-one-days, ch22 (advanced ch4, 10; at risk, see C2 below). Deming is this chapter's POV, so any count he makes must agree with C2.

### Audit carry-forward

From AUDIT_ch10.md (latest): the critical items C1–C7, then the Carry-forward list. The items that bear on this chapter are C1 and carry-forward 1 (the "ch11–13" range: Foss going to the carter off-turn by about Day 13), C2 (Deming's count, if he counts), C5 and 6 (if the chapter goes to the coldhouse: Malphas on the iron bench under the dead standpipes, the book on the shelf over the press), C7 and 8 (salt bars leave no bill; Foss and the carter have no names for each other) and item 5 (identity).

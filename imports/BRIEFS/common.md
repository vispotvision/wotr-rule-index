...
- **Naming.** Moto register for the Moto bloodline; the Büri/Mongolian register is dead (ruled 2026-09-12). Five naming strata: Japonic (archaic bloodlines — with one carve-out: the Zettari keep their own Swahili/Bantu/Arabic-flavoured register, R32-1-ZETTARI_REGISTER_SWAHILI_BANTU_ARABIC, ruled 2026-09-12; Japonic still governs every other archaic line), Korean (Mahuo), Chinese (lineage halls), Northern English and Norse (chartered families and commons), Far-Northern carried-name logic. Naming register is not ethnicity. The royal human bloodline is spelled Zettari, never Zettai (C-005, ruled 2026-09-12).

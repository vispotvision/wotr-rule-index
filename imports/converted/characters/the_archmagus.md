...
> **Migrated with all content preserved, including the three relics and the prototype Domain.** *"Stage VIII — Refraction (Zenith)"* converts by numeral: **Stage VIII is Transcendence**; *Refraction is Stage VII's name and Zenith is Stage XIV's, and both descriptors are struck.* **"Tier SSS (Archmagus)" is struck:** *Stage VIII caps at S-Grade, ceiling 550.* **"Aether Class: Symphonic Scholar — Harmonic Orchestration" is not among the seven; she is Class V, Radiant** *(Band B, the first true Domain, which is exactly what the Lattice of Living Light prototype is).* **"Harmonic · Dream · Celestial" are not among the Sixty:** *Dream converts to Oneirion; Harmonic is carried by Aurevane (the refraction field, the Lunarch Crown) with Mirithane; Celestial converts to Abyntheus, the Outer Pulse, and that last assignment is the least certain and is flagged for Isaac.* **Verdantia via the Florwyn line is card-given and attested.** *The "Wellspring Network / Targeted Uninfected: six remaining" count is old vocabulary and is kept only as her stated ambition.* **"Temperance Path: Spirit → Mind → Fate":** *Mind is Choir vocabulary, not one of the four Paths; Spirit dominant is retained and the Fate progression is noted as the card's claim.* **Combat figures:** *450 PJ strike force sits in the SSS energy range and cannot be reached at Stage VIII; it, Mach 150 and "22 AU/s (Archon Units)" are retained only as the card's own instrument claims, in-world and unratified; 100 GJ durability and 10 km range are physical and kept.* **"The Epoch of Refraction" is no era in the Concordance and is struck; the card is labelled Withering Age, which converts to the Withering Era.** **Unattested in current canon:** *Sanctum Aria* (not Sanctum Lux, which is a different order and is not conflated here), *the Astral Seminary*, *the Nous*, *Florwyn's Chosen Conduit* as a title, the *Labyrinth of Ma* as an incident, and the relic names. **Attested:** *Eresse, the Eressean line, the Grove-Spired throne, the Council of Bloom, Florwyn, the Archons, the Titans, Verdantia, and the [Ma] Recall glyph that rotates in her eyes.* **Note for ruling:** *the Grove-Spired throne in current canon belongs to the Venrik line (Karo Venrik exiled from it, Asta Venrik its queen); how "the False Succession" sits against them is pending Isaac.*
...
**Crystal State** · Refined. **η** · ~0.70, Band B. *Estimate inside the Stage VIII range, marked as such.*
...
*Level is an estimate: placed high in Band III on the card's own scale claims, and held under the Stage X gate at 300.*
...
**Counter** · **Break the geometry, or make her disagree with herself.** *The card gives both. A Fate-law or Void working (in current terms, Limina negation of the Nihiloth or Dissolution kind, or anything the Fate Path carries) collapses her lattices into noise, because a law that removes rules has nothing for a refractive law to bend. A direct, systemic strike on the Soul Crystal, at Resilience Integrity rather than at the field, invites the Resonance Cascade and turns her Domain into a hostile reality field with her inside it.* **Anyone who has studied her (Crystalline Recall cuts both ways) knows the second is cheaper.**
...
**The Eressean Crown** · **Refused.** *The False Succession: she declined the throne, declaring her focus was on the equation rather than the crown.* **The Venrik line holds the Grove-Spired throne in current canon; her standing against Karo and Asta Venrik is pending Isaac.**

...
*"~0.55"* ✓ **in band**. Crystal State *"Refined"*. **The invoice:** a fifth of the reserve, fibre torn
...
it the only one of Draven's four pages that gets Craft and Law V right together. η is in band, the Stage is
the floor, and the cost is priced as a fraction of reserve — **the only page in the batch that gives the

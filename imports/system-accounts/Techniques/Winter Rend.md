...
floor**, and lawfully so: `C-062` was **ruled 2026-09-25** (agent ruling, Isaac's rung **I-2**),
...
| Numbers in band | **mostly pass, one large fail** | ✓ 2 m under A-Grade Contact Range. ✓ η 0.55 is 0.05 below the Tier 5 band of 0.60–0.70 as **R44-4** corrected it, and the card governs there — `C-062` **ruled 2026-09-25** (rung **I-2**). ✓ Stage at the floor. ✓ Both Sub-Stats the card's own peaks, both gates clear. ✓ Thermal shock numbers close exactly. ✗ The thermal half of the Numerical Effect is out by 10⁶–10⁸ (`SA-PHYS-WINTER-ARC-YIELD`). |

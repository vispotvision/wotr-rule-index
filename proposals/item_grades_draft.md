...
Essence into it). Isaac, same day: "It should be based on the nine tier system
like journeymen adept etc." So an item is ranked on the Accord's public ladder,
the nine Tiers of Standing (Initiate to Paragon), with the Grade letter that
Tier carries read off The Sixteen Stages; an item and a person are read on one
scale. Flags at the end.
...
- A plain item with no working in it has no Tier at all. It performs
...
One Tier, and its Grade letter, read against the Part Four and Part Six tables for what the item
does:
...
| Armour, ward, shield | what it stops: a strike at or below its Tier's Grade | Attack output band, stamped as the proof-mark |
...
| Proofed armour | 25% of the maker's reserve, once | until struck by a strike two Tiers above its proof |
| Relic | the maker's whole reserve, once, and a Starvation spell after (below 10% EU) | permanent while its material holds |

So an Apprentice maker (Stage II, D-Grade, reserve ~0.56 EU) can prepare about ninety
...
1. **Material tier n = Tier of Standing n (table 2) is a design proposal,**
   built on the Material Index's own tier descriptions and checked against the
   two items above.

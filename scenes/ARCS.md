...
One heading per arc, scenes in order. docs_export.py compiles The Scene Archive
and the per-arc documents in this order; the epub build follows it too. Order
set by Claude Code on 2026-09-12 from the numbering and the filenames; move any
line and the next sync recompiles.

## The Kharven year — Sodoku Moto
...
## The New World — Ilthára Korvaeth
- 01_the_vacancy_korvaeth_arc.md

## Cozbi, Niran and the Enclave
...
## Long-form and bloodline pieces

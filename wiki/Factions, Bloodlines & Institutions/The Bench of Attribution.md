---
title: "The Bench of Attribution"
notion_id: "3b158200-eb22-81a7-9a4c-e068982e590a"
...
```mermaid
flowchart TD
    P["PETITION<br>reference lot, full glyph chain in Parunic,<br>and a named practitioner who will stand as author"]
    A["ASSAY<br>two Measurewrights independently, against<br>Nine-Nail Attestation Salt, in separate halls"]
    D["DOCTRINAL READ<br>Archives reads for the four glyph roles<br>and Wellspring authorisation"]
    R["RULING<br>Arbitration puts the question<br>all three chairs answer"]
    AP["APPEAL<br>at the appellant's cost, before Arbitration<br>sitting alone, under truth-binding"]
    P --> A --> D --> R --> AP
    D -.->|"chain missing a Boundary role"| X["REFUSED OUTRIGHT<br>not appealable"]
```

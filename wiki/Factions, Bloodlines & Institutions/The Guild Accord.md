---
title: "The Guild Accord"
notion_id: "3b158200-eb22-816a-bcc2-c148358fb25e"
...
```mermaid
flowchart TD
    HC["THE HIGH CONCORDANT<br>Arbiter of the Lattice<br>soul woven into the Heart Vault"]
    HC --> CC["THE CONCORD COUNCIL<br>five Divisional Heads"]
    HC -.->|"reports only here"| BC["THE BLACK CONCORD<br>the sixth and unspoken Division"]
    CC --> S["STRATEGIC<br>realm defense, the Concord Legion"]
    CC --> E["ENFORCEMENT<br>lawkeeping, Sealwrights, apprehension"]
    CC --> A["ARBITRATION<br>diplomacy, treaties, Trials of Resonance"]
    CC --> R["RESEARCH & ARCHIVES<br>scholarship, containment, the Archives Eternal"]
    CC --> L["LOGISTICS & SUPPLY<br>Gates, Essence transport, Aether credit"]
    CC --> EN["REGIONAL ENVOYS & GUILDLORDS"]
    EN --> GM["GUILDMASTERS"]
    GM --> DG["DEPUTY GUILDMASTERS<br>& PRIME INSTRUCTORS"]
    GM --> PL["PARTY LEADERS<br>tactical authority only"]
```

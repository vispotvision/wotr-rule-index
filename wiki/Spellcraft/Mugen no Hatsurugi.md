...
> **Migration note.** Muken Moto, Bara Moto, Gimbzo, the Shingan, and the six named Wellsprings (Fixatio, Materia Primordia, Coagulatio, Anamnesis, Aurevane, Monolithion) are all attested in current canon; the card's spelling "Monlithion" is corrected to the canonical **Monolithion** (Materia family, "The Enduring Monument"), a near-miss the verification pass is required to catch rather than warn on. Akagane-ke is built from the attested Moto line **Akagane** (Reigan-eyed, soul-reading and inner-system control) plus the standard Japonic house suffix; the specific armory is not itself attested and is kept as a plausible, load-bearing detail. **Bara Moto** has no full character card in the wiki mirror but is attested as co-founder of the Moto bloodline alongside Mizuki Moto; nothing numeric is claimed about him here. **Flagged, not resolved:** Muken Moto's own ratified character card ("The Ashen Blade," King of Kharven) lists a Hataraki-kinetic technique kit built on Fractura, Petralon, Judicium and Coagulatio, with a single named weapon, the Reforged Scrap-Iron Blade, and no mention of Mugen no Hatsurugi, the Shingan-linked ledger-forge described here, or training under Gimbzo. This card and his ratified sheet do not describe the same technique kit. Per the rule against silently resolving a conflict, both stand: this entry converts the Trello card's own claim as its own claim, states plainly that it is not corroborated by his current character sheet, and leaves the reconciliation (a technique from before his coronation that his sheet omits, an alternate-timeline sheet, or an originated addition that needs ratifying) to Isaac. Numbers below are derived conservatively from Muken's own attested EU economy on that ratified sheet (technique costs there run 22,000 to 110,000 EU) rather than invented fresh, since no other numeric source for this technique exists.
...
Per the card's own history: Muken Moto's own work, drafted across a hundred and twenty days of instruction on the Plane of Fate, and ratified by neither Bara nor Gimbzo, which makes it his alone under the named-inventor rule. As a self-derived, unratified technique, it must be read live in an exchange before it kills rather than summarized, and anyone who studies a documented use of it afterward gains standing counterplay against it that its first opponents did not have. Where this places him in relation to his later, ratified reign in Kharven, whose own sheet does not carry this technique, is unresolved and is the discrepancy flagged above.

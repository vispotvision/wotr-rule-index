...
**Weakness** · A Body Path anchor holding hard to physical law resists the distortion. A clear-light Domain's own claim on the Layer disrupts the dream-overlay outright.
**Cost** · Aeldoris takes on a brief sensory overlay of his own field's contradictions (Double Vision), and the field leaves a residue that bleeds into the ground for a time after the fight ends (Dream Residue).
**Counterplay** · A grounding rune anchors a defender's own physical law against the field's claim. A reality-lock invocation reasserts the Layer's ordinary recognition over Aeldoris's. A pulse of unclaimed Aether disrupts the field the way any second claim would.

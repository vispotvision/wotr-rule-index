...
**Counter** · Cut the sound and the hymn collapses before it completes; a Mortalis-aligned current resists or twists the Canticle rather than answering it.
...
**Weakness** · A Mortalis-aligned current resists or actively corrupts what the hymn is doing; a dead or sterilised patch of ground gives it nothing to answer.
**Cost** · Lineage Strain (the inherited echo of Florwyn's Ground pulls closer with overuse, threatening to entangle her further than she can control) and Emotional Vulnerability (an empathic foe can read or exploit the state the hymn exposes).
**Counterplay** · Silence her outright, force the fight onto ground where nothing grows, or read and exploit the emotional state the hymn leaves exposed.

---
title: "Liminal Palace of False Dawn"
notion_id: "3d958200-eb22-81a4-8688-c39d15abda92"
...
- **Wellspring:** Oneirion, The Wellspring of Dream (primary). Also carried at primary weight per the source: Fractura, Tenebra. Secondary harmonisations carried: Basilithe, Orrenthal, Dissolution, Tarturon, Cataclysm, Penance, Petralon.
- **Family:** Limina
...
- **Governing Sub-Stats:** Cognition (engaging a law-level perceptual phenomenon and resisting glamours and false spatial constructs turned back on their own caster), Analysis (reading which sensory layer is the true one), Retention (holding the overlay's complete structure loaded without it slipping)
- **Secondary Primary:** Harmonics, Sub-Stat Projection (how far the overlay's field reaches before it can no longer be sustained)

...
**Weakness** · Letheveil clarity dissolves the thread, since a mind that has just had its recent fear-memory shaken loose leaves Oneirion no coordinate to lock onto. Non-humanoid targets respond inconsistently, their configuration space mapping differently.
**Cost** · Aeldoris's own body echoes the target's fear-motion (Sympathetic Twitch), and panic residue clings to his Aether Shell afterward (Echo Feedback), fading only with time.
**Counterplay** · High Spirit Path discipline resists having an involuntary impulse seeded into it. A trained pain-response can sever the thread outright. A lucid hold on one's own dream-logic negates the puppet effect entirely.

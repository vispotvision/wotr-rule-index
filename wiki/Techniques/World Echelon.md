...
**Weakness** · The rough Spirit-Fate seat means World Echelon is, structurally, two arguments held in one lattice rather than one clean claim, and an opponent who reads the seam between the Spirit half and the Fate half is reading a genuine fault line, not a metaphor.
**Cost** · High soul-heating and local Principle drift, as given.
**Counterplay** · A Sovereign-tier Spirit Path practitioner's own Domain resists being folded into someone else's court geometry; a transcendent Harmonics Empathy field absorbs the weighing-effect faster than the court can apply it.

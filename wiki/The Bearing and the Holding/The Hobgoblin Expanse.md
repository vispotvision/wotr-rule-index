---
title: "The Hobgoblin Expanse"
notion_id: "3b158200-eb22-81b0-8227-d8a4f9a29302"
...
```mermaid
flowchart TD
    A["Dokk-Vraal's deep raid into the northern shield<br>militarily successful, politically catastrophic"]
    A --> B["THREE DAWI OATH-HOUSES UNITE<br>a century of tunnel-access argument set aside"]
    A --> C["ERESSEAN EXPEDITIONARY FORCE<br>dispatched not from injury but because the Dawi alliance<br>disturbed the Kinship Doctrine's equilibrium model"]
    A --> D["FRONTIERFOLK VALLEY-LORDS<br>stop paying goblinoid tolls, start fortifying"]
    B --> E["Northern passes lost in nine days<br>Eastern approaches lost in six"]
    C --> E
    D --> E
    E --> F["The Ironblood demand the Hobgoblins commit<br>their administrative reserves to a counterattack"]
    F --> G["THE REFUSAL"]
    G --> H["Forty years of grinding expulsion"]
```

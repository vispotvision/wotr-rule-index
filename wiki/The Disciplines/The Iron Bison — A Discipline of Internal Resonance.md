---
title: "The Iron Bison — A Discipline of Internal Resonance"
notion_id: "3bc58200-eb22-81fb-8b71-e5beb48191e6"
...
```mermaid
flowchart LR
    A["ANIMA SPIRARE<br>read the soul-breath rate<br>lock the curve to demand"] --> P["PHREATIS<br>circulate seven chambers<br>confirm nothing vents"]
    P --> C["COAGULATIO<br>nucleate the output<br>into ordered density"]
    C --> CH["CHTHONICA<br>declare the axis<br>lawful load-bearer"]
    CH --> F["FIXATIO<br>seal the increment<br>into the body"]
    F --> A
```

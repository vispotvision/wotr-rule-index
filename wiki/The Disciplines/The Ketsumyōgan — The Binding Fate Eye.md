---
title: "The Ketsumyōgan — The Binding Fate Eye"
notion_id: "3b158200-eb22-815e-8fe9-fb1a81cf3572"
...
flowchart TD
    ...
    K --> E["EDIT"]
    K --> T["TOTAL"]
    P --> S1["1 · SHISEN 糸線<br>reads the threads"]
    P --> S2["2 · TEISHI 締糸<br>reads when they commit"]
    P --> S3["3 · REISHI 霊糸<br>reads between souls"]
    P --> S6["6 · SANSHI 三糸<br>reads all three planes at once"]
    E --> S4["4 · DANSHI 断糸<br>cuts"]
    E --> S5["5 · MUSUHI 結糸<br>ties"]
    E --> S7["7 · ORIHI 織糸<br>moves"]
    T --> S8["8 · ZENSHI 全糸<br>governs"]
```

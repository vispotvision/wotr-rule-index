---
title: "The Concord Citadel"
notion_id: "3b158200-eb22-81c4-9084-f14837c8b7fd"
...
```mermaid
flowchart TD
    CS["THE COUNCIL SPIRE<br>summit · hollow column of refracted light"]
    HCC["THE CHAMBER OF STILL FLAME<br>apex, behind eleven seals"]
    AE["THE ARCHIVES ETERNAL<br>crystalline corridors · the Vault of Parun"]
    CH["THE CHORAL SANCTUM<br>core · the Choir of the Fallen"]
    HV["THE HEART VAULT<br>deeper than the Archives<br>the Wellspring of Law"]
    CB["THE CITY BELOW<br>guild quarters, training sanctums,<br>Gate plazas, the Forum of Balance"]
    RW["THE RING WALLS<br>the Halo Array · orbiting rather than standing"]
    HCC --> CS --> AE --> CH --> HV
    CS --> CB
    RW -.->|"encircles all"| CS
```

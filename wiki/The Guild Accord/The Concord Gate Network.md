---
title: "The Concord Gate Network"
notion_id: "3b158200-eb22-8125-b480-d3d9b1cfe547"
...
```mermaid
flowchart TD
    GS["THE GATE SHELL<br>the physical arch, carved of<br>ley-reactive stone or crystal metal"]
    VC["THE VEIL CORE<br>a spinning Essence nucleus<br>that holds the Aether Path open"]
    LS["THE LATTICE SEAL<br>an encoded sigil network linking<br>the Gate to the central Concord Codex"]
    GS --> VC --> LS
    LS --> R["HARMONIC RECOGNITION<br>the same pulse that resonates<br>in Accord-bound Soul Crystals"]
    R -->|"bound"| P["Safe passage"]
    R -->|"unbound"| B["Overwhelming vertigo<br>or spiritual burning"]
```

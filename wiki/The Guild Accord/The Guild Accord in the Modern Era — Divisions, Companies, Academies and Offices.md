---
title: "The Guild Accord in the Modern Era — Divisions, Companies, Academies and Offices"
notion_id: "3d758200-eb22-8121-9842-c160dd9c8203"
...
**Where the Accord stands.** The communion is being signed now, circle by circle, and the Articles and the Commission framework bind as law only inside a signed circle. The first was signed at Kharven-Seat. Everywhere else what reaches is older: the Codex, its courts and its standards, carried by charter and taken by consent, and the reach below is the reach of that older machinery.
The Accord is not equally strong everywhere and the pattern is materialist rather than political.
**Strongest: the New World's arc.** Chartered from nothing within living memory. There is no older law to displace because there was no older law, so **its chartered halls are not one jurisdiction among several there; they are the jurisdiction**, running the Accord's text by charter ahead of any circle. Every settlement holds a charter, every charter names the Accord's standards, and a company that loses its charter loses the ground it stands on. The elven old-ground beside the arc is another matter: four Eons of Eressean law the Accord did not displace. The Divisions maintain more staff across the arc than in the whole of the Old World.
...
**The chairs are the money.** An endowed chair is a fund, and the holder is paid from it, and the endower's family frequently retains a say in appointments in perpetuity. A dozen chairs in the Inner World are in the gift of a crown rather than an academy, and those are the ones that get people ennobled.

#### The societies

A society does not teach. It **elects**, from a large pool, a small fixed number each year, and the election is by the existing members. Membership is styled **Fellow**, carries a postnominal, and cannot be bought at any price, which is precisely why it is worth more than anything that can.
The Society's whole power is that it is the only body in the four quarters that confers standing **without money changing hands.** It has no charter to grant, no licence to issue and no court to convene. It simply says, once a year, who is worth listening to, and the four quarters have agreed to care.
**The Accord and the Societies have never worked out their relationship** and both prefer it that way. Research and Archives funds them, and has never dared try to appoint to them.

### VII. The Great Offices

**These are appointments, not rankings.** Nobody is measured to be the greatest anything. An office exists, somebody is appointed to it, and the honorific accretes afterward until people forget the office was ever a job.
The historical pattern is exact and worth copying: an office is created to *do* something, the holder is styled by an increasingly grand informal title, the title becomes the standard usage, and eventually the office is detached from the work altogether and becomes largely honorary, awarded for distinction. **Three of the four Accord offices have completed that journey. One has not, and resents the others.**

#### In the Accord's gift

**The Grand Mage.** Originally the office that **visited and examined the academies**, on circuit, once every three years, with power to suspend a charter. The honorific accreted over two centuries. The office is now largely honorary, detached from any particular academy, and conferred for distinction, and the visitation is performed by deputies. **Guildmasters who still receive the visitation consider this an outrage**, since they are examined by a man acting in the name of somebody who has never seen their hall.
**The Grand Alembic.** Pre-eminent in the pouring. Began as the office that certified the Draft formulary, which meant deciding what could lawfully be made. Now honorary, and the formulary is certified by a standing committee of the Alchemists' Society, which the Accord funds and does not appoint to, and which is therefore the most independent body in the four quarters and knows it.
**The Grand Engraver.** Pre-eminent in the cutting. Keeper of the angle-set and of the Master Glyph Index. Honorary in name and **not honorary in fact**, because somebody has to say whether a newly attested form is a form, and no committee has ever been willing to take that on.
**The Grand Gauger.** Pre-eminent in the draw. Created within the last century, still does its job, still sets the standard bore, still hears appeals on metering. The other three regard it as a jumped-up inspectorate with a grand name. It regards them as three honorifics attached to nobody's actual work, and it is right, and saying so has cost two holders their seat at the Citadel table.
**There is no Accord office for the singing.** Chantcraft has never been an Accord examination category, and the orders appoint their own **Precentor of the Choirs**, whom the Accord does not recognise and cannot appoint, and who outranks every one of the four inside any hall where a chant is holding something up.

#### In the crowns' gift

Every crown appoints its own: **Mage Royal**, **Alchemist Royal**, **Engraver Royal**, and in the Inner World a **Gauger Royal** in three kingdoms so far. These are salaried, resident, and expected to work.
**Two honour systems, and they overlap badly.** The Grand Mage is the Accord's. The Mage Royal is a crown's. Neither outranks the other and no protocol has ever settled which enters a room first, so the compromise everywhere is that they enter together and are announced together, and the two men involved have usually loathed each other for years.

### VIII. Hooks

**The eighth and ninth places.** Two of the Twelve Great in a precedence dispute nobody can resolve, because the original ruling is ambiguous and both readings hold. It matters at every civic occasion and has cost lives twice.
**Enforcement's ledger.** A Division funded by forfeiture. Somebody in Arbitration has the numbers and is deciding whether raising them ends the practice or ends them.
**The three directions.** A Divisional Head wants a charter revoked. He does not ask. He arranges for the Concordant to hear about the problem from three sources over a season. Somebody notices the pattern.
**Redemption.** A man bought his freedom of the company and has been elected to the Court, and the Court is deciding whether to let it stand, and the vote will be close, and everyone will pretend afterward it was about something else.
**The tables.** The Adventurers' underwriting tables say what a Containment on a live Wellspring actually costs in lives. A party has just been shown them by a clerk who should not have.
**The still line.** The wire out of the Citadel goes quiet for two days.

...
**Aetheric Density** · The concentration of Aether present in a given volume. Sets the ceiling on the AU/s output a practitioner can achieve in that location, which is why battles are fought over ground and not only over people.
**Aetheric Residue** · Traces left behind by an Essence working. A permanent, if often subtle, change to the location where the working occurred. Always readable by someone patient enough.
**Aetheric Saturation** · A danger state in which excessive Essence floods an area faster than it can disperse. Produces Crystal Fracture Events in everyone exposed, including the person who caused it.
